 ...
 */
class DeferredShadingSystem : public NII::FrameObjListener
{
public:
	DeferredShadingSystem(Ogre::Viewport *vp, Ogre::SpaceManager *sm, Ogre::Camera *cam);
...
const Colour SAMPLE_COLORS[] = 
{   Colour::Red, Colour::Green, Colour::Blue, 
    Colour::White, Colour(1,1,0,1), Colour(1,0,1,1)
};
