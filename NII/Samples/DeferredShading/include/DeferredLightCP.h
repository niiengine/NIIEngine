...
class DeferredLightRenderOperation : public Ogre::FusionRender
{
public:
	...
	virtual void execute(Ogre::SpaceManager *sm, Ogre::RenderSystem *rs);

	virtual ~DeferredLightRenderOperation();

    /** @copydoc CustomCompositionPass::createOperation */
    virtual Ogre::FusionRender * createOperation(
        Ogre::CompositorInstance* instance, const Ogre::CompositionPass* pass)
    {
        return N_new DeferredLightRenderOperation(instance, pass);
    }
private:
