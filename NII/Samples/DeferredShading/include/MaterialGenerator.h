...
public:
	...
	*/
	...
	public:
		virtual ~Impl();
		virtual Ogre::GpuProgram * generateVertexShader(Perm permutation) = 0;
		virtual Ogre::GpuProgram * generateFragmentShader(Perm permutation) = 0;
...
protected:
	...
	*/
	...
	const Ogre::GpuProgram * &getVertexShader(Perm permutation);
	const Ogre::GpuProgram * &getFragmentShader(Perm permutation);
	...
	typedef Ogre::map<Perm, Ogre::GpuProgram *>::type ProgramMap;
