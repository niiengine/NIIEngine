...
//---------------------------------------------------------------------------
    ...
    class CompositorDemo_FrameListener : Ogre::RenderFrameListener, OIS::KeyListener,
    ...
    protected:
        ...
        float mSpeed;
        float mAvgFrameTime;
        Ogre::NIIf mMoveSpeed;
        Ogre::NIIf mRotateSpeed;
        CEGUI::Point mLastMousePosition;
        bool mLastMousePositionSet;
        // just to stop toggles flipping too fast
        Ogre::NIIf mTimeUntilNextToggle ;
        float mRotX, mRotY;
    ...
    public:
		...
		void setSpinningNode(Ogre::SpaceNode* node) { mSpinny = node; }
    private:
