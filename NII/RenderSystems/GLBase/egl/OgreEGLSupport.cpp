...
namespace Ogre {
    ...
    EGLConfig* EGLSupport::chooseGLConfig(const EGLint *attribList, EGLint *nElements)
    {
        ...
        {
            N_EXCEPT(RenderingAPI, "Failed to choose config");
    ...
    ::EGLConfig EGLSupport::getGLConfigFromContext(::EGLContext context)
    {
        ...
        {
            N_EXCEPT(RenderingAPI, "Fail to get config from context");
            return 0;
        }
        EGL_CHECK_ERROR
                                                    ...
                                                    unsigned int *w, unsigned int *h)
    {
        ...
        {
            N_EXCEPT(RenderingAPI, "Fail to get config from drawable");
            return 0;
        }
        EGL_CHECK_ERROR
                                              ...
                                              ::EGLContext shareList) const 
    {
        ...
        if (!context)
        {
            N_EXCEPT(RenderingAPI, "Fail to create New context");
            return 0;
        }
