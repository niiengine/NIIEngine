...
namespace Ogre {
    ...
    void Win32EGLWindow::initNativeCreatedWindow(const PropertyData *miscParams)
    {
...
*/
    ...
    void Win32EGLWindow::pos( int left, int top )
    {
                                ...
                                bool fullScreen, const PropertyData *miscParams)
    {
        ...
        LogManager::getSingleton().logMessage("EGLWindow::create used FBConfigID = " + StrConv::conv(glConfigID));
