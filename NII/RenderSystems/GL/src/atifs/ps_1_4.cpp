...
void PS_1_4::test()
{
  ...
  char testtemp1[] = "1 test";
  char testtemp2[] = "2.3f test";
  char testtemp3[] = "-0.5 test";
  char testtemp4[] = " 23.6 test";
  char testtemp5[] = "  -0.021 test";
  char testtemp6[] = "12 test";
  char testtemp7[] = "3test";
...
// **************************************************************
  ...
  static char temp8[] = "Basic PS_1_4";
  testCompile(temp8, CompileTest1src, CompileTest1result, ARRAYSIZE(CompileTest1result));

// **************************************************************
  char CompileTest2src[] = "ps.1.1\n";
  SymbolID CompileTest2result[] = {sid_PS_1_1};

  static char temp9[] = "Basic PS_1_1";
  testCompile(temp9, CompileTest2src, CompileTest2result, ARRAYSIZE(CompileTest2result));
...
// **************************************************************
  ...
  static char temp6[] = "PS_1_4 with defines";
  testCompile(temp6, CompileTest3src, CompileTest3result, ARRAYSIZE(CompileTest3result));
...
// **************************************************************
  ...
  static char temp4[] = "PS_1_4 with 2 defines";
  testCompile(temp4, CompileTest4src, CompileTest4result, ARRAYSIZE(CompileTest4result));
...
// **************************************************************
  ...
  static char temp7[] = "PS_1_4 with defines";
  testCompile(temp7, CompileTest3src, CompileTest3result, ARRAYSIZE(CompileTest3result), CompileTest5MachinInstResults, ARRAYSIZE(CompileTest5MachinInstResults));
// **************************************************************
  ...
  static char temp10[] = "PS_1_4 ALU simple";
  testCompile(temp10, CompileTest6Src, CompileTest6result, ARRAYSIZE(CompileTest6result));
...
// **************************************************************
  // test to see if PS_1_4 compile pass 2 generates the proper machine instructions
	...
	static char temp2[] = "PS_1_4 ALU simple modifier";
	testCompile(temp2, CompileTest7Src, CompileTest7result, ARRAYSIZE(CompileTest7result), CompileTest7MachinInstResults, ARRAYSIZE(CompileTest7MachinInstResults));
...
// test to see if a PS_1_1 can be compiled - pass 1 and pass 2 are checked
	...
	static char temp5[] = "PS_1_1 Texture simple";
	testCompile(temp5, TestStr5, test5result, ARRAYSIZE(test5result), test5MachinInstResults, ARRAYSIZE(test5MachinInstResults));
...
// test to see if a PS_1_2 CISC instructions can be compiled - pass 1 and pass 2 are checked
	...
	static char temp3[] = "PS_1_2 CISC instructions";
	testCompile(temp3, TestStr6, test6result, ARRAYSIZE(test6result), test6MachinInstResults, ARRAYSIZE(test6MachinInstResults));
...
// test to see if a PS_1_4 two phase can be compiled - pass 1 and pass 2 are checked
	...
	static char temp1[] = "PS_1_4 texture complex : Phase - instructions";
	testCompile(temp1, TestStr7, test7result, ARRAYSIZE(test7result), test7MachinInstResults, ARRAYSIZE(test7MachinInstResults));
