...
namespace Ogre {
    ...
    //-----------------------------------------------------------------------
    void D3D9HLSLProgram::populateDef(D3DXCONSTANT_DESC& d3dDesc, GpuParamUnit& def) const
    {
    ...
    //-----------------------------------------------------------------------
    GpuProgramParam * D3D9HLSLProgram::createParameters(void)
    {
        // Call superclass
    ...
    {
        return StrConv::conv(static_cast<const D3D9HLSLProgram*>(target)->getColumnMajorMatrices());
    }
    ...
    {
        return StrConv::conv(static_cast<const D3D9HLSLProgram*>(target)->getBackwardsCompatibility());
    }
