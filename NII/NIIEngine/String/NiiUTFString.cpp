...
namespace ThirdPart
{
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::_base_iterator::_get_index() const
    {
        return mIter - mString->mData.begin();
    }
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::unicode_char UTFString::_base_iterator::_getCharacter() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_fwd_iterator UTFString::_fwd_iterator::operator++( int )
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_fwd_iterator UTFString::_fwd_iterator::operator+( difference_type n )
    {
        _fwd_iterator tmp( *this );
        if ( n < 0 )
            tmp._seekRev( -n );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::unicode_char UTFString::_fwd_iterator::getCharacter() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_const_fwd_iterator UTFString::_const_fwd_iterator::operator++( int )
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_const_fwd_iterator UTFString::_const_fwd_iterator::operator+( difference_type n )
    {
        _const_fwd_iterator tmp( *this );
        if ( n < 0 )
            tmp._seekRev( -n );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::unicode_char UTFString::_const_fwd_iterator::getCharacter() const
    {
        return _getCharacter();
    }
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_rev_iterator UTFString::_rev_iterator::operator++( int )
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_rev_iterator UTFString::_rev_iterator::operator+( difference_type n )
    {
        _rev_iterator tmp( *this );
        if ( n < 0 )
            tmp._seekFwd( -n );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_const_rev_iterator UTFString::_const_rev_iterator::operator++( int )
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::_const_rev_iterator UTFString::_const_rev_iterator::operator+( difference_type n )
    {
        _const_rev_iterator tmp( *this );
        if ( n < 0 )
            tmp._seekFwd( -n );
    ...
    UTFString::UTFString( const NII::String& str )
    {
        _init();
        assign( str.c_str() );
    }
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::size() const
    {
        return mData.size();
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::length() const
    {
        return size();
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::length_Characters() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::max_size() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::capacity() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString UTFString::substr( size_type index, size_type num /*= npos */ ) const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::unicode_char UTFString::getChar( size_type loc ) const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::iterator UTFString::begin()
    {
        iterator i;
        i.mIter = mData.begin();
        i.mString = this;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::const_iterator UTFString::begin() const
    {
        const_iterator i;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::iterator UTFString::end()
    {
        iterator i;
        i.mIter = mData.end();
        i.mString = this;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::const_iterator UTFString::end() const
    {
        const_iterator i;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::reverse_iterator UTFString::rbegin()
    {
        reverse_iterator i;
        i.mIter = mData.end();
        i.mString = this;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::const_reverse_iterator UTFString::rbegin() const
    {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::reverse_iterator UTFString::rend()
    {
        reverse_iterator i;
        i.mIter = mData.begin();
        i.mString = this;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::const_reverse_iterator UTFString::rend() const
    {
        const_reverse_iterator i;
        i.mIter = const_cast<UTFString*>( this )->mData.begin();
        i.mString = const_cast<UTFString*>( this );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::iterator UTFString::insert( iterator i, const code_point& ch )
    {
        iterator ret;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::iterator UTFString::erase( iterator loc )
    {
        iterator ret;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::iterator UTFString::erase( iterator start, iterator end )
    {
        iterator ret;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( const UTFString& str, size_type index /*= 0 */ ) const
    {
        return mData.find( str.c_str(), index );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( const code_point* cp_str, size_type index, size_type length ) const
    {
        UTFString tmp( cp_str );
        return mData.find( tmp.c_str(), index, length );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( const char* c_str, size_type index, size_type length ) const
    {
        UTFString tmp( c_str );
        return mData.find( tmp.c_str(), index, length );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find( const wchar_t* w_str, size_type index, size_type length ) const
    {
        UTFString tmp( w_str );
        return mData.find( tmp.c_str(), index, length );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( char ch, size_type index /*= 0 */ ) const
    {
        return find( static_cast<code_point>( ch ), index );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( code_point ch, size_type index /*= 0 */ ) const
    {
        return mData.find( ch, index );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find( wchar_t ch, size_type index /*= 0 */ ) const
    {
        return find( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find( unicode_char ch, size_type index /*= 0 */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( const UTFString& str, size_type index /*= 0 */ ) const
    {
        return mData.rfind( str.c_str(), index );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( const code_point* cp_str, size_type index, size_type num ) const
    {
        UTFString tmp( cp_str );
        return mData.rfind( tmp.c_str(), index, num );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( const char* c_str, size_type index, size_type num ) const
    {
        UTFString tmp( c_str );
        return mData.rfind( tmp.c_str(), index, num );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::rfind( const wchar_t* w_str, size_type index, size_type num ) const
    {
        UTFString tmp( w_str );
        return mData.rfind( tmp.c_str(), index, num );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( char ch, size_type index /*= 0 */ ) const
    {
        return rfind( static_cast<code_point>( ch ), index );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( code_point ch, size_type index ) const
    {
        return mData.rfind( ch, index );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::rfind( wchar_t ch, size_type index /*= 0 */ ) const
    {
        return rfind( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::rfind( unicode_char ch, size_type index /*= 0 */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_of( const UTFString &str, size_type index /*= 0*/, size_type num /*= npos */ ) const
    {
        size_type i = 0;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_of( code_point ch, size_type index /*= 0 */ ) const
    {
        UTFString tmp;
        tmp.assign( 1, ch );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_of( char ch, size_type index /*= 0 */ ) const
    {
        return find_first_of( static_cast<code_point>( ch ), index );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find_first_of( wchar_t ch, size_type index /*= 0 */ ) const
    {
        return find_first_of( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_of( unicode_char ch, size_type index /*= 0 */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_not_of( const UTFString& str, size_type index /*= 0*/, size_type num /*= npos */ ) const
    {
        size_type i = 0;
        const size_type len = length();
        while ( i < num && ( index + i ) < len ) {
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_not_of( code_point ch, size_type index /*= 0 */ ) const
    {
        UTFString tmp;
        tmp.assign( 1, ch );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_not_of( char ch, size_type index /*= 0 */ ) const
    {
        return find_first_not_of( static_cast<code_point>( ch ), index );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find_first_not_of( wchar_t ch, size_type index /*= 0 */ ) const
    {
        return find_first_not_of( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_first_not_of( unicode_char ch, size_type index /*= 0 */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_of( const UTFString& str, size_type index /*= npos*/, size_type num /*= npos */ ) const
    {
        size_type i = 0;
        const size_type len = length();
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_of( code_point ch, size_type index /*= npos */ ) const
    {
        UTFString tmp;
        tmp.assign( 1, ch );
    ...
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find_last_of( wchar_t ch, size_type index /*= npos */ ) const
    {
        return find_last_of( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_of( unicode_char ch, size_type index /*= npos */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_not_of( const UTFString& str, size_type index /*= npos*/, size_type num /*= npos */ ) const
    {
        size_type i = 0;
        const size_type len = length();
        if ( index > len ) index = len - 1;
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_not_of( code_point ch, size_type index /*= npos */ ) const
    {
        UTFString tmp;
        tmp.assign( 1, ch );
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_not_of( char ch, size_type index /*= npos */ ) const
    {
        return find_last_not_of( static_cast<code_point>( ch ), index );
    }
    //--------------------------------------------------------------------------
#if NII_IS_NATIVE_WCHAR_T
    ThirdPart::UTFString::size_type UTFString::find_last_not_of( wchar_t ch, size_type index /*= npos */ ) const
    {
        return find_last_not_of( static_cast<unicode_char>( ch ), index );
    }
#endif
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::find_last_not_of( unicode_char ch, size_type index /*= npos */ ) const
    {
        code_point cp[3] = {0, 0, 0};
        size_t l = _utf32_to_utf16( ch, cp );
    ...
    //--------------------------------------------------------------------------
#if NII_StringCustomAlloc
    //! implicit cast to NII::String
    UTFString::operator NII::String() const
    {
#if NII_STRING
        return NII::String( asWStr() );
#else
        return NII::String( asUTF8().c_str() );
#endif
    }
#endif
    //--------------------------------------------------------------------------
    ...
    size_t UTFString::_utf16_char_length( code_point cp )
    {
        if ( 0xD800 <= cp && cp <= 0xDBFF ) // test if cp is the beginning of a surrogate pair
            return 2; // if it is, then we are 2 words NIIl
        return 1; // otherwise we are only 1 word NIIl
    }
    //--------------------------------------------------------------------------
    ...
    size_t UTFString::_utf8_to_utf32( const unsigned char in_cp[6], unicode_char& out_uc )
    {
        ...
        if ( len == 1 ) { // if we are only 1 byte NIIl, then just grab it and exit
            out_uc = in_cp[0];
            return 1;
        }
    ...
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::_verifyUTF8( const unsigned char* c_str )
    {
        std::string tmp( reinterpret_cast<const char*>( c_str ) );
        return _verifyUTF8( tmp );
    }
    //--------------------------------------------------------------------------
    ThirdPart::UTFString::size_type UTFString::_verifyUTF8( const std::string& str )
    {
        std::string::const_iterator i, ie = str.end();
        i = str.begin();
        size_type length = 0;
        ...
        if(mBuffer.mVoidBuffer != 0) 
        {
            switch(mBufferType)
            {
                ...
                default:
                    ...
                    N_assert(0, "This should never happen - mVoidBuffer should never"
                        "contain something if we don't know the type");
                    break;
            }
            mBuffer.mVoidBuffer = 0;
            mBufferSize = 0;
