    ...
    */
    ...
    public:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        void add(PropertyScriptSys * obj);

        /** 移去脚本解析器
        @version NIIEngine 3.0.0
        */
        void remove(PropertyScriptSys * obj);

        /** 获取脚本解析器
        @param[in] ext 文件后缀类型
        @version NIIEngine 3.0.0
        */
        void getParser(const String & ext, PropertyScriptSys *& out);
    ...
    private:
        ...
        typedef multimap<NIIf, PropertyScriptSys *>::type ScriptSysList;
