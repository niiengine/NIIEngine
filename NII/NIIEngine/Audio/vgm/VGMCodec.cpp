...
namespace NII_MEDIA
{
    ...
    //------------------------------------------------------------------------
    bool VGMCodec::Init(const CStdString & strFile, NCount filecache)
    {
        if (!m_dll.Load())
        ...
        {
        case  8: m_DataFormat = SF_U8   ; break;
        case 16: m_DataFormat = SF_S16; break;
        case 32: m_DataFormat = SF_F; break;
        }
