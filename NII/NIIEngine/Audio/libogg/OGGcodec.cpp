...
namespace NII_MEDIA
{
    ...
    //------------------------------------------------------------------------
    AudioChannel OGGCodec::GetChannelInfo()
    {
        static AudioChannelType map[8][9] =
        {
            {ACT_FC, ACT_Unknow},
            {ACT_FL, ACT_FR, ACT_Unknow},
            {ACT_FL, ACT_FC, ACT_FR, ACT_Unknow},
            {ACT_FL, ACT_FR, ACT_BL, ACT_BR, ACT_Unknow},
            {ACT_FL, ACT_FC, ACT_FR, ACT_BL, ACT_BR, ACT_Unknow},
            {ACT_FL, ACT_FC, ACT_FR, ACT_BL, ACT_BR, ACT_LEF, ACT_Unknow},
            {ACT_FL, ACT_FC, ACT_FR, ACT_SL, ACT_SR, ACT_BL, ACT_BR, ACT_Unknow},
            {ACT_FL, ACT_FC, ACT_FR, ACT_SL, ACT_SR, ACT_BL, ACT_BR, ACT_LEF, ACT_Unknow}
        };
