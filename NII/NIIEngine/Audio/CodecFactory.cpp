...
ICodec * CodecFactory::CreateCodecDemux(const CStdString & strFile, const CStdString & strContent, NCount filecache)
{
...
ICodec * CodecFactory::CreateOGGCodec(const CStdString & strFile, NCount filecache)
{
