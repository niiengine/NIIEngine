    ...
    */
    ...
    public:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        inline void setSampleFormat(SampleFormat sf)        { mFormat = sf; }

        /** 获取音频量化位宽
        @version NIIEngine 3.0.0
        */
        inline SampleFormat getSampleFormat()               { return mFormat; }

        /** 设置样本频率
        @version NIIEngine 3.0.0
        */
        inline void setSampleRate(SampleRate sr)            { mSampleRate = sr; }

        /** 获取样本频率
        @version NIIEngine 3.0.0
        */
        inline SampleRate getSampleRate()                   { return (SampleRate)mSampleRate; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        inline NCount getSize()                             { return mSize; }

        /** 获取这段音频的长度(单位:秒)
        @version NIIEngine 3.0.0
        */
        inline TimeDurMS getLength()                        { return mLength; }
