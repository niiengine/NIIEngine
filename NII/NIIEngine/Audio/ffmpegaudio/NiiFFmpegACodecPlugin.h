...
#ifndef _NII_FFMPEGA_CODEC_PLUGIN_H_
#define _NII_FFMPEGA_CODEC_PLUGIN_H_

#include "NiiPreInclude.h"

#include "NiiPlugin.h"
#include "NiiFFmpegACodec.h"

namespace NII
{
    class FFmpegACodecPlugin : public Plugin
    {
    public:
        FFmpegACodecPlugin();
    ...
    private:
        static FFmpegACodec * msInstance;
    };
}
#endif