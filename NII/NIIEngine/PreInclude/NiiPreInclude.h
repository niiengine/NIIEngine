...
namespace NII
{
    ...
    */
    ...
    typedef vector<Pattern *>::type PatternList;
    typedef vector<RenderPattern *>::type RenderPatternList;
    typedef vector<ComputePattern *>::type ComputePatternList;
    ...
    typedef vector<NIIf>::type GBufferArray;
