...
#ifndef _NII_BOOST_THREADMANAGER_H_
#define _NII_BOOST_THREADMANAGER_H_
...
namespace NII
{
    ...
    */
    class _EngineAPI BoostThreadManager : public ThreadManager
    {
    public:
        BoostThreadManager(const String & name = StrUtil::BLANK);
        
        virtual ~BoostThreadManager(); 
