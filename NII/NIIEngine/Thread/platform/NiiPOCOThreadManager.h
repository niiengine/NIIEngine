...
#ifndef _NII_POCOThreadManager_H_
#define _NII_POCOThreadManager_H_
...
namespace NII
{
    ...
    */
    class _EngineAPI POCOThreadMananger : public ThreadManager
    {
    public:
        POCOThreadMananger(const String & name = StrUtil::BLANK);
        
        virtual ~POCOThreadMananger(); 
