...
#ifndef _NII_POSIX_THREADMANAGER_H_
#define _NII_POSIX_THREADMANAGER_H_
...
namespace NII
{
    ...
    */
    class _EngineAPI POSIXThreadMananger : public ThreadManager
    {
    public:
        POSIXThreadMananger(const String & name = StrUtil::BLANK);
        
        virtual ~POSIXThreadMananger(); 
