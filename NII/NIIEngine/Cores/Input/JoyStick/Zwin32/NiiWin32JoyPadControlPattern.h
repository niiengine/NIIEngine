...
#ifndef _NII_WIN32_JOYPAD_CONTROL_PATTERN_H_
#define _NII_WIN32_JOYPAD_CONTROL_PATTERN_H_
...
namespace NII_MEDIA
{
    ...
    */
    class Win32JoyPadControlPattern : public JoyPadControlPattern
    {
    public:
        /** 通过管理器类可以调用这个方法
        ...
        */
        Win32JoyPadControlPattern(Nid id, IDirectInput8 * pdi, GUID guid);

        /// 这个方法把这个实例从输入管理器中移去
        ~Win32JoyPadControlPattern();
