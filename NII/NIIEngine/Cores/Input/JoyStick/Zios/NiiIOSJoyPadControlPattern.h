...
#ifndef _NII_IOS_JOYPAD_CONTROL_PATTERN_H_
#define _NII_IOS_JOYPAD_CONTROL_PATTERN_H_
...
namespace NII_MEDIA
{
    ...
    */
    class IOSJoyPadControlPattern : public JoyPadControlPattern
    {
    public:
        /** 通过管理器类可以调用这个方法
        ...
        */
        IOSJoyPadControlPattern(Nid id);

        ~IOSJoyPadControlPattern();
