...
#ifndef _NII_OSX_CONTROLPATTERN_MANAGER_PLUGIN_H_
#define _NII_OSX_CONTROLPATTERN_MANAGER_PLUGIN_H_
...
namespace NII_MEDIA
{
    ...
    */
    class OSXControlPatternManagerPlugin : public Plugin
    {
    public:
        OSXControlPatternManagerPlugin();
