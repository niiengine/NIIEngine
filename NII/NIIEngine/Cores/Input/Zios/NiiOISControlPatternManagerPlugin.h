...
#ifndef _NII_OIS_CONTROL_PATTERN_MANAGER_PLUGIN_H_
#define _NII_OIS_CONTROL_PATTERN_MANAGER_PLUGIN_H_
...
namespace NII_MEDIA
{
    ...
    */
    class OISControlPatternManagerPlugin : public Plugin
    {
    public:
        OISControlPatternManagerPlugin();
