...
#ifndef _NII_LINUX_TOUCH_CONTROLPATTERN_H_
#define _NII_LINUX_TOUCH_CONTROLPATTERN_H_

#include "NiiTouchControlPattern.h"

namespace NII
{
    /** 这是一个专门为NII引擎包装的Linux触屏部分
    @author 冇得弹
    @mail zelda_ok@163.com
    */
    class _EngineAPI LinuxTouchControlPattern : public TouchControlPattern
    {
    public:
        LinuxTouchControlPattern(Nid id);

        ~LinuxTouchControlPattern();
