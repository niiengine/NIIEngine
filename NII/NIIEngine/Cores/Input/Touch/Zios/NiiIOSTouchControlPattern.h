...
#ifndef _NII_IOS_TOUCH_CONTROLPATTERN_H_
#define _NII_IOS_TOUCH_CONTROLPATTERN_H_

#include "NiiMultiTouchControlPattern.h"

namespace NII
{
    /** 这是一个专门为NII引擎包装的OIS触屏部分
    @author 冇得弹
    @mail zelda_ok@163.com
    */
    class _EngineAPI OISTouchControlPattern : public TouchControlPattern 
    {
    public:
        OISTouchControlPattern(Nid id);
        
        ~OISTouchControlPattern();    
