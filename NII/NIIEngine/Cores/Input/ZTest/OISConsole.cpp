...
void doStartup()
{
	...
	pl.insert(Npair(std::string("WINDOW"), wnd.str()));

	//Default mode is foreground exclusive..but, we want to show mouse - so nonexclusive
//	pl.insert(Npair(std::string("w32_mouse"), std::string("DISCL_FOREGROUND" )));
//	pl.insert(Npair(std::string("w32_mouse"), std::string("DISCL_NONEXCLUSIVE")));
#elif defined OIS_LINUX_PLATFORM
...
//	pl.insert(Npair(std::string("x11_mouse_grab"), std::string("false")));
//	pl.insert(Npair(std::string("x11_mouse_hide"), std::string("false")));
#elif defined OIS_APPLE_PLATFORM
