...
namespace NII
{
    ...
    //typedef   Nui16	utf16;  // removed typedef to prevent usage, as utf16 is not supported (yet)
    typedef		Nui32	utf32;
    ...
    \brief
        ...
        as such.
    */
    class _EngineAPI String : public UIAlloc
    {
    public:
        typedef utf32           value_type;         //!< Basic 'code point' type used for String (utf32)
        typedef NCount          size_type;          //!< Unsigned type used for size values and indices
    ...
    public:
        ...
        */
        ...
        /*!
        \brief Construct a new string object and initialise it with code-points from the range [beg, end).
        @param beg Iterator describing the start of the data to be used when initialising the String object
        @param end Iterator describing the (exclusive) end of the data to be used when initialising the String object
        @return Nothing
        */
        ...
        /*!
        \brief Constructs a new String object and initialise it using the provided c-string.
        @param c_str Pointer to a c-string.
        @return Nothing
        \exception std::length_error Thrown if resulting String object would be too big.
        */
        ...
        /*!
        \brief Constructs a new String object and initialise it using characters from the provided char array.
        @param chars char array.
        @param chars_len Number of chars from the array to be used.
        @return Nothing
        \exception std::length_error	Thrown if resulting String object would be too big.
        */
        ...
        @return Number of code points currently in the String
        */
        ...
        */
        ...
        /*!
        \brief Compares this String with the String 'str'.
        @note This does currently not properly consider Unicode and / or the system locale.
        @param str The String object that is to compared with this String.
        @return
        ...
        */
        ...
        /*!
        \brief Compares this String with the std::string 'std_str'.
        @note This does currently not properly consider Unicode and / or the system locale.
        @param std_str The std::string object that is to compared with this String.
        @note
        ...
        */
        ...
        @return
            ...
            @note A code unit does not equal a code point.  A utf32 code point, when encoded as utf8, can occupy between 1 and 4 code units.
        ...
        */
        size_type	utf8_stream_len(size_type num = npos, size_type idx = 0) const
        {
            ...
            return encoded_size(&ptr()[idx], N_MIN(size_type, num, maxlen));
        }
    ...
    private:
        ...
        *************************************************************************/
        ...
        size_type encode(const utf32* src, utf8* dest, size_type dest_len, size_type src_len = 0) const
        {
            ...
            for (NCount idx = 0; idx < src_len; ++idx)
            {
                utf32	cp = src[idx];
        ...
        size_type encode(const utf8* src, utf32* dest, size_type dest_len, size_type src_len = 0) const
        {
            ...
            for (NCount idx = 0; ((idx < src_len) && (destCapacity > 0));)
            {
                utf32	cp;
                utf8	cu = src[idx++];
    ...
    */
    bool _EngineAPI	operator==(const String& str1, const String& str2);

    /*!
    \brief
        Return true if String \a str is equal to std::string \a std_str
    */
    bool _EngineAPI	operator==(const String& str, const std::string& std_str);

    /*!
    \brief
        Return true if String \a str is equal to std::string \a std_str
    */
    bool _EngineAPI	operator==(const std::string& std_str, const String& str);

    /*!
    \brief
        Return true if String \a str is equal to null-terminated utf8 data \a utf8_str
    */
    bool _EngineAPI	operator==(const String& str, const utf8* utf8_str);

    /*!
    \brief
        Return true if String \a str is equal to null-terminated utf8 data \a utf8_str
    */
    bool _EngineAPI	operator==(const utf8* utf8_str, const String& str);
    ...
    */
    bool _EngineAPI	operator==(const String& str, const char* c_str);

    /*!
    \brief
        Return true if c-string \a c_str is equal to String \a str
    */
    bool _EngineAPI	operator==(const char* c_str, const String& str);
    ...
    */
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const String& str1, const String& str2);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const String& str, const std::string& std_str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const std::string& std_str, const String& str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const String& str, const utf8* utf8_str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const utf8* utf8_str, const String& str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const String& str, utf32 code_point);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(utf32 code_point, const String& str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const String& str, const char* c_str);
    ...
    \exception std::length_error	Thrown if the resulting String would be too large.
    */
    String _EngineAPI	operator+(const char* c_str, const String& str);


    //////////////////////////////////////////////////////////////////////////
    // Output (stream) functions
    //////////////////////////////////////////////////////////////////////////
    _EngineAPI std::ostream& operator<<(std::ostream& s, const String& str);
    ...
    @return
        Nothing
    */
    void _EngineAPI swap(String& str1, String& str2);
    ...
    */
    struct StringFastLessCompare
    {
        ...
        {
            const NCount la = a.length();
            const NCount lb = b.length();
            if (la == lb)
    ...
    typedef std::basic_string<char, std::char_traits<char>, STLAllocatorWrapper<char, AllocatorConfig<StlAlloc>::Allocator> > String;
