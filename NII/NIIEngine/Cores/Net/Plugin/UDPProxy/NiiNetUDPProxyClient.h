...
/// \details Used when RouterMapClient fails
...
namespace NII_NET
{
    ...
    struct UDPProxyClientResultHandler
    {
        ...
        /// \param[out] sourceAddress \a sourceAddress parameter passed to UDPProxyClient::RequestForwarding. If it was Address::invalid, it is now our external IP address.
        ...
        virtual void OnForwardingSuccess(const String & proxyIPAddress, Nui16 proxyPort,
            Address * proxyCoordinator, Address * sourceAddress, Address * targetAddress,
                UniqueID targetGuid, UDPProxyClient * proxyClientPlugin)=0;
        ...
        /// \param[out] targetGuid \a targetGuid parameter originally passed to UDPProxyClient::RequestForwarding
        /// \param[out] proxyClient The plugin that is calling this callback
        virtual void OnForwardingNotification(const String & proxyIPAddress, Nui16 proxyPort,
            Address * proxyCoordinator, Address * sourceAddress, Address * targetAddress,
                UniqueID targetGuid, UDPProxyClient * proxyClientPlugin)=0;
        ...
        /// \param[out] targetGuid \a targetGuid parameter originally passed to UDPProxyClient::RequestForwarding
        /// \param[out] proxyClient The plugin that is calling this callback
        virtual void OnNoServersOnline(Address * proxyCoordinator, Address * sourceAddress,
            Address * targetAddress, UniqueID targetGuid, UDPProxyClient * proxyClientPlugin)=0;
        ...
        /// \param[out] targetGuid \a targetGuid parameter originally passed to UDPProxyClient::RequestForwarding
        /// \param[out] proxyClient The plugin that is calling this callback
        virtual void OnRecipientNotConnected(Address * proxyCoordinator,
            Address * sourceAddress, Address * targetAddress, UniqueID targetGuid,
                UDPProxyClient * proxyClientPlugin) = 0;
        ...
        /// \param[out] targetGuid \a targetGuid parameter originally passed to UDPProxyClient::RequestForwarding
        /// \param[out] proxyClient The plugin that is calling this callback
        virtual void OnAllServersBusy(Address * proxyCoordinator, Address * sourceAddress,
            Address * targetAddress, UniqueID targetGuid, UDPProxyClient * proxyClientPlugin)=0;
        ...
        /// \param[out] targetGuid \a targetGuid parameter originally passed to UDPProxyClient::RequestForwarding
        /// \param[out] proxyClient The plugin that is calling this callback
        virtual void OnForwardingInProgress(const String & proxyIPAddress, Nui16 proxyPort,
            Address * proxyCoordinator, Address * sourceAddress, Address * targetAddress,
                UniqueID targetGuid, UDPProxyClient * proxyClientPlugin) = 0;
    };
    ...
    /// \sa RouterMapClient
    /// \ingroup UDP_PROXY_GROUP
    class _EngineAPI UDPProxyClient : public Plugin
    {
    public:
        UDPProxyClient();
        ~UDPProxyClient();
        ...
        /// \param[in] sourceAddress External IP address of the system we want to forward messages from. This does not have to be our own system. To specify our own system, you can pass Address::invalid which the coordinator will treat as our external IP address.
        ...
        bool RequestForwarding(Address * proxyCoordinator, Address * sourceAddress,
            Address * targetAddressAsSeenFromCoordinator, TimeDurMS timeoutOnNoDataMS,
                NetSerializer * serverSelectionBitstream = 0);

        /// Same as above, but specify the target with a UniqueID, in case you don't know what its address is to the coordinator
        ...
        bool RequestForwarding(Address * proxyCoordinator, Address * sourceAddress,
            UniqueID targetGuid, TimeDurMS timeoutOnNoDataMS,
                NetSerializer * serverSelectionBitstream = 0);
        ...
        struct PingServerGroup
        {
            ...
            TimeDurMS startPingTime;
            Address * coordinatorAddressForPings;
            DataStructures::List<ServerWithPing> serversToPing;
            bool AreAllServersPinged(void) const;
            void SendPingedServersToCoordinator(LinkBase * linkbase);
        };

        DataStructures::List<PingServerGroup *> pingServerGroups;
    protected:
        void OnPingServers(SocketMessage * msg);
        void Clear(void);
