...
namespace NII_NET
{
    ...
    class AutopatcherRepositoryInterface : public BufferReadBase
    {
    public:
        ...
        virtual bool GetChangelistSinceDate(const char *applicationName, FileList *addedOrModifiedFilesWithHashData, FileList *deletedFiles, NIId sinceDate)=0;
        ...
        virtual bool GetMostRecentChangelistWithPatches(
            ...
            NIId * priorRowPatchTime,
            NIId * mostRecentRowPatchTime)=0;
