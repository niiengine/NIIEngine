...
namespace NII_NET
{
    ...
    public:
        ...
        RakString GetName(void) const {return name;}
        void SetName(const char *str) {name = str;}
        void SetSystemAddress(const Address &sa) {mAddress = *sa;}
        Address * GetSystemAddress(void) const {return mAddress;}
        void SetGUID(UniqueID g) {guid=g;}
        UniqueID GetGUID(void) const {return guid;}
    ...
    typedef RakString GameIdentifier;
    ...
    struct Slots
    {
        ...
        ~Slots();
        NCount publicSlots;
        NCount reservedSlots;
        NCount spectatorSlots;
        NCount GetTotalSlots(void) const {return publicSlots+reservedSlots+spectatorSlots;}
    ...
    //	RoomsParticipant *removedUser;
        ...
        Address * removedUserAddress;
        RakString removedUserName;
    ...
    struct JoinedRoomResult
    {
        ...
        RakString acceptedInvitorName;
        Address * acceptedInvitorAddress;
        RoomsParticipant* joiningMember;
        RakString joiningMemberName;
        Address * joiningMemberAddress;
        UniqueID joiningMemberGuid;
    ...
    struct RoomCreationParameters
    {
        ...
        RoomsErrorCode Validate(
            const DataStructures::List<RakString> &otherRoomNames,
    ...
    struct RoomQuery
    {
        ...
        void AddQuery_NUMERIC(const char *columnName, NIId numericValue, DataStructures::Table::FilterQueryType op=DataStructures::Table::QF_EQUAL);
    ...
    class AllGamesRoomsContainer
    {
        ...
        RoomsErrorCode SendInvite(RoomsParticipant* roomsParticipant, RoomsParticipant* inviteeId, bool inviteToSpectatorSlot, RakString subject, RakString body);
        RoomsErrorCode AcceptInvite(RoomID roomId, Room **room, RoomsParticipant* roomsParticipant, RakString inviteSender);
        ...
        RoomsErrorCode ChangeRoomName(RoomsParticipant* roomsParticipant, RakString newRoomName, ProfanityFilter *profanityFilter);
        ...
        RoomsErrorCode KickMember(RoomsParticipant* roomsParticipant, RoomsParticipant *kickedParticipant, RakString reason);
        RoomsErrorCode UnbanMember(RoomsParticipant* roomsParticipant, RakString name);
        RoomsErrorCode GetBanReason( RoomID lobbyRoomId, Room **room, RakString name, RakString *reason);
        RoomsErrorCode LeaveRoom(RoomsParticipant* roomsParticipant, RemoveUserResult *removeUserResult);
        //RoomsErrorCode GetKickReason(RoomsParticipant* roomsParticipant, RakString *kickReason);
        ...
        RoomsErrorCode SearchByFilter(GameIdentifier gameIdentifier,
            RoomsParticipant * roomsParticipant, RoomQuery *roomQuery,
        ...
        NCount GetPropertyIndex(RoomID lobbyRoomId, const char * propertyName) const;
        ...
        Room * GetRoomByName(RakString roomName);
    protected:
        RoomID nextRoomId;
    };
    ...
    protected:
        RoomsErrorCode CreateRoom(RoomCreationParameters * roomCreationParameters,
            ProfanityFilter *profanityFilter, RoomID lobbyRoomId, bool validate);
        ...
        RoomsErrorCode RemoveUserFromQuickJoin(RoomsParticipant* roomsParticipant, QuickJoinUser **qju);
        bool IsInQuickJoin(RoomsParticipant* roomsParticipant);
        NCount GetQuickJoinIndex(RoomsParticipant* roomsParticipant);
        void GetRoomNames(DataStructures::List<RakString> &roomNames);
    ...
    public:
        ...
        ~Room();
        RoomsErrorCode SendInvite(RoomsParticipant* roomsParticipant, RoomsParticipant* inviteeId, bool inviteToSpectatorSlot, RakString subject, RakString body);
        RoomsErrorCode AcceptInvite(RoomsParticipant* roomsParticipant, RakString inviteSender);
        RoomsErrorCode StartSpectating(RoomsParticipant* roomsParticipant);
        RoomsErrorCode StopSpectating(RoomsParticipant* roomsParticipant);
        RoomsErrorCode GrantModerator(RoomsParticipant* roomsParticipant, RoomsParticipant *newModerator, DataStructures::List<InvitedUser> &clearedInvites);
        RoomsErrorCode ChangeSlotCounts(RoomsParticipant* roomsParticipant, Slots slots);
        ...
        RoomsErrorCode AreAllMembersReady(NCount exceptThisIndex, bool *allReady);
        RoomsErrorCode KickMember(RoomsParticipant* roomsParticipant, RoomsParticipant *kickedParticipant, RakString reason);
        RoomsErrorCode UnbanMember(RoomsParticipant* roomsParticipant, RakString name);
        RoomsErrorCode GetBanReason(RakString name, RakString *reason);
        RoomsErrorCode LeaveRoom(RoomsParticipant* roomsParticipant, RemoveUserResult *removeUserResult);
        ...
        NIId GetNumericProperty(RoomID lobbyRoomId, const char *propertyName) const;
        const char *GetStringProperty(RoomID lobbyRoomId, const char *propertyName) const;

        NIId GetNumericProperty(int index) const;
        const char *GetStringProperty(int index) const;
        void SetNumericProperty(int index, NIId value);
    ...
    protected:
        ...
        bool HasInvite(RakString roomsParticipant);
        NCount GetRoomIndex(RoomsParticipant * roomsParticipant) const;
        NCount GetBannedIndex(RakString username) const;
        NCount GetInviteIndex(RakString invitee, RakString invitor) const;
        NCount GetFirstInviteIndex(RakString invitee) const;
