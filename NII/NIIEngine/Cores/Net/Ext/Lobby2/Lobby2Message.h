...
namespace NII_NET
{
    ...
    /// The system can be extended by deriving from Lobby2Message, adding your own input and output parameters, and deriving from Lobby2MessageFactory register your own class factory with Lobby2Plugin::SetMessageFactory()
    /// \ingroup LOBBY_2_COMMANDS
    struct Lobby2Message
    {
        ...
        // export data in this class. Currently just the resultCode
        void writeBase(bool result, NetSerializer * in);

        void readBase(bool result, NetSerializer * out);
        
        /// Overridable serialization of the contents of this message.
        virtual void write(bool result, NetSerializer * in);

        virtual void read(bool result, NetSerializer * out);
        ...
        bool ValidateHandle( RakString *handle );

        /// Binary data cannot be longer than L2_MAX_BINARY_DATA_LENGTH
        bool ValidateBinary( SharedPtr<BinaryDataBlock>binaryDataBlock);

        /// Required text cannot be empty.
        bool ValidateRequiredText( RakString *text );

        /// Passwords must contain at least 5 characters
        bool ValidatePassword( RakString *text );

        /// Check email address format
        bool ValidateEmailAddress( RakString *text );
        ...
        virtual void DebugMsg(RakString &out) const=0;

        /// Print the result of DebugMsg
        virtual void DebugPrintf(void) const
        {
            RakString out; DebugMsg(out); printf(out.C_String());
        }
        ...
        virtual bool WasCompleted(Lobby2Plugin * client) {(void) client; return false;}
    ...
    struct IndexedBinaryValue
    {
        ...
        IndexedBinaryValue(unsigned int idx, char * val, unsigned short valLength) :
            index(idx), value(val), valueByteLength(valLength)
        {
            searchOperator=-1;
            type=(unsigned char)-1;
        }
    ...
    struct CreateAccountParameters
    {
        ...
        {
            ageInDays = 0;
            binaryData = OP_NEW<BinaryDataBlock>();
        }
        ~CreateAccountParameters(){}
        /// [in] Self-apparent
        RakString firstName;
        /// [in] Self-apparent
        RakString middleName;
        /// [in] Self-apparent
        RakString lastName;
        /// [in] Self-apparent
        RakString race;
        ...
        bool sex_male;
        /// [in] Self-apparent
        RakString homeAddress1;
        /// [in] Self-apparent
        RakString homeAddress2;
        /// [in] Self-apparent
        RakString homeCity;
        /// [in] Self-apparent
        RakString homeState;
        /// [in] Self-apparent
        RakString homeCountry;
        /// [in] Self-apparent
        RakString homeZipCode;
        /// [in] Self-apparent
        RakString billingAddress1;
        /// [in] Self-apparent
        RakString billingAddress2;
        /// [in] Self-apparent
        RakString billingCity;
        /// [in] Self-apparent
        RakString billingState;
        /// [in] Self-apparent
        RakString billingCountry;
        /// [in] Self-apparent
        RakString billingZipCode;
        /// [in] Self-apparent
        RakString emailAddress;
        /// [in] Self-apparent
        RakString password;
        /// [in] If the user needs to retrieve their password; you could ask them this question.
        RakString passwordRecoveryQuestion;
        /// [in] If the user needs to retrieve their password; you could use this for the answer.
        RakString passwordRecoveryAnswer;
        ...
        /// [in] binary data
        SharedPtr<BinaryDataBlock> binaryData;
    ...
    struct FriendInfo
    {
        ...
        void write(NetSerializer * in)
        {
            usernameAndStatus.write(in);
        }
        void read(NetSerializer * out)
        {
            usernameAndStatus.read(out);
        }
    };
    struct EmailResult
    {
    ...
    {
        MatchParticipant() {}
        MatchParticipant(RakString _handle, NIIf _score) : handle(_handle), score(_score) {}
        RakString handle;
        NIIf score;
    ...
    struct ClanInfo
    {
        ...
        RakString clanLeader;
        SharedPtr<BinaryDataBlock> binaryData;
        DataStructures::List<RakString> clanMembersOtherThanLeader;
    ...
    struct OpenInvite
    {
        RakString clanHandle;
        void write(NetSerializer * in);
        void read(NetSerializer * out);
    };
    struct ClanJoinRequest
    {
        RakString targetClan;
        RakString dateSent;
        RakString joinRequestSender;
        void write(NetSerializer * in);
        void read(NetSerializer * out);
    };
    struct ClanJoinInvite
    {
        RakString sourceClan;
        RakString dateSent;
        RakString joinRequestTarget;
        void write(NetSerializer * in);
        void read(NetSerializer * out);
    };
    struct BookmarkedUser
    {
        RakString targetHandle;
        int type;
        RakString description;
    ...
    #define __L2_MSG_BASE_IMPL(__NAME__) \
        ...
        virtual void DebugMsg(RakString &out) const {out.Set(#__NAME__ " result=%s\n", Lobby2ResultCodeDescription::ToEnglish(resultCode));};
    ...
    struct System_RegisterProfanity : public Lobby2Message
    {
        ...
        // Input parameters
        DataStructures::List<RakString> profanityWords;
    ...
    struct CDKey_Add : public Lobby2Message
    {
        ...
        // Input parameters
        DataStructures::List<RakString> cdKeys;
        RakString titleName;
    ...
    struct Client_Login : public Lobby2Message
    {
        ...
        // Output parameters
        RakString bannedReason;
        RakString whenBanned;
        RakString bannedExpiration;
    };
    ...
    struct Client_GetIgnoreList : public Lobby2Message
    {
        ...
        // Output parameters
        DataStructures::List<RakString> ignoredHandles;
    };
    ...
    struct Emails_Send : public Lobby2Message
    {
        ...
        // Input parameters
        DataStructures::List<RakString> recipients;
        RakString subject;
        RakString body;
        int status;
        SharedPtr<BinaryDataBlock> binaryData;
    ...
    struct Clans_ChangeHandle : public Lobby2Message
    {
        ...
        // Input parameters
        RakString oldClanHandle;
        RakString newClanHandle;
    ...
    struct Clans_Leave : public Lobby2Message
    {
        ...
        virtual bool RequiresLogin(void) const {return true;}
        virtual void write(bool result, NetSerializer * in);
        virtual void read(bool result, NetSerializer * src);
        virtual bool PrevalidateInput(void);
        ...
        // Output parameters
        bool wasDissolved;
        RakString newClanLeader; // If not dissolved
    };
    ...
    struct Clans_AcceptJoinRequest : public Lobby2Message
    {
        ...
        int emailStatus;
        SharedPtr<BinaryDataBlock> binaryData;
        RakString requestingUserHandle;
        bool failIfAlreadyInClan;
    ...
    struct Clans_GetBlacklist : public Lobby2Message
    {
        ...
        // Output parameters
        DataStructures::List<RakString> blacklistedUsers;
    };
    ...
    struct Clans_GetList : public Lobby2Message
    {
        ...
        // Output parameters
        DataStructures::List<RakString> clanNames;
    };
    ...
    struct Clans_DestroyBoard : public Lobby2Message
    {
        ...
        virtual bool RequiresLogin(void) const {return true;}
        virtual void write(bool result, NetSerializer * in);
        virtual void reads(bool result, NetSerializer * out);
        virtual bool PrevalidateInput(void);
    ...
    struct Clans_GetBoards : public Lobby2Message
    {
        ...
        // Output parameters
        DataStructures::List<RakString> clanBoardsNames;
    ...
    struct Notification_Clans_KickAndBlacklistUser : public Lobby2Message
    {
        ...
        RakString clanHandle;
        RakString targetHandle;
        RakString blacklistingUserHandle;
    ...
    struct Notification_Clans_UnblacklistUser : public Lobby2Message
    {
        ...
        RakString unblacklistingUserHandle;
    };
    /// \ingroup LOBBY_2_NOTIFICATIONS
    ...
    #define __L2_ALLOCATE_AND_DEFINE(FACTORY, __TYPE__,VAR_NAME) __TYPE__ *VAR_NAME = (__TYPE__ *) FACTORY->Alloc(L2MID_##__TYPE__); N_assert(VAR_NAME);
    #define __L2_MSG_FACTORY_BASE(__NAME__) {case L2MID_##__NAME__ : Lobby2Message *m = OP_NEW< __NAME__ >() ; N_assert(m->GetID()==L2MID_##__NAME__ ); m->requestId=nextRequestId++; return m;}
    /// \ingroup LOBBY_2_GROUP
    ...
    //			__L2_MSG_FACTORY_BASE(Notification_Console_RoomMemberConnectivityUpdate);
        ...
        void Dealloc(Lobby2Message * msg)
        {
            ...
            if (msg->GetRefCount() <= 0)
            {
                ...
                if (msg->GetRefCount() <= 0)
                    OP_DELETE<Lobby2Message>(msg);
                deallocateLockMutex.Unlock();
            }
        }

        unsigned int nextRequestId;
        ThreadMutex deallocateLockMutex;
    };
}
}
#endif