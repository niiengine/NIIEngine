...
namespace NII_NET
{
    ...
    public:
        ...
        /// \return True on success, false on failure.
        virtual bool GetChangelistSinceDate(const char *applicationName, FileList *addedOrModifiedFilesWithHashData, FileList *deletedFiles, NIId sinceDate);
        ...
        // Not yet implemented
        virtual bool GetMostRecentChangelistWithPatches(RakString &applicationName,
        ...
        ThreadMutex filePartConnectionMutex;
    };
}
}
#endif