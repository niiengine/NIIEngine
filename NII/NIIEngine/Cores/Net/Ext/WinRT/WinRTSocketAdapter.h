...
{     
	...
	int getSockName(Windows::Networking::Sockets::DatagramSocket ^s,
	...
	int inetAddr(const char * cp);
	
	int ioctlSocket(Windows::Networking::Sockets::DatagramSocket ^s,
                        long cmd,
                        unsigned long *argp);
	...
	int setSockOpt(Windows::Networking::Sockets::DatagramSocket ^s,
                       int level,
                       int optname,
                       const char * optval,
                       socklen_t optlen);

	int setSockOpt(Windows::Networking::Sockets::StreamSocket ^s,
                       int level,
                       int optname,
                       const char * optval,
                       socklen_t optlen);
