...
namespace NII_NET
{
    ...
    class RAK_DLL_EXPORT RakVoice : public Plugin
    {
    public:
        RakVoice();
        virtual ~RakVoice();
        ...
        void RequestVoiceChannel(UniqueID recipient);
        ...
        void CloseVoiceChannel(UniqueID recipient);
        ...
        bool SendFrame(UniqueID recipient, void * inputBuffer);
        ...
        bool IsSendingVoiceDataTo(UniqueID recipient);
        ...
        /// How many bytes are on the write buffer, waiting to be passed to a call to NetworkSys::send (internally)
        /// This should remain at a fairly small near-constant size as outgoing data is sent to the send function
        /// \param[in] guid The system to query, or Address::getInvalid() for the sum of all channels.
        /// \return Number of bytes on the write buffer
        unsigned GetBufferedBytesToSend(UniqueID guid) const;
        ...
        unsigned GetBufferedBytesToReturn(UniqueID guid) const;
    ...
    protected:
        void OnOpenChannelRequest(SocketMessage * msg);
        void OnOpenChannelReply(SocketMessage * msg);
        virtual void OnVoiceData(SocketMessage * msg);
        void OpenChannel(SocketMessage * msg);
        void FreeChannelMemory(UniqueID recipient);
        ...
        DataStructures::OrderedList<UniqueID, VoiceChannel*, VoiceChannelComp> voiceChannels;
        int32_t sampleRate;
