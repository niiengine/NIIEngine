...
IGNORERAKPEERANDINTERFACE(GetSockets( DataStructures::List<SharedPtr<RakNetSocket> > &sockets ))
...
IGNORERAKPEERANDINTERFACE(SetIncomingDatagramEventHandler( bool (*_incomingDatagramEventHandler)(SocketMessageData *) ))
...
//ClusterNetworkObj
%ignore RakNet::ClusterNetworkObj::SendList;
%ignore RakNet::NetworkObj::SendList;
...
//SocketIO
%ignore RakNet::SocketIO::SendOrBuffer;
...
%ignore RakNet::PluginInterface2::init;
%ignore RakNet::PluginInterface2::shutdown;
...
%ignore RakNet::NatPunchthroughClient::OnNewConnection(SystemAddress systemAddress, RakNetGUID rakNetGUID, bool isIncoming);
	/// \internal For plugin handling
%ignore RakNet::NatPunchthroughClient::OnClosedConnection(SystemAddress systemAddress, RakNetGUID rakNetGUID, ConnectCloseType lostConnectionReason );
...
//Structs
%ignore RakNet::ConnectFailType;
%ignore RakNet::ConnectCloseType;
//These are internal
