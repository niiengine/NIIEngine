...
// %template(RakNetSmartPtrRakNetSocket) SharedPtr<RakNetSocket>;

//Can't use the macro because it won't include the space then nested templates won't work
/*
%typemap(cscode) DataStructures::List<SharedPtr<RakNetSocket> >
%{
...
%template(RakNetListRakNetSmartPtrRakNetSocket) DataStructures::List <SharedPtr<RakNetSocket> >;
*/
