...
STRUCT_CUSTOM_GENERAL_ARRAY_TYPEMAP_LOOP_COPY(bytesInSendBufferIsCached,bytesInSendBufferCache,double bytesInSendBuffer[ NUMBER_OF_PRIORITIES ],double,double,SetBytesInSendBuffer,RakNetStatistics_bytesInSendBuffer_get,RakNet::NetStats,PacketPriority.NUMBER_OF_PRIORITIES,(double));

STRUCT_CUSTOM_GENERAL_ARRAY_TYPEMAP_LOOP_COPY(messageInSendBufferIsCached,messageInSendBufferCache,unsigned messageInSendBuffer[ NUMBER_OF_PRIORITIES ],uint,int,SetMessageInSendBuffer,RakNetStatistics_messageInSendBuffer_get,RakNet::NetStats,PacketPriority.NUMBER_OF_PRIORITIES,(uint));

namespace RakNet
{
STRUCT_CUSTOM_GENERAL_ARRAY_TYPEMAP_LOOP_COPY(runningTotalIsCached,runningTotalCache,unsigned long long runningTotal [ RNS_PER_SECOND_METRICS_COUNT ],ulong,long,SetRunningTotal,RakNetStatistics_runningTotal_get,RakNet::NetStats,RNSPerSecondMetrics.RNS_PER_SECOND_METRICS_COUNT,(ulong));
STRUCT_CUSTOM_GENERAL_ARRAY_TYPEMAP_LOOP_COPY(valueOverLastSecondIsCached,valueOverLastSecondCache,unsigned long long valueOverLastSecond [ RNS_PER_SECOND_METRICS_COUNT ],ulong,long,SetValueOverLastSecond,RakNetStatistics_valueOverLastSecond_get,RakNet::NetStats,RNSPerSecondMetrics.RNS_PER_SECOND_METRICS_COUNT,(ulong));
}
...
%typemap(csbody) RakNet::NetStats 
%{
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal NetStats(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(NetStats obj) {
    if (obj != null)
    {
...
//This adds to the main RakNet class, generally used for globals
	...
	%{ 
	    ...
	    public static void StatisticsToString(NetStats s, out string buffer, int verbosityLevel) 
	    {
...
/*
%typemap(cscode) SharedPtr<RakNetSocket>
%{
...
%typemap(cscode) RakNet::NetStats
%{
