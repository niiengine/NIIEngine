    ...
    class TestMain
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            NetStats testRakNetStatistics = new NetStats();
            ...
            //RakNetGUID
            RakNetGUID testRakNetGUID = testClient.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS);
            ...
            testConnectionGraph2.ConnectionExists(testClient.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS), testServer.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS));
            SystemAddress[] outSystemAddressList = new SystemAddress[1];
            RakNetGUID[] outGuidList = new RakNetGUID[1];
            uint inOutUint = 1;
            testConnectionGraph2.GetConnectionListForRemoteSystem(testServer.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS), outSystemAddressList, outGuidList, ref inOutUint);
            ...
            testFullyConnectedMesh2.AddParticipant(testServer.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS));
            ...
            testNatPunchthroughClient.OpenNAT(testServer.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS), testClient.GetSystemAddressFromIndex(0));
            ...
            //ConnectReceiveType
            Console.WriteLine("ConnectReceiveType");
            ConnectReceiveType testPluginReceiveResult = new ConnectReceiveType();
            ...
            RemoteHash testRemoteSystemIndex = new RemoteHash();
            ...
            //ThreadMutex
            Console.WriteLine("ThreadMutex");
            ThreadMutex testSimpleMutex = new ThreadMutex();
            ...
            Thread.Sleep(1000);
            //testUDPForwarder.threadOperationIncomingMutex=new ThreadMutex();
           // testUDPForwarder.threadOperationOutgoingMutex=new ThreadMutex();
            ...
            testClient.getGUID(RakNet.RakNet.UNASSIGNED_SYSTEM_ADDRESS);
            ...
            testClient.addMessage(testPacket,true);
