...
const NIIf CAMERA_HEIGHT=50.0f;
const NIIf SHOT_SPEED=.6f;
const NIIf BALL_DIAMETER=25.0f;
...
public:
	...
	TimeDurMS shootFromOrigin(core::vector3df camPosition, core::vector3df camAt);
...
private:
	...
	scene::IParticleSpaceSceneNode* campFire;
	...
	DataStructures::Multilist<ML_QUEUE, RakString> outputMessages;
	TimeDurMS whenOutputMessageStarted;
	void PushMessage(RakString rs);
