...
#pragma warning(disable: 4127)
    ...
    Nui8 * CSHA1::GetHash( void ) const
    {
        return ( Nui8 * ) m_digest;
    }
    //------------------------------------------------------------------------
    ...
    void CSHA1::HMAC(Nui8 *sharedKey, int sharedKeyLength, Nui8 *data, int dataLength, Nui8 output[SHA1_LENGTH])
    {
        ...
        Nui8 keyWithIpad[sha1BlockLength];
        Nui8 keyWithOpad[sha1BlockLength];
