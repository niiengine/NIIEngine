...
public:
    ...
    Nui8 * GetHash(void) const;
    // KevinJ: http://cseweb.ucsd.edu/~mihir/papers/hmac-cb.pdf
	static void HMAC(Nui8 * sharedKey, int sharedKeyLength, Nui8 * data, int dataLength, Nui8 output[SHA1_LENGTH]);
private:
