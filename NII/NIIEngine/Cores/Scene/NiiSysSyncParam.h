    ...
    */
    ...
    public:
        ...
        */
        ...
        inline void setAmbient(const Colour& ambient)                   { mAmbient = ambient; }
        inline const Colour & getAmbient() const                        { return mAmbient; }
        inline const Colour & getChAmbient() const                      { return mCurrentShaderCh->getColour().getAmbient(); }
        inline const Colour & getChDiffuse() const                      { return mCurrentShaderCh->getColour().getDiffuse(); }
        inline const Colour & getChSpecular() const                     { return mCurrentShaderCh->getColour().getSpecular(); }
        inline const Colour & getChEmissive() const                     { return mCurrentShaderCh->getColour().getEmissive(); }
        inline NIIf getChShininess() const                              { return mCurrentShaderCh->getColour().getShininess(); }
        inline Colour getEnvAmbient() const                             { return mAmbient * getChAmbient(); }
