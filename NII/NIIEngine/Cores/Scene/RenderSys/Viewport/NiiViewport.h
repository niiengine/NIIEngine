    ...
    */
    ...
    public:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        inline NIIi getMipMap() const                   { return mMipMap; }
    ...
    _EngineAPI void createViewport(ViewportList & out, NCount cnt, 
        Texture * buf, const Vector4 * area, const Vector4 * clip, Nui8 mipLevel, bool overlay);
        
    _EngineAPI void deleteViewport(ViewportList & in);
}
#endif