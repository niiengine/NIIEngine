...
int main(int numargs, char** args)
{
    ...
    // register the file buffer to tEmbeddedZipVFSFactory
	outFileDataPos+= sprintf(outFileDataPos, "\t\tEmbeddedZipVFSFactory::addEmbbeddedFile(fileName, fileData, sizeof(fileData), NULL);\n");
...
// 	outFileDataPos+= sprintf(outFileDataPos, "\t{\n");
//     // remove the file from tEmbeddedZipVFSFactory in the distractor (for the case of dynamic plugin unload?)
// 	outFileDataPos+= sprintf(outFileDataPos, "\t\tEmbeddedZipVFSFactory::removeEmbbeddedFile(fileName);\n");
// 	outFileDataPos+= sprintf(outFileDataPos, "\t}\n");
