							   ...
							   : wxPanel(parent, id, pos, size, style, name)
{
	...
	//MaterialController* controller = new MaterialController((MaterialPtr)MaterialManager::getSingletonPtr()->create("Test", GroupDefault));
	//TechniqueController* tc = controller->createTechnique();
	//PassController* pc = tc->create();
...
void PropertiesPanel::projectRemoved(EventArgs & args)
{
	...
	//           Materials, ShaderFusionList, and ShaderChList?
}

void PropertiesPanel::materialRemoved(EventArgs & args)
{
	// Consider: Should this method also attempt to remove all
	//           of the page associated with this Materials, ShaderFusionList,
	//           and ShaderChList?
...
{
	// Consider: Should this method also attempt to remove all
	//           of the page associated with this ShaderFusionList, ShaderChList?
