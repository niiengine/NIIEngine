...
#include "wx/wx.h"
	...
	*/
	...
	public:
		...
		inline Ogre::SpaceManager* getSceneManager() const {return mSceneMgr;}
		void setZoomScale(Ogre::NIIf zoomScale) {mZoomScale = zoomScale;}
	...
	private:
		...
		Ogre::Camera* mCamera;
		Ogre::SpaceManager* mSceneMgr;
		Ogre::ViewWindow* mRenderWindow;
		Ogre::SpaceNode *mCameraYawNode, *mCameraPitchNode;
		Ogre::SpaceNode *mLightYawNode, *mLightPitchNode;
		Ogre::NIIf mZoomScale;
		Ogre::Light* mLight;
