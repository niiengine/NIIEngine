    ...
    public:
        ...
        */
        DeformerMap& buildMeshForExport(
			...
			bool tangents, VertexType tangentSemantic, bool tangentsSplitMirrored, bool tangentsSplitRotated, bool tangentsUseParity,
			bool vertexAnimation, AnimationList& animList, NIIf fps, const String& materialPrefix = StringUtil::BLANK,
		...
		*/
		void exportMesh(const String& fileName, const AABox& skelAABB);
    ...
    protected:
        ...
        */
		...
		void buildMesh(Mesh* pMesh, bool mergeSubmeshes, bool lookForBoneAssignments, 
			bool vertexAnimation, AnimationList& animList, NIIf fps);
		...
		*/
		struct ProtoSubMesh
		{
			...
			Mesh::SkeletonVertexList boneAssignments;
			/// By-value pose list, build up ready for transfer later
			std::list<VertexOffset> poseList;
		...
		void exportAnimations(Mesh* pMesh, AnimationList& animList, NIIf fps);
