...
#pragma warning(pop)
	...
	void CgFxScriptLoader::CgStateListener::init()
	{
		...
		cgSetStateCallbacks(mCgState, getCgCallBackSet(), getCgCallBackReset(),
            getCgCallBackValidate());
	...
	void CgFxScriptLoader::CgBoolGlobalStateListener::updatePass( Pass * ogrePass, CGstateassignment cgStateAssignment )
	{
		...
		case GST_DEPTHTESTENABLE:
			break;
		case GST_ZENABLE:
			ogrePass->setStencil(ShaderCh::SOT_Set)->setDepthEnable(value);
			break;
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgStencilFuncSeparateGlobalStateListener::updatePass(
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgStencilMaskSeparateGlobalStateListener::updatePass(
        Pass * ogrePass, CGstateassignment cgStateAssignment)
	{
		switch(getValue(cgStateAssignment).x)
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgStencilOpSeparateGlobalStateListener::updatePass(
        Pass * ogrePass, CGstateassignment cgStateAssignment)
	{
		switch(getValue(cgStateAssignment).x)
		{
	...
	CgFxScriptLoader::CgSamplerStateListener::CgSamplerStateListener(
        SamplerStateType samplerStateType, CGtype cgType ) :
            CgStateListener(cgType),
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgSamplerStateListener::upateTextureUnitState(
        ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment)
	{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgIntSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgBoolSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgFloatSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( mSamplerStateType )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgFloat4SamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( mSamplerStateType )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgTextureSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		parseTextureName(getCgParameter(cgStateAssignment), ogreTextureUnitState);
	}
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgTextureSamplerStateListener::parseTextureName( CGparameter cgParameter, ShaderChTextureUnit * ogreTextureUnitState )
	{
		...
		if (cgAnnotation && cgGetAnnotationType(cgAnnotation) == CG_STRING)
		{
			...
			if (textureName)
			{
				ogreTextureUnitState->setSrc(textureName, parseTextureType(cgParameter, ogreTextureUnitState));
			}
		}
	}
	//---------------------------------------------------------------------
	Texture::Type CgFxScriptLoader::CgTextureSamplerStateListener::parseTextureType( CGparameter cgParameter, ShaderChTextureUnit * ogreTextureUnitState )
	{
	...
	//---------------------------------------------------------------------
	//---------------------------------------------------------------------
	CgFxScriptLoader::CgWrapSamplerStateListener::CgWrapSamplerStateListener(
        const SamplerStateType samplerStateType) : 
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgWrapSamplerStateListener::upateTextureUnitState(ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		TextureAddressingMode ogreTextureAddressingMode = ShaderChTextureUnit::TAM_REPEAT;
		ogreTextureAddressingMode = getOgreTextureAddressingMode(cgStateAssignment);

		TextureAddressing uvw = ogreTextureUnitState->getAddressingMode();

		switch(mSamplerStateType)
		{
		case SST_WRAPS:
			uvw.mS_U = ogreTextureAddressingMode;
			break;
		case SST_WRAPT:
			uvw.mT_V = ogreTextureAddressingMode;
			break;
		case SST_WRAPR:
			uvw.mR_W = ogreTextureAddressingMode;
			break;
		default:
			// todo - error
			break;
		}
        ogreTextureUnitState->setUAddressing(uvw.mS_U);
        ogreTextureUnitState->setVAddressing(uvw.mT_V);
        ogreTextureUnitState->setWAddressing(uvw.mR_W);
	}
	//---------------------------------------------------------------------
	TextureAddressingMode CgFxScriptLoader::CgWrapSamplerStateListener::getOgreTextureAddressingMode( CGstateassignment cgStateAssignment )
	{
		...
		case WT_REPEAT: // Repeat
			ogreTextureAddressingMode = ShaderChTextureUnit::TAM_REPEAT;
			break;
		case WT_CLAMP: // Clamp
			ogreTextureAddressingMode = ShaderChTextureUnit::TAM_CLAMP;
			break;
		case WT_CLAMPTOEDGE: // ClampToEdge
			ogreTextureAddressingMode = ShaderChTextureUnit::TAM_CLAMP;
			break;
		case WT_CLAMPTOBORDER: // ClampToBorder
			ogreTextureAddressingMode = ShaderChTextureUnit::TAM_BORDER;
			break;
		case WT_MIRROREDREPEAT: // MirroredRepeat
			ogreTextureAddressingMode = ShaderChTextureUnit::TAM_MIRROR;
			break;
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgCompareModeSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( getValue(cgStateAssignment) )
		{
		case CMT_NONE: // None
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgCompareFuncSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch(getValue(cgStateAssignment))
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgDepthModeSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( getValue(cgStateAssignment) )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgMinFilterSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( getValue(cgStateAssignment) )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgMagFilterSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( getValue(cgStateAssignment) )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgMipFilterSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( getValue(cgStateAssignment) )
		{
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::CgTextureAddressSamplerStateListener::upateTextureUnitState( ShaderChTextureUnit * ogreTextureUnitState, CGstateassignment cgStateAssignment )
	{
		switch( mSamplerStateType )
		{
		case SST_ADDRESSU:
    ...
    CgFxScriptLoader::~CgFxScriptLoader()
    {
		...
		{
			N_delete mCgStateListenerVector[i];
		}

		for(size_t i = 0 ; i < mCgSamplerStateListenerVector.size() ; i++)
		{
			N_delete mCgSamplerStateListenerVector[i];
		}
    ...
    //---------------------------------------------------------------------
    NIIf CgFxScriptLoader::getScriptLevel() const
    {
		// before the normal material manager - so a normal material can inherits from a cgfx material
		return 99.0f;
    }
	//---------------------------------------------------------------------
    void CgFxScriptLoader::parse(DataStream *& stream, const String & groupName)
    {
		String streamAsString(stream->getData(), stream->size());
		...
		checkForCgError("CgFxScriptLoader::parse",
	...
	void CgFxScriptLoader::parseCgEffectTechniques( CGeffect cgEffect, MaterialPtr ogreMaterial )
	{
		...
		while (cgTechnique)
		{
			ShaderFusion * ogreTechnique = ogreMaterial->createTechnique();
			...
			ogreTechnique->removeAll();
			parseCgTechnique(cgTechnique, ogreTechnique);
			cgTechnique = cgGetNextTechnique(cgTechnique);
		}
	}
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseCgTechnique(CGtechnique cgTechnique, ShaderFusion * ogreTechnique )
	{
		CGpass cgPass = cgGetFirstPass(cgTechnique);
		while(cgPass)
		{
			Pass * ogrePass = ogreTechnique->create();
	...
	void CgFxScriptLoader::parseCgProgram( CGpass cgPass, Pass * ogrePass, const GpuProgramType ogreProgramType )
	{
		...
		programName << (ogrePass->getParent()->getParent()->getCount() - 1) << "-"; // ShaderFusion number
		programName << ogrePass->getParent()->getName() << "|"; // ShaderFusion
		programName << (ogrePass->getParent()->getCount() - 1) << "-"; // Pass number
		...
		ogreProgram->setProgramCode(source);
		ogreProgram->set("entry_point", entry);
		ogreProgram->set("profiles", profile);

		//ogreProgram->load();
		if(ogreProgram->isValid())
		{
			ogreProgram->load();
			GpuProgramParam * ogreProgramParameters = ogreProgram->createDefaultParam();
			parseCgProgramParameters(cgPass, ogreProgramParameters);

			switch(ogreProgramType)
			{
			case GPT_VERTEX_PROGRAM:
                ogrePass->getProgram().set(ST_VS, 0, ogreProgram->getOriginID());
				break;
			case GPT_FRAGMENT_PROGRAM:
                ogrePass->getProgram().set(ST_FS, 0, ogreProgram->getOriginID());
				break;
			case GPT_GEOMETRY_PROGRAM:
                ogrePass->getProgram().set(ST_GS, 0, ogreProgram->getOriginID());
				break;
			}
		}
	}
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseCgProgramParameters(CGpass cgPass, GpuProgramParam * ogreProgramParameters )
	{
		CGeffect cgEffect = cgGetTechniqueEffect(cgGetPassTechnique(cgPass));

		GpuParamUnitList::const_iterator i, iend = ogreProgramParameters->getDefineList().end();
        for(i = ogreProgramParameters->getDefineList().begin(); i != iend; ++i)
		{
			// get the constant definition
			const String & ogreParamName = i->first;
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseCgProgramParameter( CGparameter cgParameter, GpuProgramParam * ogreProgramParameters, const String& ogreParamName )
	{
	...
	const char * CgFxScriptLoader::getGlobalStateNameTypeToString( const GlobalStateType cgStateName )
	{
		...
		case GST_PIXELSHADER: return "ST_FS";
	...
	//---------------------------------------------------------------------
	bool CgFxScriptLoader::cgSemanticToOgreAutoConstantType(const char * cgParamSemantic,
        const char * uiNameValue, GpuSyncParam & ogreAutoConstantType,
            size_t & extraInfo)
	{
		extraInfo = 0;
		...
		case FXS_COLOR:
			...
			return false;
		case FXS_DIFFUSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Ch_Diffuse;
			return true;
		case FXS_SPECULAR:
			ogreAutoConstantType = GpuProgramParam::GSP_Ch_Specular;
			return true;
		case FXS_AMBIENT:
			ogreAutoConstantType = GpuProgramParam::GSP_Ch_Ambient;
			return true;
		case FXS_EMISSION:
			// todo - add to ogre
			return false;
		case FXS_EMISSIVE:
			ogreAutoConstantType = GpuProgramParam::GSP_Ch_Emissive;
			return true;
		...
		case FXS_ATTENUATION:
			// todo - in ogre GSP_Light_Attenuation_ParamIndex is float4 and we need float3 here
			return false;
		...
		case FXS_CAMERAPOSITION:
			ogreAutoConstantType = GpuProgramParam::GSP_Camera_Pos;
			return true;
		case FXS_TIME:
			// todo - possibly this value is has the wrong units...
			ogreAutoConstantType = GpuProgramParam::GSP_Sys_CostTime;
			return true;
		case FXS_ELAPSEDTIME:
			// todo - possibly this value is has the wrong units...
			ogreAutoConstantType = GpuProgramParam::GSP_Frame_CostTime;
			return true;
		...
		case FXS_LEFTMOUSEDOWN:
			...
			return false;
		case FXS_WORLD:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Space;
			return true;
		case FXS_VIEW:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View;
			return true;
		case FXS_PROJECTION:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj;
			return true;
		case FXS_WORLDTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Space_Transpose;
			return true;
		case FXS_VIEWTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_Transpose;
			return true;
		case FXS_PROJECTIONTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_Transpose;
			return true;
		case FXS_WORLDVIEW:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_X_Space;
			return true;
		case FXS_WORLDVIEWPROJECTION:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_X_Space;
			return true;
		case FXS_WORLDINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Space_Inverse;
			return true;
		case FXS_VIEWINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_Inverse;
			return true;
		case FXS_PROJECTIONINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_Inverse;
			return true;
		case FXS_WORLDINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Space_InverseTranspose;
			return true;
		case FXS_VIEWINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_InverseTranspose;
			return true;
		case FXS_PROJECTIONINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_InverseTranspose;
			return true;
		case FXS_WORLDVIEWINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_X_Space_Inverse;
			return true;
		case FXS_WORLDVIEWTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_X_Space_Transpose;
			return true;
		case FXS_WORLDVIEWINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_View_X_Space_InverseTranspose;
			return true;
		case FXS_WORLDVIEWPROJECTIONINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_X_Space_Inverse;
			return true;
		case FXS_WORLDVIEWPROJECTIONTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_X_Space_Transpose;
			return true;
		case FXS_WORLDVIEWPROJECTIONINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_X_Space_InverseTranspose;
			return true;
		case FXS_VIEWPROJECTION:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View;
			return true;
		case FXS_VIEWPROJECTIONTRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_Transpose;
			return true;
		case FXS_VIEWPROJECTIONINVERSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_Inverse;
			return true;
		case FXS_VIEWPROJECTIONINVERSETRANSPOSE:
			ogreAutoConstantType = GpuProgramParam::GSP_Matrix_Proj_X_View_InverseTranspose;
			return true;
		...
		case FXS_UNKNOWN:
			if (uiNameValue)
			{
				...
				if (StringUtil::beginsWith(uiNameValueAsString, theWordLight, false))
				{
					...
					if (firstSpacePos > 0)
					{
						...
						{
							ogreAutoConstantType = GpuProgramParam::GSP_Light_Diffuse_ParamIndex;
							return true;
						}
						if ( colorPart == "Intensity" ) // float
						{
							ogreAutoConstantType = GpuProgramParam::GSP_Light_BrightFactor_ParamIndex;
							return true;
						}
						if ( colorPart == "Light_position" ) // float3
						{
							ogreAutoConstantType = GpuProgramParam::GSP_Light_Pos_ParamIndex;
							return true;
						}
						if ( colorPart == "Light_direction" ) // float3
						{
							ogreAutoConstantType = GpuProgramParam::GSP_Light_Dir_ParamIndex;
							return true;
						}
						if ( colorPart == "Distance Falloff Exponent" ) // float
						{
							//ogreAutoConstantType = todo: add to GpuProgramParam;
							return false;
						}
	...
	//---------------------------------------------------------------------
	bool CgFxScriptLoader::parseAutoConstantParam( CGparameter cgParameter, GpuProgramParam * ogreProgramParameters, const String& ogreParamName )
	{
		...
		if (cgParamSemantic)
		{
			GpuSyncParam ogreAutoConstantType;
			size_t extraInfo = 0;
			...
			if (isAutoConstant)
			{
				ogreProgramParameters->set(ogreParamName, ogreAutoConstantType, extraInfo);
			}
		}
		return isAutoConstant;
	}
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseFloatCgProgramParameter( CGtype cgParamType,
        CGparameter cgParameter, GpuProgramParam * ogreProgramParameters,
            const String & ogreParamName )
	{
		...
		ogreProgramParameters->set(ogreParamName, cgParamValue, 1, paramSize);
	}
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseIntCgProgramParameter( CGtype cgParamType, 
        CGparameter cgParameter, GpuProgramParam * ogreProgramParameters, 
            const String& ogreParamName )
	{
	...
	Ogre::CgFxScriptLoader::CgSamplerStateListener * CgFxScriptLoader::createCgSamplerStateListener( const SamplerStateType type )
	{
		...
		case SST_ADDRESSV:
		case SST_ADDRESSW:
			return N_new CgTextureAddressSamplerStateListener(type);
		case SST_WRAPS:
		case SST_WRAPT:
		case SST_WRAPR:
			return N_new CgWrapSamplerStateListener(type);
		case SST_BORDERCOLOR:
			return N_new CgFloat4SamplerStateListener(type);
		case SST_COMPAREMODE:
			return N_new CgCompareModeSamplerStateListener();
		case SST_COMPAREFUNC:
			return N_new CgCompareFuncSamplerStateListener();
		case SST_DEPTHMODE:
			return N_new CgDepthModeSamplerStateListener();
		case SST_GENERATEMIPMAP:
			return N_new CgBoolSamplerStateListener(type);
		case SST_MIPMAPLODBIAS:
		case SST_LODBIAS:
		case SST_MAXMIPLEVEL:
		case SST_MAXANISOTROPY:
		case SST_MINMIPLEVEL:
		case SST_SRGBTEXTURE:
			return N_new CgFloatSamplerStateListener(type);
		case SST_MINFILTER:
			return N_new CgMinFilterSamplerStateListener();
		case SST_MAGFILTER:
			return N_new CgMagFilterSamplerStateListener();
		case SST_TEXTURE:
			return N_new CgTextureSamplerStateListener(type);
		case SST_MIPFILTER:
			return N_new CgMipFilterSamplerStateListener();
		default:
			// TODO - this is an error....
			return N_new CgSamplerStateListener(type, CG_STRING);
		}
	}
	//---------------------------------------------------------------------
	Ogre::CgFxScriptLoader::CgGlobalStateListener * CgFxScriptLoader::createCgGlobalStateListener( const GlobalStateType type )
	{
		...
		case GST_VERTEXPROGRAMPOINTSIZEENABLE:
		case GST_VERTEXPROGRAMTWOSIDEENABLE:
			return N_new CgBoolGlobalStateListener(type);
		case GST_COLORWRITEENABLE:
		case GST_COLORMASK:
		case GST_PIXELSHADERCONSTANTB:
		case GST_VERTEXSHADERCONSTANTB:
		...
		case GST_COLORWRITEENABLE2:
		case GST_COLORWRITEENABLE3:
			return N_new CgBool4GlobalStateListener(type);
		case GST_ALPHAREF:
		case GST_CLEARDEPTH:
		case GST_DEPTHBIAS:
		case GST_FOGDENSITY:
		...
		case GST_BUMPENVMAT11:
		case GST_LIGHTSPOTEXPONENT:
			return N_new CgFloatGlobalStateListener(type);
		case GST_DEPTHBOUNDS:
		case GST_DEPTHRANGE:
		case GST_POLYGONOFFSET:
		case GST_MAXANISOTROPY:
		case GST_MAXMIPLEVEL:
			return N_new CgFloat2GlobalStateListener(type);
		case GST_POINTDISTANCEATTENUATION:
			return N_new CgFloat3GlobalStateListener(type);
		case GST_BLENDCOLOR:
		case GST_CLEARCOLOR:
		case GST_CLIPPLANE:
		case GST_FOGCOLOR:
		...
		case GST_VERTEXSHADERCONSTANTF:
		case GST_BORDERCOLOR:
			return N_new CgFloat4GlobalStateListener(type);
		case GST_PIXELSHADERCONSTANT2:
		case GST_VERTEXSHADERCONSTANT2:
			return N_new CgFloat4x2GlobalStateListener(type);
		case GST_PIXELSHADERCONSTANT3:
		case GST_VERTEXSHADERCONSTANT3:
			return N_new CgFloat4x3GlobalStateListener(type);
		case GST_COLORMATRIX:
		case GST_COLORTRANSFORM:
		case GST_MODELVIEWMATRIX:
		case GST_MODELVIEWTRANSFORM:
		...
		case GST_PIXELSHADERCONSTANT4:
		case GST_VERTEXSHADERCONSTANT4:
			return N_new CgFloat4x4GlobalStateListener(type);
		case GST_LINESTIPPLE:
		case GST_FILLMODE:
			return N_new CgInt2GlobalStateListener(type);
		case GST_SCISSOR:
		case GST_PIXELSHADERCONSTANTI:
		case GST_VERTEXSHADERCONSTANTI:
			return N_new CgInt4GlobalStateListener(type);
		case GST_SAMPLER:
		case GST_TEXTURE1D:
			return N_new CgSamplerGlobalStateListener(type);
		case GST_TEXTURE2D:
			return N_new CgSampler2GlobalStateListener(type);
		case GST_TEXTURE3D:
			return N_new CgSampler3GlobalStateListener(type);
		case GST_TEXTURECUBEMAP:
			return N_new CgSamplerCubeGlobalStateListener(type);
		case GST_TEXTURERECTANGLE:
			return N_new CgSamplerRectGlobalStateListener(type);
		case GST_TEXTURE:
			return N_new CgTextureGlobalStateListener(type);
		case GST_GEOMETRYPROGRAM:
		case GST_VERTEXPROGRAM:
		case GST_FRAGMENTPROGRAM:
		case GST_VERTEXSHADER:
		case GST_PIXELSHADER:
			return N_new CgProgramGlobalStateListener(type);
		case GST_BLENDOP:
		case GST_CLEARSTENCIL:
		case GST_CLIPPLANEENABLE:
		case GST_CULLMODE:
		...
		case GST_TEXTURETRANSFORMFLAGS:
		case GST_MIPFILTER: // todo
			return N_new CgIntGlobalStateListener(type);
		case GST_BLENDEQUATION:
			return N_new CgBlendEquationGlobalStateListener();
		case GST_DEPTHFUNC:
			return N_new CgDepthFuncGlobalStateListener();
		case GST_FOGDISTANCEMODE:
			return N_new CgFogDistanceModeGlobalStateListener();
		case GST_FOGMODE:
			return N_new CgFogModeGlobalStateListener();
		case GST_LIGHTMODELCOLORCONTROL:
			return N_new CgLightModelColorControlGlobalStateListener();
		case GST_LOGICOP:
			return N_new CgLogicOpGlobalStateListener();
		case GST_POINTSPRITECOORDORIGIN:
			return N_new CgPointSpriteCoordOriginGlobalStateListener();
		case GST_POINTSPRITERMODE:
			return N_new CgPointSpriteRModeGlobalStateListener();
		case GST_SHADEMODEL:
		case GST_SHADEMODE:
			return N_new CgShadeModelGlobalStateListener();
		case GST_TEXGENSMODE:
		case GST_TEXGENTMODE:
		case GST_TEXGENRMODE:
		case GST_TEXGENQMODE:
			return N_new CgTexGenModeGlobalStateListener(type);
		case GST_TEXTUREENVMODE:
			return N_new CgTextureEnvModeGlobalStateListener();
		case GST_MINFILTER:
			return N_new CgMinFilterGlobalStateListener();
		case GST_MAGFILTER:
			return N_new CgMagFilterGlobalStateListener();
		case GST_FRONTFACE:
			return N_new CgFrontFaceGlobalStateListener();
		case GST_CULLFACE:
			return N_new CgCullFaceGlobalStateListener();
		case GST_FOGCOORDSRC:
			return N_new CgFogCoordSrcGlobalStateListener();
		case GST_ALPHAFUNC:
			return N_new CgAlphaFuncGlobalStateListener();
		case GST_BLENDFUNC:
			return N_new CgBlendFuncGlobalStateListener();
		case GST_BLENDFUNCSEPARATE:
			return N_new CgBlendFuncSeparateGlobalStateListener();
		case GST_BLENDEQUATIONSEPARATE:
			return N_new CgBlendEquationSeparateGlobalStateListener();
		case GST_COLORMATERIAL:
			return N_new CgColorMaterialGlobalStateListener();
		case GST_POLYGONMODE:
			return N_new CgPolygonModeGlobalStateListener();
		case GST_STENCILFUNC:
			return N_new CgStencilFuncGlobalStateListener();
		case GST_STENCILOP:
			return N_new CgStencilOpGlobalStateListener();
		case GST_STENCILFUNCSEPARATE:
			return N_new CgStencilFuncSeparateGlobalStateListener();
		case GST_STENCILMASKSEPARATE:
			return N_new CgStencilMaskSeparateGlobalStateListener();
		case GST_STENCILOPSEPARATE:
			return N_new CgStencilOpSeparateGlobalStateListener();
		default:
			// TODO - this is an error....
		return N_new CgGlobalStateListener(type, CG_STRING);
		}
	}
	//---------------------------------------------------------------------
	...
	//---------------------------------------------------------------------
	void CgFxScriptLoader::parseTextureUnitState( CGstateassignment cgStateAssignment, ShaderChTextureUnit * ogreTextureUnitState )
	{
	...
	void CgFxScriptLoader::parseSamplerParameters(CGpass cgPass, Pass * ogrePass)
	{
		...
		while (cgParameter)
		{
			if (cgGetParameterClass(cgParameter) == CG_PARAMETERCLASS_SAMPLER)
			{
				...
				if (cgStateAssignment)
				{
					ShaderChTextureUnit * ogreTextureUnitState = ogrePass->getTexture().create();
