...
macro(findpkg_finish PREFIX)
  ...
  if (NOT ${PREFIX}_FOUND)
    if (${PREFIX}_INCLUDE_DIR AND ${PREFIX}_LIBRARY)
      ...
      if (NOT ${PREFIX}_FIND_QUIETLY)
        message(STATUS "找到 ${PREFIX}: ${${PREFIX}_LIBRARIES}")
      endif ()
    else ()
      if (NOT ${PREFIX}_FIND_QUIETLY)
        message(STATUS "不能找到 ${PREFIX}")
      endif ()
      if (${PREFIX}_FIND_REQUIRED)
        message(FATAL_ERROR "需要库 ${PREFIX} 没有找到! 安装这个库(包含开发包)然后再次尝试.如果库已经安装, 请手动cmake中的设置变量.")
      endif ()
    endif ()
