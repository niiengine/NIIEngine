  ...
  if (NII_UNITY_BUILD)
    ...
    foreach(_FILE ${_PRIMARY})
      ...
      if ((_EXT STREQUAL ".cpp") AND (_EXCLUDED EQUAL "-1"))
        ...
        if(_FILE_CNT EQUAL NII_UNITY_FILES_PER_UNIT)
          set(_FILENAME "${NII_BINARY_DIR}/${TARGETNAME}/compile_${TARGETNAME}_${_FILE_NUM}.cpp")
...
# usage: nii_add_library(TARGETNAME LIBTYPE SOURCE_FILES [SEPARATE SOURCE_FILES])
function(nii_add_library TARGETNAME LIBTYPE)
  create_unity_build_files(${TARGETNAME} ${ARGN})
  add_library(${TARGETNAME} ${LIBTYPE} ${_SOURCES})
endfunction(nii_add_library)


# add a new executable target
# usage: nii_add_executable(TARGETNAME [WIN32] [MACOSX_BUNDLE] SOURCE_FILES [SEPARATE SOURCE_FILES])
function(nii_add_executable TARGETNAME)
