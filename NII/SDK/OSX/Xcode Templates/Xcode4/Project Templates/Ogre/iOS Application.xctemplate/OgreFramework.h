...
public:
	...
	Ogre::Root*                 m_pRoot;
	Ogre::SpaceManager*		m_pSceneMgr;
	Ogre::ViewWindow*			m_pRenderWnd;
...
private:
    ...
    Ogre::RenderFrameArgs            m_FrameEvent;
	int                         m_iNumScreenShots;
    
	bool                        m_bShutDownOgre;
	
	Ogre::Vector3				m_TranslateVector;
	Ogre::NIIf                  m_MoveSpeed; 
	Ogre::Angle				m_RotateSpeed; 
	float                       m_MoveScale; 
	Ogre::Angle				m_RotScale;
#ifdef OGRE_STATIC_LIB
