...
#ifndef _NII_UTFSTRING_H__
#define _NII_UTFSTRING_H__

#if NII_UNICODE_SUPPORT
...
//
#if N_COMPILER == N_CPP_MSVC && (1300 <= N_COMPILER_VER && N_COMPILER_VER <= 1310)
...
#endif  // N_COMPILER == N_CPP_MSVC && N_COMPILER_VER == 1300
...
// NII_IS_NATIVE_WCHAR_T means that wchar_t isn't a typedef of
// unsigned short or unsigned int.
    ...
    // a typedef of unsigned short.
        ...
        #define NII_IS_NATIVE_WCHAR_T      1
    #else
        #define NII_IS_NATIVE_WCHAR_T      0
    #endif
#else   // N_COMPILER != N_CPP_MSVC

// Assumed wchar_t is natively for other compilers
#   define NII_IS_NATIVE_WCHAR_T     1

#endif  // N_COMPILER == N_CPP_MSVC
    ...
    */
    ...
    public:
        ...
        class _EngineAPI invalid_data: public std::runtime_error { /* i don't know why the beautifier is freaking out on this line */
        public:
        ...
        class _EngineAPI _base_iterator: public std::iterator<std::random_access_iterator_tag, value_type> { /* i don't know why the beautifier is freaking out on this line */
        ...
        class _EngineAPI _fwd_iterator: public _base_iterator { /* i don't know why the beautifier is freaking out on this line */
        ...
        class _EngineAPI _const_fwd_iterator: public _base_iterator { /* i don't know why the beautifier is freaking out on this line */
        public:
            _const_fwd_iterator();
        ...
        //! forward iterator for UTFString
        class _EngineAPI _rev_iterator: public _base_iterator { /* i don't know why the beautifier is freaking out on this line */
        ...
        class _EngineAPI _const_rev_iterator: public _base_iterator { /* i don't know why the beautifier is freaking out on this line */
        public:
            _const_rev_iterator();
        ...
        //! duplicate of \a str, \a length code points NIIl
        UTFString( const code_point* str, size_type length );
        //! substring of \a str starting at \a index and \a length code points NIIl
        ...
        //! duplicate of \a w_str, \a length characters NIIl
        ...
        //! duplicate of \a c_str, \a length characters NIIl (UTF-8 encoding)
        ...
        UTFString( const NII::String& str );
#endif
        ...
        void clear();
        //! returns a substring of the current string, starting at \a index, and \a num characters NIIl.
        ...
        //! appends a substring of \a str starting at \a index that is \a len characters NIIl on to the end of the current string
        ...
        //! inserts a substring of \a str (starting at \a index2 and \a num code points NIIl) into the current string, at location \a index1
        ...
        //! compare a substring of \a str to a substring of the current string, where the substring of \a str begins at zero and is \a length2 characters NIIl, and the substring of the current string begins at \a index and is \a length  characters NIIl
        int compare(size_type index, size_type length, const code_point * str, size_type length2) const;
#if NII_IS_NATIVE_WCHAR_T
        //! compare a substring of \a str to a substring of the current string, where the substring of \a str begins at zero and is \a length2 elements NIIl, and the substring of the current string begins at \a index and is \a length characters NIIl
        int compare(size_type index, size_type length, const wchar_t * w_str, size_type length2) const;
#endif
        //! compare a substring of \a str to a substring of the current string, where the substring of \a str begins at zero and is \a length2 <b>UTF-8 code points</b> NIIl, and the substring of the current string begins at \a index and is \a length characters NIIl
    ...
    private:
        ...
        mutable BufferType mBufferType; // identifies the data type held in m_buffer
