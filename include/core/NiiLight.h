    ...
    */
    ...
    public:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        LightType getType() const                   { return mLightType; }

        /** 设置灯光的位置.
        @remark 点光源专有概念
        @version NIIEngine 3.0.0
        */
        void setPos(const Vector3f & o)             { mPosition = o; mMove = true; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        void setDirection(const Vector3f & vec)     { mDirection = vec; mMove = true; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        void setDiffuse(NIIf r, NIIf g, NIIf b)     { mDiffuse.r = r; mDiffuse.b = g; mDiffuse.g = b; }

        /** 设置反射(漫)颜色.
        @version NIIEngine 3.0.0
        */
        void setDiffuse(const Colour & c)           { mDiffuse = c; }

        /** 获取反射(漫)颜色
        @version NIIEngine 3.0.0
        */
        const Colour & getDiffuse() const           { return mDiffuse; }

        /** 设置反射(镜面)颜色.
        @remark 三色元
        @version NIIEngine 3.0.0
        */
        void setSpecular(NIIf r, NIIf g, NIIf b)    { mSpecular.r = r; mSpecular.b = g; mSpecular.g = b; }

        /** 设置反射(镜面)颜色.
        @remark 三色元
        @version NIIEngine 3.0.0
        */
        void setSpecular(const Colour & c)          { mSpecular = c; }

        /** 返回反射(镜面)颜色.
        @version NIIEngine 3.0.0
        */
        const Colour & getSpecular() const          { return mSpecular; }

        /** 设置光亮因子
        @version NIIEngine 3.0.0
        */
        void setBrightFactor(NIIf f)                { mBrightFactor = f; }

        /** 获取光亮因子
        @version NIIEngine 3.0.0
        */
        NIIf getBrightFactor() const                { return mBrightFactor; }

        /** 设置阴影范围
        @version NIIEngine 3.0.0
        */
        void setShadowExtent(NIIf f)                { mShadowExtent = f; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        void setShadowNearClip(NIIf extent)         { mShadowNearClip = extent; }
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getShadowNearClip(NIIf ext) const      { return mShadowNearClip > 0 ? mShadowNearClip : ext; }

        /** 设置阴影近剪切距离
        @remark 使用摆位摄想机, 一般情况下近远切距离是由摄想机设置的
        @version NIIEngine 3.0.0
        */
        void setShadowFarClip(NIIf farClip)         { mShadowFarClip = farClip; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        const ShadowGenCamera * getShadowCamera() const { return mShadowCamera; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getSortValue() const                   { return mSortValue; }

        /** 设置索引
        @remark 一般是指应用到渲染器中的索引
        @version NIIEngine 3.0.0
        */
        void setIndex(Nidx i)                       { mIndexInFrame = i; }

        /** 获取索引
        @remark 一般是指应用到渲染器中的索引
        @version NIIEngine 3.0.0
        */
        Nidx getIndex() const                       { return mIndexInFrame; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getStart() const                       { return mStart; }
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getRange() const                       { return mEnd; }

        /** 设置聚光灯内角
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        void setSpotlightInner(const Radian & val)  { mSpotInner = val; }

        /** 获取聚光灯内角
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        const Radian & getSpotlightInner() const    { return mSpotInner; }

        /** 设置聚光灯外角
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        void setSpotlightOuter(const Radian & val)  { mSpotOuter = val; }

        /** 获取聚光灯外角
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        const Radian & getSpotlightOuter() const    { return mSpotOuter; }

        /** 设置内外角衰减率.
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        void setSpotlightFalloff(NIIf val)          { mSpotFalloff = val; }

        /** 获取内外角衰减率.
        @note 聚光灯专用
        @version NIIEngine 3.0.0
        */
        NIIf getSpotlightFalloff() const            { return mSpotFalloff; }
        ...
        @version NIIEngine 3.0.0
        */
        void setAttenuationConstant(NIIf f)         { mAttenuationConst = f; }
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getAttenuationConstant() const         { return mAttenuationConst; }
        ...
        @version NIIEngine 3.0.0
        */
        void setAttenuationLinear(NIIf f)           { mAttenuationLinear = f; }
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getAttenuationLinear() const           { return mAttenuationLinear; }
        ...
        @version NIIEngine 3.0.0
        */
        void setAttenuationQuadric(NIIf f)          { mAttenuationQuad = f; }
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getAttenuationQuadric() const          { return mAttenuationQuad; }
