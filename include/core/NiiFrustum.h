...
namespace NII
{
    ...
    */
    ...
    public:
        ...
        @version NIIEngine 3.0.0
        */
        virtual void setProjType(Type t);

        /** 获取投影类型(模型/透视)
        @version NIIEngine 3.0.0
        */
        virtual Type getProjType() const;
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        NIIf getOrthoAspectWidth() const;

        /** 设置正交投影高
        @version NIIEngine 3.0.0
        */
        NIIf getOrthoAspectHeight() const;
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        const Plane & getReflection() const;
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        bool isCustomNearClip() const;

        /** 设置是否使用自定义投影矩阵
        @version NIIEngine 3.0.0 高级api
        */
        void setCustomProjMatrix(bool b);

        /** 获取是否使用自定义投影矩阵
        @version NIIEngine 3.0.0 高级api
        */
        bool isCustomProjMatrix() const;
        ...
        */
        ...
        @version NIIEngine 3.0.0 高级api
        */
        void setCustomViewMatrix(bool b);

        /** 获取是否使用自定义视图矩阵
        @version NIIEngine 3.0.0 高级api
        */
        bool isCustomViewMatrix() const;
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        const Matrix4f & getReflectionMatrix() const;
    ...
    protected:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        void updateViewMatrix(const Vector3f & pos, const Quaternion & ori,
            const Matrix4f * reflect = 0);
    protected:
        NIIf mFarExtent;
        NIIf mNearExtent;
        NIIf mUnit;                 ///< 单元/距离
