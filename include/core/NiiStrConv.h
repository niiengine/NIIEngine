    ...
    */
    ...
    public:
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        static void conv(const String & in, RelPosf & out, const RelPosf & o = RelPosf(1.0f, 0.0f));
        ...
        @version NIIEngine 3.0.0
        */
        static void conv(const String & in, RelRectf & out, const RelRectf & o = RelRectf(RelPosf(1.0f, 0.0f)));
        ...
        */
        ...
        @version NIIEngine 3.0.0
        */
        static const String & conv(const RelPosf & in, String & out);

        /** 转换RelRect为字符串.
        @remark 格式"(ls,loft),(ts,toft),(rs,roft),(bs,boft)", 8个NIIf
        @version NIIEngine 3.0.0
        */
        static const String & conv(const RelRectf & in, String & out);
