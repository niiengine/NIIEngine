...
namespace NII
{
    ...
    */
    ...
    class ScriptError;
    class ScriptNode;
    class ResourceLoadScheme;
    class ResourceResultScheme;
    ...
    class Resource;
    class ResourceLoadSchemeManager;
    ...
    class ScriptModule;
    class ResourceResultSchemeManager;
    class GeometryQuery;
    class FrameShaderOp;
    class FrameShaderCh;
    ...
    #define N_Level_Bit_Escape          8         /// auto id = 前8位parent后8位child
