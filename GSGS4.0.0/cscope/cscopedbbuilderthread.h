 ...
 * \date 01/23/08
 */
class CscopeRequest : public gsgs::ThreadRequest
{
...
class CscopeDbBuilderThread : public gsgs::WorkerThread
{
    friend class gsgs::Singleton<CscopeDbBuilderThread>;

protected:
    void ProcessRequest(gsgs::ThreadRequest* req);
...
typedef gsgs::Singleton<CscopeDbBuilderThread> CScopeThreadST;
