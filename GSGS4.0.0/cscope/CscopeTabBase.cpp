    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_buttonUpdateDbNow =
        new DefaultButton(this, wxID_ANY, _("&Update"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonClear =
        new DefaultButton(this, wxID_ANY, _("&Clear"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
