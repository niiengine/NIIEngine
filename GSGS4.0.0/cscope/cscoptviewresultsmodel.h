...
#ifndef __CScoptViewResultsModel_GUARD__H__
#define __CScoptViewResultsModel_GUARD__H__
 ...
 * To convert between a wxDataViewItem to a CScoptViewResultsModel_Item class, simply use:
 * @code
 * CScoptViewResultsModel_Item* itemData = reinterpret_cast<CScoptViewResultsModel_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class CScoptViewResultsModel_Item
{
protected:
    wxVector<wxVariant>        m_data;
    CScoptViewResultsModel_Item*           m_parent;
    wxVector<CScoptViewResultsModel_Item*> m_children;
    bool                       m_isContainer;
    wxClientData*              m_clientData;

public:
    CScoptViewResultsModel_Item()
        : m_parent(NULL)
        , m_isContainer(false)
        , m_clientData(NULL)
    {}
    virtual ~CScoptViewResultsModel_Item() {
        if ( m_clientData ) {
            delete m_clientData;
            m_clientData = NULL;
        }
        ...
        wxVector<CScoptViewResultsModel_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(CScoptViewResultsModel_Item* child) {
        wxVector<CScoptViewResultsModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(CScoptViewResultsModel_Item* child) {
        wxVector<CScoptViewResultsModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(CScoptViewResultsModel_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<CScoptViewResultsModel_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(CScoptViewResultsModel_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<CScoptViewResultsModel_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<CScoptViewResultsModel_Item*>& GetChildren() {
        return m_children;
    }
    ...
    CScoptViewResultsModel_Item* GetParent() {
        return m_parent;
    }
...
class CScoptViewResultsModel : public wxDataViewModel
{
protected:
    wxVector<CScoptViewResultsModel_Item*> m_data;
    unsigned int m_colCount;

public:
    CScoptViewResultsModel();
    virtual ~CScoptViewResultsModel();
    ...
    void SetData(const wxVector<CScoptViewResultsModel_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<CScoptViewResultsModel_Item*>& GetData() const {
        return m_data;
    }
    wxVector<CScoptViewResultsModel_Item*>& GetData() {
        return m_data;
    }
...
#endif // __CScoptViewResultsModel_GUARD__H__
