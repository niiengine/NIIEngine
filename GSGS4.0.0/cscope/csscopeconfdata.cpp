...
{
    m_cscopeFilepath = gsgs_Path().GetBinaryFullPath("cscope");
}
...
void CScopeConfData::DeSerialize(gsgs::Serializer& arch )
{
...
void CScopeConfData::Serialize(gsgs::Serializer& arch )
{
