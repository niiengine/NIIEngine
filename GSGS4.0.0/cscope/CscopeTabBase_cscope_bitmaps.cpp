...
void wxC59CAInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/CscopeTabBase_cscope_bitmaps.cpp$C__src_codelite_cscope_CscopeTabBase_cscope_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/CscopeTabBase_cscope_bitmaps.cpp$C__src_codelite_cscope_CscopeTabBase_cscope_bitmaps.xrc"));
}
