...
TEST_FUNC(testVariablesParserSimple)
{
    ...
    CxxVariableScanner scanner(content, eCxxStandard::kCxx11, gsgsStringMap(), false);
...
TEST_FUNC(testVariablesParserCxx11)
{
    ...
    {
        CxxVariableScanner scanner(funcSignature, eCxxStandard::kCxx11, gsgsStringMap(), true);
...
void testCC()
{
    ...
    wxFileName fn(GetTestsDir() + "../../SampleWorkspace/.gsgs/SampleWorkspace.tags");
...
void InitialiseTags()
{
    ...
    TagsManagerST::Get()->SetIndexerPath(wxT("/usr/bin"));
...
// #ifdef __WXMSW__
//     TagsManagerST::Get()->SetIndexerPath("C:/Program Files/GSGS/gsgs_indexer.exe");
//     TagsManagerST::Get()->StartIndexer();
//     TagEntryPtrList tags = TagsManagerST::Get()->ParseBuffer("enum class FooShort : short {"
//                                                                  "    short_apple,"
//                                                                  "    short_banana,"
//                                                                  "    short_orange,"
//                                                                  "};");
