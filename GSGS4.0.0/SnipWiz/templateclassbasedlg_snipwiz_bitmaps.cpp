...
void wxC61A6InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/templateclassbasedlg_snipwiz_bitmaps.cpp$C__src_codelite_SnipWiz_templateclassbasedlg_snipwiz_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/templateclassbasedlg_snipwiz_bitmaps.cpp$C__src_codelite_SnipWiz_templateclassbasedlg_snipwiz_bitmaps.xrc"));
}
