...
#include "gsgsThread.h" // Base class: WorkerThread

class WebTools;
class JavaScriptSyntaxColourThread : public gsgs::WorkerThread
{
private:
    WebTools* m_plugin;

public:
    struct Request : public gsgs::ThreadRequest {
        wxString filename;
        wxString content;
        Request() {}
    };
...
public:
    virtual void ProcessRequest(gsgs::ThreadRequest* request);
