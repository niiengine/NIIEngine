...
public:
    gsgs::DefaultTreeCtrl* GetTreeCtrlLocals() { return m_treeCtrlLocals; }
    wxPanel* GetSplitterPageWatches() { return m_splitterPageWatches; }
    gsgs::ThemedListCtrl* GetDvListCtrlCallstack() { return m_dvListCtrlCallstack; }
