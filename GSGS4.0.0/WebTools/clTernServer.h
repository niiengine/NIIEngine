...
protected:
    void OnTernTerminated(gsgs::ProcessEvent& event);
    void OnTernOutput(gsgs::ProcessEvent& event);
    ...
    gsgsTipInfoPtr ProcessCalltip(const wxString& output);
    ...
    JSONObject CreateLocation(wxStyledTextCtrl* ctrl, int pos = wxNOT_FOUND);
    JSONObject CreateFilesArray(IEditor *editor, bool forDelete = false);
