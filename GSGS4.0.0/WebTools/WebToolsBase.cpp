    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_pgPropPortNumber->SetHelpString(_("The port number on which 'tern' listens to\nTern is the code completion "
                                        "engine used by gsgs for JavaScript"));
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    {
        wxIcon icn;
        icn.CopyFromBitmap(wxXmlResource::Get()->LoadBitmap(wxT("nodejs")));
        app_icons.AddIcon(icn);
    }
    {
        wxIcon icn;
        icn.CopyFromBitmap(wxXmlResource::Get()->LoadBitmap(wxT("nodejs-32")));
        app_icons.AddIcon(icn);
    }
    SetIcons(app_icons);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_treeCtrlLocals =
        new gsgs::DefaultTreeCtrl(m_splitterPageWatches, wxID_ANY, wxDefaultPosition,
    ...
    m_notebook = new Notebook(m_splitterPage369, wxID_ANY, wxDefaultSize, wxDefaultPosition,
    ...
    m_dvListCtrlCallstack =
        new gsgs::ThemedListCtrl(m_panelCallstack, wxID_ANY, wxDefaultPosition,
    ...
    m_tbBreakpoints = new gsgs::ToolBar(m_panelBreakpoints, wxID_ANY, wxDefaultPosition,
    ...
    m_dvListCtrlBreakpoints =
        new gsgs::ThemedListCtrl(m_panelBreakpoints, wxID_ANY, wxDefaultPosition,
