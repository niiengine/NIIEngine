...
{
protected:
    gsgs::ThemedListCtrl* m_dvListCtrlTools;
...
public:
    gsgs::ThemedListCtrl* GetDvListCtrlTools() { return m_dvListCtrlTools; }
...
{
protected:
    gsgs::ThemedListCtrl* m_dvListCtrlTasks;
...
public:
    gsgs::ThemedListCtrl* GetDvListCtrlTasks() { return m_dvListCtrlTasks; }
