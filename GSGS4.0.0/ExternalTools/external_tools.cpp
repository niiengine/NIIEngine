    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_dvListCtrlTools = new gsgs::ThemedListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(300, 200)),
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_dvListCtrlTasks = new gsgs::ThemedListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
