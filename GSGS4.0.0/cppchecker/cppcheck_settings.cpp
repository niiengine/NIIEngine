...
void CppCheckSettings::Serialize(Serializer& arch)
{
...
void CppCheckSettings::DeSerialize(Serializer& arch)
{
...
wxString CppCheckSettings::GetOptions() const
{
    ...
    gsgsStringMap::const_iterator iter = m_SuppressedWarnings1.begin();
