    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_checkBoxSerialise->SetToolTip(_("If ticked, these settings will be saved and be applied in the future. Otherwise the warnings will be back when you restart gsgs, which may be what you should want."));
    ...
    m_checkBoxSerialiseIncludeDirs->SetToolTip(_("If ticked, these settings will be saved and be applied in the future. Otherwise the warnings will be back when you restart gsgs, which may be what you want."));
