...
void wxCBCB5InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/cppcheckreportbasepage_cppchecker_bitmaps.cpp$C__src_codelite_cppchecker_cppcheckreportbasepage_cppchecker_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/cppcheckreportbasepage_cppchecker_bitmaps.cpp$C__src_codelite_cppchecker_cppcheckreportbasepage_cppchecker_bitmaps.xrc"));
}
