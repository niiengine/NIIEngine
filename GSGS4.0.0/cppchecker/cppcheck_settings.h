...
class CppCheckSettings : public ObjectData
{
    bool m_Style;
    bool m_Performance;
    bool m_Portability;
    ...
    gsgsStringMap m_SuppressedWarnings0;     // The items unchecked in the checklistbox
    gsgsStringMap m_SuppressedWarnings1;     // The checked ones
    gsgsStringMap m_SuppressedWarningsOrig0; // Ditto, containing the original values
    gsgsStringMap m_SuppressedWarningsOrig1;
...
public:
    ...
    const gsgsStringMap* GetSuppressedWarningsStrings0() const { return &m_SuppressedWarnings0; }
    const gsgsStringMap* GetSuppressedWarningsStrings1() const { return &m_SuppressedWarnings1; }
