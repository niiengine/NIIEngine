...
protected:
    ...
    DefaultButton* m_buttonStop;
    DefaultButton* m_buttonUp;
    DefaultButton* m_buttonDown;
...
public:
    ...
    DefaultButton* GetButtonStop() { return m_buttonStop; }
    DefaultButton* GetButtonUp() { return m_buttonUp; }
    DefaultButton* GetButtonDown() { return m_buttonDown; }
