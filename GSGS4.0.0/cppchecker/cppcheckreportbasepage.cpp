    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_buttonClear =
        new DefaultButton(this, wxID_CLEAR, _("&Clear"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_buttonClear->SetToolTip(_("Clear the CppCheck report view"));

    bSizer4->Add(m_buttonClear, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_buttonStop =
        new DefaultButton(this, wxID_STOP, _("&Stop"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonUp = new DefaultButton(this, wxID_UP, _("Up"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_buttonUp->SetToolTip(_("Move to previous error"));

    bSizer4->Add(m_buttonUp, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_buttonDown =
        new DefaultButton(this, wxID_DOWN, _("Down"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
