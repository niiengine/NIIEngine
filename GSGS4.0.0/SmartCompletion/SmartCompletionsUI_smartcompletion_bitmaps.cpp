...
void wxC6BACInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/SmartCompletionsUI_smartcompletion_bitmaps.cpp$C__src_codelite_SmartCompletion_SmartCompletionsUI_smartcompletion_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/SmartCompletionsUI_smartcompletion_bitmaps.cpp$C__src_codelite_SmartCompletion_SmartCompletionsUI_smartcompletion_bitmaps.xrc"));
}
