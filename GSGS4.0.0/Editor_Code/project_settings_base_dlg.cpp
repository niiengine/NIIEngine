    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_stdBtnSizer126 = new DialogButtonSizer();
    
    mainSizer->Add(m_stdBtnSizer126, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
    
    m_button_ok = new Button(this, wxID_OK, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    m_button_ok->SetDefault();
    m_stdBtnSizer126->AddButton(m_button_ok);
    
    m_button_apply = new Button(this, wxID_APPLY, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    m_stdBtnSizer126->AddButton(m_button_apply);
    
    m_button_cancel = new Button(this, wxID_CANCEL, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    m_stdBtnSizer126->AddButton(m_button_cancel);
    
    m_button_help = new Button(this, wxID_HELP, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_pgPropMakeGenerator->SetHelpString(_("Select the Makefile generator to use. By default, gsgs uses its builtin Makefile generator"));
    ...
    m_pgPropGUIApp->SetHelpString(_("By marking the project as a GUI project, gsgs will launch the program without any console terminal wrapping the process execution"));
    ...
    m_pgPropUseSeparateDebuggerArgs->SetHelpString(_("When enabled (.e.g. set to True) gsgs will pass the arguments set in 'Debug Program Arguments'"));
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_pgPropBehaviorWithGlobalSettings->SetHelpString(_("Define how gsgs will merge the compiler settings defined in the 'Global Settings' with the settings defined on this page"));
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_pgPropBehaviorWithGlobalSettings->SetHelpString(_("Define how gsgs will merge the linker settings defined in the 'Global Settings' with the settings defined on this page"));
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText321 = gsgs_Style().createStaticText(m_panelDebugger, wxID_ANY, _("Select debugger path. Leave empty to use the default:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_textCtrlDebuggerPath = gsgs_Style().createTextCtrl(m_panelDebugger, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    boxSizer35->Add(m_textCtrlDebuggerPath, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_button39 = new Button(m_panelDebugger, wxID_ANY, _("..."), wxDefaultPosition, wxSize(-1,-1), 0);
    ...
    m_button88 = new Button(m_panel80, wxID_ADD, _("&Add.."), wxDefaultPosition, wxSize(-1,-1), 0);
    
    boxSizer84->Add(m_button88, 0, wxALL|wxEXPAND, 5);
    
    m_button90 = new Button(m_panel80, wxID_DELETE, _("&Delete..."), wxDefaultPosition, wxSize(-1,-1), 0);
    ...
    m_staticText301 = gsgs_Style().createStaticText(m_panel71, wxID_ANY, _("Enter here any commands that should be passed to the debugger on startup:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    boxSizer76->Add(m_staticText301, 0, wxALL, 5);
    
    m_textCtrlDbgCmds = gsgs_Style().createTextCtrl(m_panel71, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE|wxTE_DONTWRAP);
    ...
    m_staticText311 = gsgs_Style().createStaticText(m_panel74, wxID_ANY, _("Enter here any commands that should be passed to the debugger after attaching the remote target:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    boxSizer78->Add(m_staticText311, 0, wxALL|wxEXPAND, 5);
    
    m_textCtrlDbgPostConnectCmds = gsgs_Style().createTextCtrl(m_panel74, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE|wxTE_DONTWRAP);
    ...
    m_staticText31 = gsgs_Style().createStaticText(m_panelDebugger, wxID_ANY, _("Host / tty:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    fgSizer61->Add(m_staticText31, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrl1DbgHost = gsgs_Style().createTextCtrl(m_panelDebugger, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_NO_VSCROLL);
    fgSizer61->Add(m_textCtrl1DbgHost, 0, wxALL|wxEXPAND, 5);
    
    m_staticText32 = gsgs_Style().createStaticText(m_panelDebugger, wxID_ANY, _("Port:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    fgSizer61->Add(m_staticText32, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlDbgPort = gsgs_Style().createTextCtrl(m_panelDebugger, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_NO_VSCROLL);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText44 = gsgs_Style().createStaticText(m_panelEnv, wxID_ANY, _("Environment variable set to use:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText45 = gsgs_Style().createStaticText(m_panelEnv, wxID_ANY, _("Debugger 'PreDefined Types' set to use:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText47 = gsgs_Style().createStaticText(m_panelEnv, wxID_ANY, _("Additional environment variables:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer34->Add(m_staticText47, 0, wxALL, 5);
    
    m_textCtrlEnvvars = gsgs_Style().createTextCtrl(m_panelEnv, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText11 = gsgs_Style().createStaticText(m_preBuildPage, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_textCtrlBuildEvents = gsgs_Style().createTextCtrl(m_preBuildPage, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE);
    #ifdef __WXMSW__
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText33 = gsgs_Style().createStaticText(m_customBuildPage, wxID_ANY, _("Working Directory:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer23->Add(m_staticText33, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlCustomBuildWD = gsgs_Style().createTextCtrl(m_customBuildPage, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    bSizer23->Add(m_textCtrlCustomBuildWD, 1, wxALL|wxEXPAND, 5);
    
    m_buttonBrowseCustomBuildWD = new Button(m_customBuildPage, wxID_ANY, _("..."), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_buttonNewCustomTarget = new Button(m_customBuildPage, wxID_ANY, _("New..."), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer221->Add(m_buttonNewCustomTarget, 0, wxALL, 5);
    
    m_buttonEditCustomTarget = new Button(m_customBuildPage, wxID_ANY, _("Edit..."), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer221->Add(m_buttonEditCustomTarget, 0, wxALL, 5);
    
    m_buttonDeleteCustomTarget = new Button(m_customBuildPage, wxID_ANY, _("Delete"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText25 = gsgs_Style().createStaticText(m_customMakefileStep, wxID_ANY, _("Dependencies:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    fgSizer5->Add(m_staticText25, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textDeps = gsgs_Style().createTextCtrl(m_customMakefileStep, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_NO_VSCROLL);
    #ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to wxFONTFAMILY_TELETYPE
    ...
    m_staticText26 = gsgs_Style().createStaticText(m_customMakefileStep, wxID_ANY, _("Rule action:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    fgSizer5->Add(m_staticText26, 0, wxALL|wxALIGN_RIGHT, 5);
    
    m_textPreBuildRule = gsgs_Style().createTextCtrl(m_customMakefileStep, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE|wxTE_DONTWRAP);
    #ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to wxFONTFAMILY_TELETYPE
    ...
    m_staticText24 = gsgs_Style().createStaticText(m_customMakefileStep, wxID_ANY, _("Define here a custom makefile rule to be executed in the pre-build steps.\nSee the wiki for more help"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText47 = gsgs_Style().createStaticText(m_panel14, wxID_ANY, _("Search paths:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer35->Add(m_staticText47, 0, wxALL, 5);
    
    m_textCtrlSearchPaths = gsgs_Style().createTextCtrl(m_panel14, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE);
    #ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to wxFONTFAMILY_TELETYPE
    ...
    m_staticText49 = gsgs_Style().createStaticText(m_panel15, wxID_ANY, _("Macros (clang only):"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer36->Add(m_staticText49, 0, wxALL, 5);
    
    m_textCtrlMacros = gsgs_Style().createTextCtrl(m_panel15, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), wxTE_RICH2|wxTE_PROCESS_TAB|wxTE_MULTILINE);
    #ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to wxFONTFAMILY_TELETYPE
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticTextTargetName = gsgs_Style().createStaticText(this, wxID_ANY, _("Target Name:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer53->Add(m_staticTextTargetName, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlTargetName = gsgs_Style().createTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    flexGridSizer53->Add(m_textCtrlTargetName, 1, wxALL|wxEXPAND, 5);
    
    m_staticTextCommand = gsgs_Style().createStaticText(this, wxID_ANY, _("Command:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer53->Add(m_staticTextCommand, 0, wxALL|wxALIGN_RIGHT|wxALIGN_TOP, 5);
    
    m_textCtrlCommand = gsgs_Style().createTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), wxTE_WORDWRAP|wxTE_RICH2|wxTE_MULTILINE);
    ...
    m_button122 = new Button(this, wxID_OK, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
    m_button122->SetDefault();
    m_stdBtnSizer120->AddButton(m_button122);
    
    m_button124 = new Button(this, wxID_CANCEL, wxT(""), wxDefaultPosition, wxSize(-1, -1), 0);
