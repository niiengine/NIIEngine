...
protected:
    ...
    wxInfoBar* m_infobar;
    DialogButtonSizer* m_stdBtnSizer126;
    gsgs::Button* m_button_ok;
    gsgs::Button* m_button_apply;
    gsgs::Button* m_button_cancel;
    gsgs::Button* m_button_help;
...
protected:
    ...
    gsgs::Button* m_button88;
    gsgs::Button* m_button90;
    wxPanel* m_panel71;
...
public:
    ...
    gsgs::Button* GetButton88() { return m_button88; }
    gsgs::Button* GetButton90() { return m_button90; }
...
protected:
    ...
    gsgs::Button* m_buttonBrowseCustomBuildWD;
    wxDataViewListCtrl* m_dvListCtrlTargets;
    gsgs::Button* m_buttonNewCustomTarget;
    gsgs::Button* m_buttonEditCustomTarget;
    gsgs::Button* m_buttonDeleteCustomTarget;
...
public:
    ...
    gsgs::Button* GetButtonBrowseCustomBuildWD() { return m_buttonBrowseCustomBuildWD; }
    wxDataViewListCtrl* GetDvListCtrlTargets() { return m_dvListCtrlTargets; }
    gsgs::Button* GetButtonNewCustomTarget() { return m_buttonNewCustomTarget; }
    gsgs::Button* GetButtonEditCustomTarget() { return m_buttonEditCustomTarget; }
    gsgs::Button* GetButtonDeleteCustomTarget() { return m_buttonDeleteCustomTarget; }
