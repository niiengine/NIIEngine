...
#ifndef __FolderModel_GUARD__H__
#define __FolderModel_GUARD__H__
 ...
 * To convert between a wxDataViewItem to a FolderModel_Item class, simply use:
 * @code
 * FolderModel_Item* itemData = reinterpret_cast<FolderModel_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class FolderModel_Item
{
protected:
    wxVector<wxVariant>        m_data;
    FolderModel_Item*           m_parent;
    wxVector<FolderModel_Item*> m_children;
    bool                       m_isContainer;
...
public:
    ...
    virtual ~FolderModel_Item() {
        ...
        wxVector<FolderModel_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(FolderModel_Item* child) {
        wxVector<FolderModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(FolderModel_Item* child) {
        wxVector<FolderModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(FolderModel_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<FolderModel_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(FolderModel_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<FolderModel_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<FolderModel_Item*>& GetChildren() {
        return m_children;
    }
...
class FolderModel : public wxDataViewModel
{
protected:
    wxVector<FolderModel_Item*> m_data;
...
public:
    ...
    void SetData(const wxVector<FolderModel_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<FolderModel_Item*>& GetData() const {
        return m_data;
    }
    wxVector<FolderModel_Item*>& GetData() {
        return m_data;
    }
...
#endif // __FolderModel_GUARD__H__
