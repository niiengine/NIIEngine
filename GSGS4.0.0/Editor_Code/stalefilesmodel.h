...
#ifndef __StaleFilesModel_GUARD__H__
#define __StaleFilesModel_GUARD__H__
 ...
 * To convert between a wxDataViewItem to a StaleFilesModel_Item class, simply use:
 * @code
 * StaleFilesModel_Item* itemData = reinterpret_cast<StaleFilesModel_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class StaleFilesModel_Item
{
protected:
    wxVector<wxVariant>        m_data;
    StaleFilesModel_Item*           m_parent;
    wxVector<StaleFilesModel_Item*> m_children;
    bool                       m_isContainer;
    wxClientData*              m_clientData;

public:
    StaleFilesModel_Item()
        : m_parent(NULL)
        , m_isContainer(false)
        , m_clientData(NULL)
    {}
    virtual ~StaleFilesModel_Item() {
        if ( m_clientData ) {
            delete m_clientData;
            m_clientData = NULL;
        }
        ...
        wxVector<StaleFilesModel_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(StaleFilesModel_Item* child) {
        wxVector<StaleFilesModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(StaleFilesModel_Item* child) {
        wxVector<StaleFilesModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(StaleFilesModel_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<StaleFilesModel_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(StaleFilesModel_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<StaleFilesModel_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<StaleFilesModel_Item*>& GetChildren() {
        return m_children;
    }
    ...
    StaleFilesModel_Item* GetParent() {
        return m_parent;
    }
...
class StaleFilesModel : public wxDataViewModel
{
protected:
    wxVector<StaleFilesModel_Item*> m_data;
    unsigned int m_colCount;

public:
    StaleFilesModel();
    virtual ~StaleFilesModel();
    ...
    void SetData(const wxVector<StaleFilesModel_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<StaleFilesModel_Item*>& GetData() const {
        return m_data;
    }
    wxVector<StaleFilesModel_Item*>& GetData() {
        return m_data;
    }
...
#endif // __StaleFilesModel_GUARD__H__
