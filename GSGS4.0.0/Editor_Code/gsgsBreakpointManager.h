...
------------------------------------------------------------------------------
*/
#ifndef gsgs_BREAKPOINTS_MANAGER_H
#define gsgs_BREAKPOINTS_MANAGER_H
...
namespace gsgs
{
    ...
    {
    public:
        myDragImage(Editor* ed, const wxBitmap& bitmap, const BreakpointInfo& bp);
        bool StartDrag();
    ...
    protected:
        ...
        void DoRefreshFileBreakpoints(Editor* editor);
    ...
    public:
         ...
         * @param editor
         */
        void RefreshBreakpointsForEditor(Editor* editor);
        ...
        */
         ...
         */
        void DragBreakpoint(Editor* editor, int line, wxBitmap bitmap);
