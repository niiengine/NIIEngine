...
namespace gsgs
{
    ...
    void FindReplaceDialog::CreateViewImpl()
    {
        ...
        itemStaticText =
            gsgs_Style().createStaticText(this, wxID_STATIC, wxT("Find What:"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
        ...
        m_replaceWithLabel =
            gsgs_Style().createStaticText(this, wxID_STATIC, wxT("Replace With:"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
        ...
        m_find = new Button(this, wxID_ANY, wxT("&Find Next"));
        btnSizer->Add(m_find, 1, wxALL | wxEXPAND, 5);

        m_replace = new Button(this, wxID_ANY, wxT("&Replace"));
        btnSizer->Add(m_replace, 1, wxALL | wxEXPAND, 5);

        m_replaceAll = new Button(this, wxID_ANY, wxT("Replace &All"));
        btnSizer->Add(m_replaceAll, 1, wxALL | wxEXPAND, 5);

        m_markAll = new Button(this, wxID_ANY, wxT("&Bookmark All"));
        btnSizer->Add(m_markAll, 1, wxALL | wxEXPAND, 5);

        m_clearBookmarks = new Button(this, wxID_ANY, wxT("&Clear Bookmarks"));
        btnSizer->Add(m_clearBookmarks, 1, wxALL | wxEXPAND, 5);

        m_cancel = new Button(this, wxID_ANY, wxT("Close"));
        btnSizer->Add(m_cancel, 1, wxALL | wxEXPAND, 5);

        m_replacementsMsg = gsgs_Style().createStaticText(this, wxID_ANY, wxEmptyString);
    ...
    void FindReplaceData::SetReplaceString(const wxString& str)
    {
        ...
        int max_value;
        gsgs_Config().Read(kConfigMaxItemsInFindReplaceDialog, max_value, 15);
    ...
    void FindReplaceData::FromJSON(const JSONObject& json)
    {
        json.getObject("m_findString").getValue(m_findString);
        json.getObject("m_replaceString").getValue(m_replaceString);
        json.getObject("m_flags").getValue(m_flags, m_flags);
        json.getObject("m_paths").getValue(m_paths, m_paths);
        json.getObject("m_encoding").getValue(m_encoding, m_encoding);
        json.getObject("m_fileMask").getValue(m_fileMask);
        json.getObject("m_selectedMask").getValue(m_selectedMask, m_selectedMask);
    ...
    JSONObject FindReplaceData::ToJSON() const
    {
