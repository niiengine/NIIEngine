...
protected:
    void DoBuildTree(TagEntryPtrList& tags, const wxFileName& filename);

    wxString GetActiveEditorFile() const;
    void OnIncludeStatements(wxCommandEvent& e);
    void OnCacheUpdated(gsgs::Event& e);
    void OnCacheInvalidated(gsgs::Event& e);
    ...
    wxTreeItemId DoAddIncludeFiles(const wxFileName& fn, const FileOpen::Set_t& includes);
