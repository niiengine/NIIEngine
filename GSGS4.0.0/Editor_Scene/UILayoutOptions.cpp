...
#define INI_FILE    "LayoutEditor.ini"
#define INI_SECTION "SETTINGS"

namespace gsgs
{
    //------------------------------------------------------------------------
    UILayoutOptions* UILayoutOptions::m_instance = NULL;
    //------------------------------------------------------------------------
    UILayoutOptions* UILayoutOptions::GetInstancePtr()
    {
        // Create instance, if not done yet
        if (!m_instance)
        {
            m_instance = new UILayoutOptions();
        }
        return m_instance;
    }
    //------------------------------------------------------------------------
    ...
    UILayoutOptions::~UILayoutOptions()
    {
        ...
        LOG_EXCEPTION_SAFE("UILayoutOptions::~UILayoutOptions", "Failed to destroy options", "Failed to destroy options", "Failed to destroy options");
    }

    //------------------------------------------------------------------------
    void UILayoutOptions::UseSettings()
    {
        std::string  value;
