...
#ifndef _UILAYOUT_CONFIG_H_
#define _UILAYOUT_CONFIG_H_
 ...
 * unhandled exception will cause LayoutEditor to exit immediately. This is only relevant
...
* the project and GUI are built with RTTI information (_CPPRTTI define) under
...
// Visual C++ 6.0  
// Released in 1998, and is still widely used for large and small projects. LayoutEditor
...
//////////////////////////////////////////////////////////////////////////
    ...
    #define L_NOTE __FILE__ "(" $LINE ") : LayoutEditor note: "
    ...
    #define L_WARNING __FILE__ "(" $LINE ") : LayoutEditor warning: "
    ...
    // NOTE3: You should use the COMPILE_* macros below instead of these directly
        ...
        // work in other compilers as well. If not, try to use the non-standard preprocessor directive
        // #warning to achieve the same effect.
        #define L_TODO  __FILE__ "(" $LINE ") : LayoutEditor warning (TODO): "
        #define L_FIXME __FILE__ "(" $LINE ") : LayoutEditor warning (FIXME): "
        #define L_HACK  __FILE__ "(" $LINE ") : LayoutEditor warning (HACK): "
        #define L_MINOR __FILE__ "(" $LINE ") : LayoutEditor warning (MINOR): "
    #else
        #define L_TODO  __FILE__ "(" $LINE ") : LayoutEditor TODO: "
        #define L_FIXME __FILE__ "(" $LINE ") : LayoutEditor FIXME: "
        #define L_HACK  __FILE__ "(" $LINE ") : LayoutEditor HACK: "
        #define L_MINOR __FILE__ "(" $LINE ") : LayoutEditor MINOR: "
    ...
    //      C:\Dev\LayoutEditor\CElayoutEditor.cpp(89): LayoutEditor warning: Something to remember!
    ...
    #if defined (_MSC_VER)
        #define COMPILE_NOTE(s) //__pragma(message(L_NOTE s))
        #define COMPILE_WARN(s) //__pragma(message(L_WARNING s))
        #define COMPILE_TODO(s) //__pragma(message(L_TODO s))
        #define COMPILE_FIXME(s) //__pragma(message(L_FIXME s))
        #define COMPILE_HACK(s) //__pragma(message(L_HACK s))
        #define COMPILE_MINOR(s) //__pragma(message(L_MINOR s))
