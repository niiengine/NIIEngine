    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_dvListCtrlBacktrace = new gsgs::ThemedListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_tbBreakpoints = new gsgs::ToolBar(m_pageBreakpoints, wxID_ANY, wxDefaultPosition,
    ...
    m_treeCtrlBreakpoints = new gsgs::DefaultTreeCtrl(m_pageBreakpoints, wxID_ANY, wxDefaultPosition,
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_pgPropRaiseCodeLite = m_pgMgrDisplayProperties->AppendIn(
        m_pgPropCatGeneral, new wxBoolProperty(_("Raise gsgs when breakpoint hit"), wxPG_LABEL, 1));
    m_pgPropRaiseCodeLite->SetHelpString(_("When a breakpoint is hit, notify the user raising gsgs"));
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_dvListCtrlThreads = new gsgs::ThemedListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
