...
public:
    ...
    static JSONObject ToJSON(const LLDBThread::Vect_t& threads, const wxString &name);
    static LLDBThread::Vect_t FromJSON(const JSONObject& json, const wxString &name);
};
