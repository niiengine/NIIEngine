...
#include "gsgsDataViewListCtrl.h"
...
{
protected:
    gsgs::ThemedListCtrl* m_dvListCtrlBacktrace;
...
public:
    gsgs::ThemedListCtrl* GetDvListCtrlBacktrace() { return m_dvListCtrlBacktrace; }
...
protected:
    ...
    gsgs::ToolBar* m_tbBreakpoints;
    gsgs::DefaultTreeCtrl* m_treeCtrlBreakpoints;
...
public:
    gsgs::ToolBar* GetTbBreakpoints() { return m_tbBreakpoints; }
    gsgs::DefaultTreeCtrl* GetTreeCtrlBreakpoints() { return m_treeCtrlBreakpoints; }
...
{
protected:
    gsgs::ThemedListCtrl* m_dvListCtrlThreads;

protected:
    virtual void OnItemActivated(wxDataViewEvent& event) { event.Skip(); }

public:
    gsgs::ThemedListCtrl* GetDvListCtrlThreads() { return m_dvListCtrlThreads; }
