...
public:
    ...
    void FromJSON(const gsgs::JSONObject& ele);
    gsgs::JSONObject ToJSON() const;
     ...
     */
    wxString GetMappdPath(const wxString& sourcePath, bool useUrlScheme, const gsgsStringMap& additionalMapping) const;
    const gsgsStringMap& GetFileMapping() const { return m_fileMapping; }
    void SetFileMapping(const gsgsStringMap& fileMapping) { this->m_fileMapping = fileMapping; }
