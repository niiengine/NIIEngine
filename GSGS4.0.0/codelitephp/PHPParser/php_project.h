...
private:
    void OnFileScanStart(gsgs::Event& event);
    void OnFileScanEnd(gsgs::Event& event);
...
public:
    ...
    void ToJSON(JSONObject& element) const;
    void FromJSON(const JSONObject& element);
...
wxDECLARE_EVENT(wxEVT_PHP_PROJECT_FILES_SYNC_START, gsgs::Event);
wxDECLARE_EVENT(wxEVT_PHP_PROJECT_FILES_SYNC_END, gsgs::Event);
