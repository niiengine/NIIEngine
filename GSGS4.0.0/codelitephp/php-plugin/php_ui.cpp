...
NewPHPWorkspaceBaseDlg::NewPHPWorkspaceBaseDlg(wxWindow* parent, wxWindowID id, const wxString& title,
...
OpenResourceDlgBase::OpenResourceDlgBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
                                         const wxSize& size, long style)
    : wxDialog(parent, id, title, pos, size, style)
{
    if(!bBitmapLoaded) {
    ...
    m_staticText9 = new wxStaticText(this, wxID_ANY,
                                     _("Type the resource name (file, variable, class, function, constant or define):"),
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_panel11 =
        new wxPanel(m_treebook9, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook9, wxSize(-1, -1)), wxTAB_TRAVERSAL);
    ...
    m_staticText9 = new wxStaticText(m_panel11, wxID_ANY, _("PHP Executable:"), wxDefaultPosition,
                                     wxDLG_UNIT(m_panel11, wxSize(-1, -1)), 0);

    fgSizer4->Add(m_staticText9, 0, wxRIGHT | wxTOP | wxBOTTOM | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL,
                  WXC_FROM_DIP(5));

    m_filePickerPHPPath =
        new wxFilePickerCtrl(m_panel11, wxID_ANY, wxEmptyString, _("Select a file"), wxT("All Files (*)|*"),
                             wxDefaultPosition, wxDLG_UNIT(m_panel11, wxSize(-1, -1)),
                             wxFLP_DEFAULT_STYLE | wxFLP_USE_TEXTCTRL | wxFLP_SMALL | wxFLP_FILE_MUST_EXIST);
    m_filePickerPHPPath->SetToolTip(
        _("Select the PHP executable to use when debugging / running command line scripts"));
    m_filePickerPHPPath->SetFocus();

    fgSizer4->Add(m_filePickerPHPPath, 0, wxLEFT | wxTOP | wxBOTTOM | wxEXPAND | wxALIGN_CENTER_VERTICAL,
                  WXC_FROM_DIP(5));

    m_staticText11 = new wxStaticText(m_panel11, wxID_ANY, _("error_reporting:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel11, wxSize(-1, -1)), 0);

    fgSizer4->Add(m_staticText11, 0, wxRIGHT | wxTOP | wxBOTTOM | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL,
                  WXC_FROM_DIP(5));

    m_textCtrlErrorReporting =
        new wxTextCtrl(m_panel11, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel11, wxSize(-1, -1)), 0);
    ...
    m_staticText14 = new wxStaticText(m_panel11, wxID_ANY, _("Add include path:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel11, wxSize(-1, -1)), 0);

    bSizer18->Add(m_staticText14, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_buttonBrowseIncludePath =
        new wxButton(m_panel11, wxID_ANY, _("Browse"), wxDefaultPosition, wxDLG_UNIT(m_panel11, wxSize(-1, -1)), 0);
    ...
    m_staticText13 = new wxStaticText(m_panel15, wxID_ANY, _("Add include path for code completion:"),
                                      wxDefaultPosition, wxDLG_UNIT(m_panel15, wxSize(-1, -1)), 0);
    m_staticText13->SetToolTip(_("Paths added here will only be used for code completion and NOT during runtime.\nIf "
                                 "you want to add search paths for runtime (CLI mode only), Use the 'PHP CLI' tab"));

    bSizer23->Add(m_staticText13, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_button15 =
        new wxButton(m_panel15, wxID_ANY, _("Browse"), wxDefaultPosition, wxDLG_UNIT(m_panel15, wxSize(-1, -1)), 0);
    ...
    m_staticTextHost = new wxStaticText(m_panel13, wxID_ANY, _("Listen host:"), wxDefaultPosition,
                                        wxDLG_UNIT(m_panel13, wxSize(-1, -1)), 0);

    fgSizer5->Add(m_staticTextHost, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlHost = new wxTextCtrl(m_panel13, wxID_ANY, wxT("127.0.0.1"), wxDefaultPosition,
                                    wxDLG_UNIT(m_panel13, wxSize(-1, -1)), 0);
    ...
    m_textCtrlXDebugPort->SetToolTip(_("The port on which gsgs is accepting debug sessions from XDebug\nThis value "
    ...
    m_staticText152 = new wxStaticText(m_panel13, wxID_ANY, _("IDE Key:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panel13, wxSize(-1, -1)), 0);
    m_staticText152->SetToolTip(_("This field defines the session name between gsgs and XDebug"));

    fgSizer5->Add(m_staticText152, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlIdeKey = new wxTextCtrl(m_panel13, wxID_ANY, wxT("codeliteide"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel13, wxSize(-1, -1)), 0);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_panel43 = new wxPanel(m_treebook41, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook41, wxSize(-1, -1)),
                            wxTAB_TRAVERSAL);
    ...
    m_staticText457 = new wxStaticText(m_panel43, wxID_ANY, _("Select the project execution mode:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panel43, wxSize(-1, -1)), 0);
    ...
    m_panel5 = new wxPanel(m_choicebook1, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_choicebook1, wxSize(-1, -1)),
                           wxTAB_TRAVERSAL);
    ...
    m_staticText19 = new wxStaticText(m_panel5, wxID_ANY, _("PHP executable:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel5, wxSize(-1, -1)), 0);

    fgSizer6->Add(m_staticText19, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_filePickerPHPExe = new wxFilePickerCtrl(
        m_panel5, wxID_ANY, wxEmptyString, _("Select a file"), wxT("All files(*)|*"), wxDefaultPosition,
        wxDLG_UNIT(m_panel5, wxSize(-1, -1)), wxFLP_DEFAULT_STYLE | wxFLP_USE_TEXTCTRL | wxFLP_SMALL);
    ...
    m_staticText75 = new wxStaticText(m_panel5, wxID_ANY, _("Select PHP INI file:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel5, wxSize(-1, -1)), 0);
    ...
    m_filePickerPhpIni = new wxFilePickerCtrl(
        m_panel5, wxID_ANY, wxEmptyString, _("Select a file"), wxT("All files(*)|*"), wxDefaultPosition,
        wxDLG_UNIT(m_panel5, wxSize(-1, -1)), wxFLP_DEFAULT_STYLE | wxFLP_USE_TEXTCTRL | wxFLP_SMALL);
    ...
    m_staticText15 = new wxStaticText(m_panel5, wxID_ANY, _("Index File:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel5, wxSize(-1, -1)), 0);

    fgSizer6->Add(m_staticText15, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_filePickerIndex = new wxFilePickerCtrl(m_panel5, wxID_ANY, wxEmptyString, _("Select a file"),
                                             wxT("PHP Files (*.php)|*.php|All files(*)|*"), wxDefaultPosition,
                                             wxDLG_UNIT(m_panel5, wxSize(-1, -1)),
    ...
    m_staticText18 = new wxStaticText(m_panel5, wxID_ANY, _("Working directory:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel5, wxSize(-1, -1)), 0);

    fgSizer6->Add(m_staticText18, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_dirPickerWorkingDirectory =
        new wxDirPickerCtrl(m_panel5, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDLG_UNIT(m_panel5, wxSize(-1, -1)),
                            wxDIRP_SMALL | wxDIRP_DEFAULT_STYLE | wxDIRP_USE_TEXTCTRL | wxDIRP_DIR_MUST_EXIST);

    fgSizer6->Add(m_dirPickerWorkingDirectory, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_staticText41 = new wxStaticText(m_panel5, wxID_ANY, _("Program arguments"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel5, wxSize(-1, -1)), 0);
    ...
    m_textCtrlProgramArgs = new wxTextCtrl(m_panel5, wxID_ANY, wxT(""), wxDefaultPosition,
                                           wxDLG_UNIT(m_panel5, wxSize(-1, -1)), wxTE_RICH2 | wxTE_MULTILINE);
#ifdef __WXMSW__
    ...
    m_checkBoxPauseWhenExecutionEnds = new wxCheckBox(m_panel5, wxID_ANY, _("Pause when execution ends"),
    ...
    m_panel6 = new wxPanel(m_choicebook1, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_choicebook1, wxSize(-1, -1)),
                           wxTAB_TRAVERSAL);
    ...
    m_staticText16 = new wxStaticText(m_panel6, wxID_ANY, _("Project URL:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel6, wxSize(-1, -1)), 0);

    fgSizer8->Add(m_staticText16, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlWebSiteURL =
        new wxTextCtrl(m_panel6, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel6, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_checkBoxSystemBrowser = new wxCheckBox(m_panel6, wxID_ANY, _("Use system default browser"), wxDefaultPosition,
                                             wxDLG_UNIT(m_panel6, wxSize(-1, -1)), 0);
    ...
    m_panel59 = new wxPanel(m_treebook41, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook41, wxSize(-1, -1)),
                            wxTAB_TRAVERSAL);
    ...
    m_staticText20 = new wxStaticText(m_panel59, wxID_ANY, _("Add include path:"), wxDefaultPosition,
                                      wxDLG_UNIT(m_panel59, wxSize(-1, -1)), 0);

    bSizer28->Add(m_staticText20, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_button17 =
        new wxButton(m_panel59, wxID_ANY, _("Browse"), wxDefaultPosition, wxDLG_UNIT(m_panel59, wxSize(-1, -1)), 0);

    bSizer28->Add(m_button17, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlPHPIncludePath =
        new wxTextCtrl(m_panel59, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel59, wxSize(-1, -1)),
    ...
    m_textCtrlPHPIncludePath->SetToolTip(
        _("When running project with PHP CLI tool, pass the following\ninclude paths"));

    bSizer27->Add(m_textCtrlPHPIncludePath, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_panel447 = new wxPanel(m_treebook41, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook41, wxSize(-1, -1)),
                             wxTAB_TRAVERSAL);
    ...
    m_pgMgrView =
        new wxPropertyGridManager(m_panel447, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel447, wxSize(-1, -1)),
    ...
    m_pgPropFileTypes =
        m_pgMgrView->Append(new wxArrayStringProperty(_("Project file types"), wxPG_LABEL, m_pgMgrViewArr));
    m_pgPropFileTypes->SetHelpString(_("Set the file extensions to include in this project\nCodeLite will only display "
                                       "these file types in the project view"));

    m_pgMgrViewArr.Clear();
    m_pgPropExcludeFolders =
        m_pgMgrView->Append(new wxArrayStringProperty(_("Exclude folders"), wxPG_LABEL, m_pgMgrViewArr));
    m_pgPropExcludeFolders->SetHelpString(
        _("Set a list of folders to exclude from the project.\nIf the last part of the folder path is equal to one of "
          "the entries in this exclude list, it will not\nbe shown in the project view"));

    m_panel45 = new wxPanel(m_treebook41, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook41, wxSize(-1, -1)),
                            wxTAB_TRAVERSAL);
    ...
    m_staticText105 = new wxStaticText(m_panel45, wxID_ANY, _("File mapping"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panel45, wxSize(-1, -1)), 0);
    ...
    m_dvListCtrlFileMapping =
        new wxDataViewListCtrl(m_panel45, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel45, wxSize(-1, -1)),
    ...
    m_dvListCtrlFileMapping->AppendTextColumn(_("Target folder"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT,
                                              wxDATAVIEW_COL_RESIZABLE);
    m_panel47 = new wxPanel(m_treebook41, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_treebook41, wxSize(-1, -1)),
                            wxTAB_TRAVERSAL);
#ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to
    // wxFONTFAMILY_TELETYPE
    ...
    m_staticText13 = new wxStaticText(m_panel47, wxID_ANY, _("Add include path for code completion:"),
                                      wxDefaultPosition, wxDLG_UNIT(m_panel47, wxSize(-1, -1)), 0);
    ...
    m_button15 =
        new wxButton(m_panel47, wxID_ANY, _("Browse"), wxDefaultPosition, wxDLG_UNIT(m_panel47, wxSize(-1, -1)), 0);
    m_button15->SetDefault();
    ...
    m_textCtrlCCIncludePath =
        new wxTextCtrl(m_panel47, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel47, wxSize(-1, -1)),
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_dirPickerSource = new wxDirPickerCtrl(this, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                                            wxDLG_UNIT(this, wxSize(-1, -1)),
                                            wxDIRP_SMALL | wxDIRP_DEFAULT_STYLE | wxDIRP_USE_TEXTCTRL);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_toolbar = new gsgs::ToolBar(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
                              wxTB_HORIZONTAL | wxNO_BORDER);
    m_toolbar->SetToolBitmapSize(wxSize(16, 16));

    bSizer5->Add(m_toolbar, 0, wxEXPAND, WXC_FROM_DIP(5));

    m_gaugeParseProgress =
        new wxGauge(this, wxID_ANY, 100, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, 8)), wxGA_HORIZONTAL);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_auiBook = new Notebook(this, wxID_ANY, wxDefaultSize, wxDefaultPosition, wxDLG_UNIT(this, wxSize(300, 300)), 0);
    ...
    m_dvListCtrlStackTrace =
        new gsgs::ThemedListCtrl(m_panel140, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel140, wxSize(-1, -1)),
    ...
    m_dvListCtrlBreakpoints =
        new gsgs::ThemedListCtrl(m_panel142, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel142, wxSize(-1, -1)),
                             wxDV_ROW_LINES | wxDV_MULTIPLE | wxDV_SINGLE);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_tree =
        new gsgs::DefaultTreeCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTR_DEFAULT_STYLE);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_panel259 = new wxPanel(m_notebook257, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebook257, wxSize(-1, -1)),
                             wxTAB_TRAVERSAL);
    ...
    m_textCtrlExpression = new wxTextCtrl(m_panel259, wxID_ANY, wxT(""), wxDefaultPosition,
                                          wxDLG_UNIT(m_panel259, wxSize(-1, -1)), wxTE_PROCESS_ENTER);
#ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to
    // wxFONTFAMILY_TELETYPE
    ...
    m_buttonSend =
        new wxButton(m_panel259, wxID_ANY, _("Send"), wxDefaultPosition, wxDLG_UNIT(m_panel259, wxSize(-1, -1)), 0);
    ...
    m_textCtrlExpressionXdebug = new wxTextCtrl(m_panel261, wxID_ANY, wxT(""), wxDefaultPosition,
                                                wxDLG_UNIT(m_panel261, wxSize(-1, -1)), wxTE_PROCESS_ENTER);
#ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to
    // wxFONTFAMILY_TELETYPE
    ...
    m_textCtrlExpressionXdebug->SetToolTip(
        _("Type an expression and hit the 'Send' button\nThis works best when wrapping the command inside a print_r "
          "function, e.g.\nprint_r( $mystr, true )"));
    ...
    m_buttonSendXdebug =
        new wxButton(m_panel261, wxID_ANY, _("Send"), wxDefaultPosition, wxDLG_UNIT(m_panel261, wxSize(-1, -1)), 0);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_panelDebugURL = new wxPanel(m_simpleBook, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_simpleBook, wxSize(-1, -1)),
                                  wxTAB_TRAVERSAL);
    ...
    m_staticText377 = new wxStaticText(m_panelDebugURL, wxID_ANY, _("URL to Run / Debug:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panelDebugURL, wxSize(-1, -1)), 0);

    flexGridSizer375->Add(m_staticText377, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    wxArrayString m_comboBoxURLArr;
    m_comboBoxURL = new wxComboBox(m_panelDebugURL, wxID_ANY, wxT(""), wxDefaultPosition,
                                   wxDLG_UNIT(m_panelDebugURL, wxSize(-1, -1)), m_comboBoxURLArr, 0);
    ...
    m_panelCommandLine = new wxPanel(m_simpleBook, wxID_ANY, wxDefaultPosition,
                                     wxDLG_UNIT(m_simpleBook, wxSize(-1, -1)), wxTAB_TRAVERSAL);
    ...
    m_staticText383 = new wxStaticText(m_panelCommandLine, wxID_ANY, _("File to Run / Debug:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panelCommandLine, wxSize(-1, -1)), 0);

    flexGridSizer381->Add(m_staticText383, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlScriptToDebug = new wxTextCtrl(m_panelCommandLine, wxID_ANY, wxT(""), wxDefaultPosition,
                                             wxDLG_UNIT(m_panelCommandLine, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_checkBoxDebugActiveEditor =
        new wxCheckBox(m_panelCommandLine, wxID_ANY, _("Use the active file opened in the editor"), wxDefaultPosition,
                       wxDLG_UNIT(m_panelCommandLine, wxSize(-1, -1)), 0);
                                                 ...
                                                 const wxBitmap& bmp, const wxPoint& pos, long style)
{
    ...
    m_banner495 = new wxBannerWindow(m_wizardPageCreateMethod, wxID_ANY, wxTOP, wxDefaultPosition,
                                     wxDLG_UNIT(m_wizardPageCreateMethod, wxSize(-1, -1)), 0);
    ...
    m_radioBoxCreateMethod = new wxRadioBox(m_wizardPageCreateMethod, wxID_ANY, wxT(""), wxDefaultPosition,
                                            wxDLG_UNIT(m_wizardPageCreateMethod, wxSize(-1, -1)),
                                            m_radioBoxCreateMethodArr, 1, wxRA_SPECIFY_COLS);
    ...
    m_banner517 = new wxBannerWindow(m_wizardPageProjectDetails, wxID_ANY, wxTOP, wxDefaultPosition,
                                     wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);
    ...
    m_staticText521 = new wxStaticText(m_wizardPageProjectDetails, wxID_ANY, _("Project Name:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);

    flexGridSizer519->Add(m_staticText521, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlName = new wxTextCtrl(m_wizardPageProjectDetails, wxID_ANY, wxT(""), wxDefaultPosition,
                                    wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);
    ...
    m_staticText525 = new wxStaticText(m_wizardPageProjectDetails, wxID_ANY, _("Project path:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);

    flexGridSizer519->Add(m_staticText525, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_dirPickerPath = new wxDirPickerCtrl(m_wizardPageProjectDetails, wxID_ANY, wxEmptyString, _("Select a folder"),
                                          wxDefaultPosition, wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)),
                                          wxDIRP_SMALL | wxDIRP_DEFAULT_STYLE | wxDIRP_USE_TEXTCTRL);
    ...
    m_checkBoxSeparateFolder =
        new wxCheckBox(m_wizardPageProjectDetails, wxID_ANY, _("Create the project under a separate folder"),
                       wxDefaultPosition, wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);
    ...
    m_staticText535 = new wxStaticText(m_wizardPageProjectDetails, wxID_ANY, _("Preview:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);

    flexGridSizer519->Add(m_staticText535, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlPreview = new wxTextCtrl(m_wizardPageProjectDetails, wxID_ANY, wxT(""), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPageProjectDetails, wxSize(-1, -1)), 0);
    ...
    m_banner4951 = new wxBannerWindow(m_wizardPageFinalize, wxID_ANY, wxTOP, wxDefaultPosition,
                                      wxDLG_UNIT(m_wizardPageFinalize, wxSize(-1, -1)), 0);
    ...
    m_staticText3173 = new wxStaticText(m_wizardPageFinalize, wxID_ANY, _("Project type:"), wxDefaultPosition,
                                        wxDLG_UNIT(m_wizardPageFinalize, wxSize(-1, -1)), 0);
    ...
    m_staticText3215 = new wxStaticText(m_wizardPageFinalize, wxID_ANY, _("PHP executable:"), wxDefaultPosition,
                                        wxDLG_UNIT(m_wizardPageFinalize, wxSize(-1, -1)), 0);

    flexGridSizer3152->Add(m_staticText3215, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                           WXC_FROM_DIP(5));

    m_filePickerPhpExe = new wxFilePickerCtrl(
        m_wizardPageFinalize, wxID_ANY, wxEmptyString, _("Select a file"), wxT("*"), wxDefaultPosition,
        wxDLG_UNIT(m_wizardPageFinalize, wxSize(-1, -1)), wxFLP_DEFAULT_STYLE | wxFLP_USE_TEXTCTRL | wxFLP_OPEN);
    ...
    m_banner49511 = new wxBannerWindow(m_wizardPage634, wxID_ANY, wxTOP, wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPage634, wxSize(-1, -1)), 0);
    ...
    m_staticText653 = new wxStaticText(m_wizardPage634, wxID_ANY, _("Browse for code completion folder..."),
                                       wxDefaultPosition, wxDLG_UNIT(m_wizardPage634, wxSize(-1, -1)), 0);

    boxSizer649->Add(m_staticText653, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_button651 = new wxButton(m_wizardPage634, wxID_ANY, _("Browse"), wxDefaultPosition,
                               wxDLG_UNIT(m_wizardPage634, wxSize(-1, -1)), 0);
    m_button651->SetDefault();

    boxSizer649->Add(m_button651, 0, wxALL, WXC_FROM_DIP(5));

    m_textCtrlCCPaths = new wxTextCtrl(m_wizardPage634, wxID_ANY, wxT(""), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPage634, wxSize(-1, -1)),
                                       wxTE_RICH2 | wxTE_PROCESS_ENTER | wxTE_MULTILINE | wxTE_DONTWRAP);
#ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to
    // wxFONTFAMILY_TELETYPE
    ...
    m_textCtrlCCPaths->SetToolTip(
        _("You can add folders here for better code completion.\nCodeLite will scan these folder for any PHP files for "
                                                   ...
                                                   const wxBitmap& bmp, const wxPoint& pos, long style)
{
    ...
    m_bannerPort = new wxBannerWindow(m_wizardPagePort, wxID_ANY, wxTOP, wxDefaultPosition,
                                      wxDLG_UNIT(m_wizardPagePort, wxSize(-1, -1)), 0);
    m_bannerPort->SetBitmap(wxNullBitmap);
    m_bannerPort->SetText(
        _("XDebug Port"),
        _("Setup XDebug port number\nCodeLite will listen on this port for new incoming messages from XDebug"));
    ...
    m_staticText585 = new wxStaticText(m_wizardPagePort, wxID_ANY, _("Port number:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_wizardPagePort, wxSize(-1, -1)), 0);

    flexGridSizer583->Add(m_staticText585, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlPort = new wxTextCtrl(m_wizardPagePort, wxID_ANY, wxT("9000"), wxDefaultPosition,
                                    wxDLG_UNIT(m_wizardPagePort, wxSize(-1, -1)), 0);
    m_textCtrlPort->SetToolTip(_(
        "Set the port on which gsgs will be listening for new connections from XDebug. The default port is 9000"));
#if wxVERSION_NUMBER >= 3000
    ...
    m_bannerHost = new wxBannerWindow(m_wizardPageHost, wxID_ANY, wxTOP, wxDefaultPosition,
                                      wxDLG_UNIT(m_wizardPageHost, wxSize(-1, -1)), 0);
    m_bannerHost->SetBitmap(wxNullBitmap);
    m_bannerHost->SetText(_("gsgs IP address"), _("Set the IP address on which gsgs is running"));
    ...
    m_staticText5853 = new wxStaticText(m_wizardPageHost, wxID_ANY, _("IP address:"), wxDefaultPosition,
                                        wxDLG_UNIT(m_wizardPageHost, wxSize(-1, -1)), 0);

    flexGridSizer5832->Add(m_staticText5853, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlIP = new wxTextCtrl(m_wizardPageHost, wxID_ANY, wxT("127.0.0.1"), wxDefaultPosition,
                                  wxDLG_UNIT(m_wizardPageHost, wxSize(-1, -1)), 0);
    m_textCtrlIP->SetToolTip(_("Set the IP address on which gsgs is listening.\nThis IP needs to be visible to the "
                               "machine where XDebug is running."));
#if wxVERSION_NUMBER >= 3000
    ...
    m_bannerSessionID = new wxBannerWindow(m_wizardPageIDEKey, wxID_ANY, wxTOP, wxDefaultPosition,
                                           wxDLG_UNIT(m_wizardPageIDEKey, wxSize(-1, -1)), 0);
    m_bannerSessionID->SetBitmap(wxNullBitmap);
    m_bannerSessionID->SetText(_("IDE Key"), _("Set the IDE key between gsgs and XDebug"));
    ...
    m_staticText58537 = new wxStaticText(m_wizardPageIDEKey, wxID_ANY, _("IDE Key:"), wxDefaultPosition,
                                         wxDLG_UNIT(m_wizardPageIDEKey, wxSize(-1, -1)), 0);

    flexGridSizer58326->Add(m_staticText58537, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textCtrlKey = new wxTextCtrl(m_wizardPageIDEKey, wxID_ANY, wxT("codeliteide"), wxDefaultPosition,
                                   wxDLG_UNIT(m_wizardPageIDEKey, wxSize(-1, -1)), 0);
    m_textCtrlKey->SetToolTip(_("Set the IDE key between gsgs and XDebug"));
#if wxVERSION_NUMBER >= 3000
    ...
    m_bannerSessionID10 = new wxBannerWindow(m_wizardPagePHP, wxID_ANY, wxTOP, wxDefaultPosition,
                                             wxDLG_UNIT(m_wizardPagePHP, wxSize(-1, -1)), 0);
    ...
    m_staticText625 =
        new wxStaticText(m_wizardPagePHP, wxID_ANY, _("Copy the below text and paste it in your php.ini file:"),
                         wxDefaultPosition, wxDLG_UNIT(m_wizardPagePHP, wxSize(-1, -1)), 0);

    boxSizer6019->Add(m_staticText625, 0, wxALL, WXC_FROM_DIP(5));

    m_textCtrlPHPIni = new wxTextCtrl(m_wizardPagePHP, wxID_ANY, wxT(""), wxDefaultPosition,
                                      wxDLG_UNIT(m_wizardPagePHP, wxSize(-1, -1)), wxTE_RICH2 | wxTE_MULTILINE);
#ifdef __WXMSW__
    // To get the newer version of the font on MSW, we use font wxSYS_DEFAULT_GUI_FONT with family set to
    // wxFONTFAMILY_TELETYPE
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_dvListCtrlFunctions = new wxDataViewListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, 200)),
                                                   wxDV_ROW_LINES | wxDV_SINGLE);
    ...
    m_checkBoxLowercase = new wxCheckBox(this, wxID_ANY, _("Functions start with lowercase"), wxDefaultPosition,
    ...
    m_checkBoxPrefixGetter = new wxCheckBox(this, wxID_ANY, _("Prefix getter with 'get' or 'is'"), wxDefaultPosition,
                                            wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_checkBoxPrefixGetter->SetValue(true);
    m_checkBoxPrefixGetter->SetToolTip(_("When checked, the getter function is prefixed with 'get', otherwise, the "
                                         "getter is same as the variable name (without the $ sign)"));
