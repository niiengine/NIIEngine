...
class PHPEditorContextMenu : public wxEvtHandler
{
    ...
    static PHPEditorContextMenu* gInstance;
...
protected:
    // Helpers
    void DoContextMenu(gsgs::IEditor* editor, wxCommandEvent& e);
    wxStyledTextCtrl* DoGetActiveScintila();

protected:
    // Event handlers
    void OnContextMenu(ContextMenuEvent& e);
    void OnMarginContextMenu(ContextMenuEvent& e);
...
private:
    ...
    void DoBuildMenu(wxMenu* menu, gsgs::IEditor* editor);
