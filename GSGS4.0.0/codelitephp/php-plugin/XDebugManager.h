...
public:
     ...
     */
    gsgsStringMap GetFileMapping(PHPProject::Ptr_t pProject) const;

protected:
    void DoStartDebugger(bool ideInitiate = true);
    void DoStopDebugger();
    void DoRefreshBreakpointsMarkersForEditor(gsgs::IEditor* editor);
