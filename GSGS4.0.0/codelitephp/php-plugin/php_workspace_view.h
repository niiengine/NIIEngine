...
protected:
    ...
    void OnRunActiveProject(gsgs::ExecuteEvent& e);
    void OnStopExecutedProgram(gsgs::ExecuteEvent& e);
    void OnIsProgramRunning(gsgs::ExecuteEvent& e);
    void OnEditorChanged(wxCommandEvent& e);
    void OnFileRenamed(PHPEvent& e);
    void OnWorkspaceRenamed(PHPEvent& e);
    void OnFindInFilesShowing(gsgs::FindInFilesEvent& e);
    void OnFindInFilesDismissed(gsgs::FindInFilesEvent& e);
    void OnToggleAutoUpload(wxCommandEvent& e);
    void OnStartDebuggerListener(wxCommandEvent& e);
    void OnProjectSyncCompleted(gsgs::Event& event);

    // Php parser events
    void OnPhpParserStarted(gsgs::ParseEvent& event);
    void OnPhpParserProgress(gsgs::ParseEvent& event);
    void OnPhpParserDone(gsgs::ParseEvent& event);

    // PHP Workspace events
    void OnWorkspaceSyncStart(gsgs::Event& event);
    void OnWorkspaceSyncEnd(gsgs::Event& event);
    void OnFileSaveAs(gsgs::FileEvent& event);
