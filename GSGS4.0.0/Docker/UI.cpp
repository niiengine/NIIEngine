    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_notebook96 =
        new Notebook(m_panel114, wxID_ANY, wxSize(16,16),wxDefaultPosition, wxDLG_UNIT(m_panel114, wxSize(-1, -1)), wxBK_DEFAULT);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_notebook = new Notebook(this, wxID_ANY, wxSize(16, 16), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxBK_DEFAULT);
    ...
    m_toolbar = new gsgs::ToolBar(m_outputPage, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_outputPage, wxSize(-1, -1)),
    ...
    m_toolbarContainers = new gsgs::ToolBar(m_containersPage, wxID_ANY, wxDefaultPosition,
    ...
    m_dvListCtrlContainers = new gsgs::ThemedListCtrl(m_containersPage, wxID_ANY, wxDefaultPosition,
    ...
    m_toolbarImages =
        new gsgs::ToolBar(m_imagesPage, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_imagesPage, wxSize(-1, -1)), wxTB_FLAT);
    m_toolbarImages->SetToolBitmapSize(wxSize(16, 16));

    boxSizer90->Add(m_toolbarImages, 0, wxEXPAND, WXC_FROM_DIP(5));

    m_dvListCtrlImages =
        new gsgs::ThemedListCtrl(m_imagesPage, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_imagesPage, wxSize(-1, -1)),
                             wxDV_VERT_RULES | wxDV_ROW_LINES | wxDV_MULTIPLE | wxDV_SINGLE);
