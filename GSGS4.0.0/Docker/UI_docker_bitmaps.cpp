...
void wxCrafterOTgKroInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/UI_docker_bitmaps.cpp$C__src_codelite_Docker_UI_docker_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/UI_docker_bitmaps.cpp$C__src_codelite_Docker_UI_docker_bitmaps.xrc"));
}
