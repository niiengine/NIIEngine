...
protected:
    ...
    gsgs::ToolBar* m_toolbarContainers;
    gsgs::ThemedListCtrl* m_dvListCtrlContainers;
    wxPanel* m_imagesPage;
    gsgs::ToolBar* m_toolbarImages;
    gsgs::ThemedListCtrl* m_dvListCtrlImages;
...
public:
    ...
    gsgs::ToolBar* GetToolbarContainers() { return m_toolbarContainers; }
    gsgs::ThemedListCtrl* GetDvListCtrlContainers() { return m_dvListCtrlContainers; }
    wxPanel* GetContainersPage() { return m_containersPage; }
    gsgs::ToolBar* GetToolbarImages() { return m_toolbarImages; }
    gsgs::ThemedListCtrl* GetDvListCtrlImages() { return m_dvListCtrlImages; }
