...
/*******************************************************************************/
void GitCommitListDlg::OnProcessTerminated(gsgs::ProcessEvent& event)
{
    wxUnusedVar(event);
    wxDELETE(m_process);
...
/*******************************************************************************/
void GitCommitListDlg::OnProcessOutput(gsgs::ProcessEvent& event) { m_commandOutput.Append(event.GetOutput()); }
...
void GitCommitListDlg::OnRevertCommit(wxCommandEvent& e)
{
    ...
    if(::wxMessageBox(_("Are you sure you want to revert commit #") + commitID, "gsgs",
