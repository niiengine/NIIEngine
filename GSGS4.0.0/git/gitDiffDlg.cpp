...
void GitDiffDlg::OnProcessOutput(gsgs::ProcessEvent& event) { m_commandOutput.Append(event.GetOutput()); }

void GitDiffDlg::OnProcessTerminated(gsgs::ProcessEvent& event)
{
    wxUnusedVar(event);
    wxDELETE(m_process);
