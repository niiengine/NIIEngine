...
protected:
    ...
    FileOpen::List_t   _includeStatements;
...
public:
    ...
    // getters
    const FileOpen::Set_t& GetResults() const {
        return _matchedfiles;
    }

    ////////////////////////////////////////////////////
    // Using namespace support
    const FileOpen::Set_t& GetNamespaces() const {
        return _namespaces;
    }
    ...
    ////////////////////////////////////////////////////
    // Namespace aliasing
    const FileOpen::Set_t& GetNamespaceAliases() const {
    ...
    const FileOpen::List_t& GetIncludeStatements() const {
