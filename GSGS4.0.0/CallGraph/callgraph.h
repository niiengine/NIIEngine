...
public:
    ...
    /**
     * @brief Function create plugin menu for Call graph used in menu Plugins of gsgs.
     * @param pluginsMenu
     */
    virtual void CreatePluginMenu(wxMenu* pluginsMenu);

    /**
     * @brief Function unplug the plugin from gsgs IDE.
     */
    virtual void UnPlug();
