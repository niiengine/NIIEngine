...
void wxCAF3BInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/VIM_codelite_vim_bitmaps.cpp$C__src_codelite_codelite_vim_VIM_codelite_vim_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/VIM_codelite_vim_bitmaps.cpp$C__src_codelite_codelite_vim_VIM_codelite_vim_bitmaps.xrc"));
}
