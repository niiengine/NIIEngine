...
PreviewFrame::PreviewFrame(wxWindow* parent, const TopLevelWinWrapper& fw)
{
    ...
    gsgs_Event().Connect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewFrame::OnClosePreview), NULL, this);
}

PreviewFrame::~PreviewFrame()
{
    wxcAuiManager::Get().UnInit(this);
    gsgs_Event().Disconnect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewFrame::OnClosePreview), NULL,
                                     this);
