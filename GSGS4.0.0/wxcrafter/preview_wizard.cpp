...
PreviewWizard::PreviewWizard(wxWindow* parent, const WizardWrapper& dw)
{
    ...
    Center();
    gsgs_Event().Connect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewWizard::OnClosePreview), NULL,
                                  this);
}

PreviewWizard::~PreviewWizard()
{
    gsgs_Event().Disconnect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewWizard::OnClosePreview), NULL,
                                     this);
