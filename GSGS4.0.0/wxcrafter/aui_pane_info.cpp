...
{
    Reset();
    if(json.isValid() == false) { return; }

    m_name = json.getObject("m_name").toString();
    m_caption = json.getObject("m_caption").toString();
    m_dockDirection = json.getObject("m_dockDirection").toString();
    if(m_dockDirection.IsEmpty()) m_dockDirection = "wxAUI_DOCK_LEFT";

    m_layer = json.getObject("m_layer").toInt();
    m_row = json.getObject("m_row").toInt();
    m_position = json.getObject("m_position").toInt();
    m_bestSize = json.getObject("m_bestSize").toSize();
    m_minSize = json.getObject("m_minSize").toSize();
    m_maxSize = json.getObject("m_maxSize").toSize();
    m_resizable = json.getObject("m_resizable").toBool();
    m_captionVisible = json.getObject("m_captionVisible").toBool();
    m_closeButton = json.getObject("m_closeButton").toBool();
    m_minButton = json.getObject("m_minButton").toBool();
    m_maxButton = json.getObject("m_maxButton").toBool();
    m_pinButton = json.getObject("m_pinButton").toBool();
    m_toolbarPane = json.getObject("m_toolbarPane").toBool();
}
