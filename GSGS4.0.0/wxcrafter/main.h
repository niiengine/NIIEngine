...
protected:
    ...
    bool m_exiting;
    gsgs::ImageManager* m_bitmaps = NULL;
...
protected:
    ...
    virtual void OnSwitchToGSGSUI(wxUpdateUIEvent& event);
    ...
    virtual void OnSwitchToGSGS(wxCommandEvent& event);
    ...
    virtual void OnGSGSGotFocus(wxCommandEvent& e);
