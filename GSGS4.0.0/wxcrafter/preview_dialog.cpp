...
PreviewDialog::PreviewDialog(wxWindow* parent, const DialogWrapper& dw)
{
    ...
    Layout();
    gsgs_Event().Connect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewDialog::OnClosePreview), NULL,
                                  this);
}
...
PreviewDialog::~PreviewDialog()
{
    ...
    gsgs_Event().Disconnect(wxEVT_CLOSE_PREVIEW, wxCommandEventHandler(PreviewDialog::OnClosePreview), NULL,
                                     this);
