...
public:
    GUICraftMainPanel(wxWindow* parent, wxCrafterPlugin* plugin, gsgs::TreeCtrl* treeView);
    ...
    bool GenerateCppOutput(wxString& cpp, wxString& header, wxArrayString& headers, gsgsStringMap& additionalFiles,
    ...
    void OnFindBar(gsgs::FindEvent& e);
};
