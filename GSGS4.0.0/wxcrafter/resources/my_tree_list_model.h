 ...
 * To convert between a wxDataViewItem to a MODEL_NAME_Item class, simply use:
 * @code
 * MODEL_NAME_Item* itemData = reinterpret_cast<MODEL_NAME_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class MODEL_NAME_Item
{
protected:
    wxVector<wxVariant>        m_data;
    MODEL_NAME_Item*           m_parent;
    wxVector<MODEL_NAME_Item*> m_children;
    bool                       m_isContainer;
...
public:
    ...
    virtual ~MODEL_NAME_Item() {
        ...
        wxVector<MODEL_NAME_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(MODEL_NAME_Item* child) {
        wxVector<MODEL_NAME_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(MODEL_NAME_Item* child) {
        wxVector<MODEL_NAME_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(MODEL_NAME_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<MODEL_NAME_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(MODEL_NAME_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<MODEL_NAME_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<MODEL_NAME_Item*>& GetChildren() {
        return m_children;
    }
...
class MODEL_NAME : public wxDataViewModel
{
protected:
    wxVector<MODEL_NAME_Item*> m_data;
...
public:
    ...
    void SetData(const wxVector<MODEL_NAME_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<MODEL_NAME_Item*>& GetData() const {
        return m_data;
    }
    wxVector<MODEL_NAME_Item*>& GetData() {
        return m_data;
    }

    virtual bool HasContainerColumns (const wxDataViewItem& item) const {
        return HAS_CONTAINER_COLUMNS;
    }
