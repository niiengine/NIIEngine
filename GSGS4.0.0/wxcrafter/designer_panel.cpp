...
public:
    ...
    ~CONTEXT_MENU()
    {
        if(m_fireEvent) {
            ...
            gsgs_Event().AddPendingEvent(contextMenuEvent);
        }
    }
};
    ...
    , m_hintedContainer(NULL)
{
    ...
    gsgs_Event().Connect(wxEVT_UPDATE_PREVIEW, wxCommandEventHandler(DesignerPanel::OnUpdatePreview), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_WXGUI_PROJECT_CLOSED, wxCommandEventHandler(DesignerPanel::OnClearPreview),
                                  NULL, this);
    gsgs_Event().Connect(wxEVT_WXGUI_PROJECT_LOADED, wxCommandEventHandler(DesignerPanel::OnLoadPreview), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_TREE_ITEM_SELECTED, wxCommandEventHandler(DesignerPanel::OnHighlightControl),
                                  NULL, this);
    GetSizer()->Layout();
}
...
{
    gsgs_Event().Disconnect(wxEVT_UPDATE_PREVIEW, wxCommandEventHandler(DesignerPanel::OnUpdatePreview), NULL,
                                     this);
    gsgs_Event().Disconnect(wxEVT_WXGUI_PROJECT_CLOSED, wxCommandEventHandler(DesignerPanel::OnClearPreview),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_WXGUI_PROJECT_LOADED, wxCommandEventHandler(DesignerPanel::OnLoadPreview),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_TREE_ITEM_SELECTED, wxCommandEventHandler(DesignerPanel::OnHighlightControl),
                                     NULL, this);
}
...
void DesignerPanel::DoLoadXRC(int topLeveWinType)
{
    ...
    if(panel) {
        ...
        wc::ToolBar* pane = new wc::ToolBar(m_innerContainer);
