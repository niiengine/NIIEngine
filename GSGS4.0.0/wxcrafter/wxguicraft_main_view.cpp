...
GUICraftMainPanel::GUICraftMainPanel(wxWindow* parent, wxCrafterPlugin* plugin, gsgs::TreeCtrl* treeView)
    ...
    , m_plugin(plugin)
{
    ...
    gsgs_Event().Bind(wxEVT_WXC_CMD_BATCH_GENERATE_CODE, &GUICraftMainPanel::OnBatchGenerateCode, this);
    gsgs_Event().Connect(wxEVT_PROPERTIES_MODIFIED,
                                  wxCommandEventHandler(GUICraftMainPanel::OnPropertyChanged), NULL, this);
    gsgs_Event().Connect(wxEVT_PREVIEW_CTRL_SELECTED,
                                  wxCommandEventHandler(GUICraftMainPanel::OnPreviewItemSelected), NULL, this);
    gsgs_Event().Connect(wxEVT_WXC_SELECT_TREE_TLW,
                                  wxCommandEventHandler(GUICraftMainPanel::OnSelectToplevelItem), NULL, this);
    gsgs_Event().Connect(wxEVT_PREVIEW_BOOKPAGE_SELECTED,
                                  wxCommandEventHandler(GUICraftMainPanel::OnBookPageSelected), NULL, this);
    gsgs_Event().Connect(wxEVT_PREVIEW_RIBBON_PAGE_SELECTED,
                                  wxCommandEventHandler(GUICraftMainPanel::OnRibbonPageSelected), NULL, this);
    gsgs_Event().Connect(wxEVT_PREVIEW_CLOSED, wxCommandEventHandler(GUICraftMainPanel::OnPreviewClosed), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_WXC_OPEN_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnOpenProject), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_WXC_SAVE_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnSaveProject), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_WXC_CLOSE_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnCloseProject),
                                  NULL, this);
    gsgs_Event().Connect(wxEVT_WXC_CMD_GENERATE_CODE, wxCommandEventHandler(GUICraftMainPanel::OnGenerateCode),
                                  NULL, this);
    gsgs_Event().Connect(wxEVT_REFRESH_DESIGNER, wxCommandEventHandler(GUICraftMainPanel::OnRefreshView), NULL,
                                  this);
    gsgs_Event().Connect(wxEVT_PREVIEW_BAR_SELECTED,
                                  wxCommandEventHandler(GUICraftMainPanel::OnBarItemSelected), NULL, this);
    gsgs_Event().Connect(wxEVT_SHOW_CONTEXT_MENU, wxCommandEventHandler(GUICraftMainPanel::OnShowContextMenu),
                                  NULL, this);
    gsgs_Event().Connect(wxEVT_DELETE_CONTROL, wxCommandEventHandler(GUICraftMainPanel::OnDelete), NULL, this);
    gsgs_Event().Connect(wxEVT_UPDATE_PREVIEW, wxCommandEventHandler(GUICraftMainPanel::OnUpdatePreview), NULL,
                                  this);
    gsgs_Event().Bind(wxEVT_FINDBAR_ABOUT_TO_SHOW, &GUICraftMainPanel::OnFindBar, this);
    gsgs_Event().Connect(wxEVT_REFRESH_PROPERTIES_VIEW,
    ...
    LexerStyle::Ptr_t cppLexer = gsgs_EditorConfig().GetLexer("C++");
    if(cppLexer) {
    ...
    LexerStyle::Ptr_t xmlLexer = gsgs_EditorConfig().GetLexer("XML");
    if(xmlLexer) { xmlLexer->Apply(m_textCtrlXrc); }
...
GUICraftMainPanel::~GUICraftMainPanel()
{
    ...
    gsgs_Event().Disconnect(wxEVT_PROPERTIES_MODIFIED,
                                     wxCommandEventHandler(GUICraftMainPanel::OnPropertyChanged), NULL, this);
    gsgs_Event().Disconnect(wxEVT_PREVIEW_CTRL_SELECTED,
                                     wxCommandEventHandler(GUICraftMainPanel::OnPreviewItemSelected), NULL, this);
    gsgs_Event().Disconnect(wxEVT_PREVIEW_BOOKPAGE_SELECTED,
                                     wxCommandEventHandler(GUICraftMainPanel::OnBookPageSelected), NULL, this);
    gsgs_Event().Disconnect(wxEVT_PREVIEW_RIBBON_PAGE_SELECTED,
                                     wxCommandEventHandler(GUICraftMainPanel::OnRibbonPageSelected), NULL, this);
    gsgs_Event().Disconnect(wxEVT_PREVIEW_CLOSED, wxCommandEventHandler(GUICraftMainPanel::OnPreviewClosed),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_WXC_OPEN_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnOpenProject),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_WXC_SAVE_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnSaveProject),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_WXC_CMD_GENERATE_CODE,
                                     wxCommandEventHandler(GUICraftMainPanel::OnGenerateCode), NULL, this);
    gsgs_Event().Unbind(wxEVT_WXC_CMD_BATCH_GENERATE_CODE, &GUICraftMainPanel::OnBatchGenerateCode, this);
    gsgs_Event().Disconnect(wxEVT_REFRESH_DESIGNER, wxCommandEventHandler(GUICraftMainPanel::OnRefreshView),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_WXC_CLOSE_PROJECT, wxCommandEventHandler(GUICraftMainPanel::OnCloseProject),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_PREVIEW_BAR_SELECTED,
                                     wxCommandEventHandler(GUICraftMainPanel::OnBarItemSelected), NULL, this);
    gsgs_Event().Disconnect(wxEVT_SHOW_CONTEXT_MENU,
                                     wxCommandEventHandler(GUICraftMainPanel::OnShowContextMenu), NULL, this);
    gsgs_Event().Disconnect(wxEVT_DELETE_CONTROL, wxCommandEventHandler(GUICraftMainPanel::OnDelete), NULL,
                                     this);
    gsgs_Event().Disconnect(wxEVT_UPDATE_PREVIEW, wxCommandEventHandler(GUICraftMainPanel::OnUpdatePreview),
                                     NULL, this);
    gsgs_Event().Unbind(wxEVT_FINDBAR_ABOUT_TO_SHOW, &GUICraftMainPanel::OnFindBar, this);
    gsgs_Event().Disconnect(wxEVT_REFRESH_PROPERTIES_VIEW,
                                     wxCommandEventHandler(GUICraftMainPanel::OnRefreshPropertiesView), NULL, this);
    ...
    gsgs_Event().AddPendingEvent(deleteEvent);
}
...
void GUICraftMainPanel::Clear()
{
    ...
    gsgs_Event().AddPendingEvent(closePreviewEvt);
}
...
void GUICraftMainPanel::OnShowContextMenu(wxCommandEvent& e)
{
    ...
    wxString title;
    if(data && data->m_wxcWidget) { title = data->m_wxcWidget->GetName(); }
...
void GUICraftMainPanel::OnItemSelected(wxTreeEvent& event)
{
    ...
    if(!bManualSelection) { NotifyPreviewChanged(); }
    ...
    gsgs_Event().AddPendingEvent(eventTreeItemSeleted);
}
...
GUICraftItemData* GUICraftMainPanel::GetSelItemData()
{
    ...
    if(itemId.IsOk() == false) return NULL;
...
void GUICraftMainPanel::NotifyPreviewChanged(int eventType)
{
    ...
    if(bookPage) {
        ...
        if(book) { book->SetSelection(bookPage); }
    }
...
void GUICraftMainPanel::OnPropertyChanged(wxCommandEvent& e)
{
    ...
    if(modifiedWidget && modifiedWidget != itemData->m_wxcWidget) {
        ...
        if(item.IsOk()) {
            ...
            if(data) { modifiedWidget = dynamic_cast<wxcWidget*>(data->m_wxcWidget); }
        }
    }
    ...
    if(modifiedWidget && modifiedWidget->IsParentAuiToolbar()) {
        ...
        if(auiItem) {
            ...
            gsgs_Event().AddPendingEvent(evt); // Keep the events view in sync
        }
    }
...
{
    if(!DoCheckLicense(e.GetId())) return;
...
bool GUICraftMainPanel::GenerateCppOutput(wxString& cpp, wxString& header, wxArrayString& headers,
                                          gsgsStringMap& additionalFiles, size_t flags) const
{
...
void GUICraftMainPanel::OnSaveProject(wxCommandEvent& e)
{
    ...
    root.getObject().append(metadata);

    wxFFile fp(wxcProjectMetadata::Get().GetProjectFile(), wxT("w+b"));
    if(fp.IsOpened()) {
        root.getObject().append(ToJSON());

        fp.Write(root.getObject().getString(), wxConvUTF8);
        fp.Close();
...
void GUICraftMainPanel::OnOpenProject(wxCommandEvent& e)
{
    ...
    if(path.IsEmpty() == false) {
        ...
        if(fp.IsOpened()) {
            ...
            gsgs_Event().AddPendingEvent(evtProjectLoaded);
        }
    }
}
...
void GUICraftMainPanel::LoadProject(const wxFileName& fn, const wxString& fileContent, bool lightLoad)
{
    ...
    if(!lightLoad) {
        ...
        wxcProjectMetadata::Get().FromJSON(json.getObject().getObject(wxT("metadata")));
    ...
    JSONElement windows = json.getObject().getObject(wxT("windows"));
    int nCount = windows.getArraySize();
    ...
    if(deleteAllItems) {
        ...
        wxcProjectMetadata::Get().FromJSON(
            json.getObject().getObject(wxT("metadata"))); // Needed for Redo() to work correctly
        wxcProjectMetadata::Get().UpdatePaths();
    }

    wxTreeItemId dummy;
    for(int i = 0; i < nCount; i++) {
        wxcWidget* wrapper = Allocator::Instance()->CreateWrapperFromJSON(windows.getArray(i));
    ...
    if(firstChild.IsOk()) { m_treeControls->SelectItem(firstChild); }
...
void GUICraftMainPanel::DoUnsetItemData(const wxTreeItemId& item)
{
    if(item.IsOk()) {
        ...
        if(itemData) { itemData->m_wxcWidget = NULL; }
...
void GUICraftMainPanel::OnDelete(wxCommandEvent& e)
{
    ...
    if(data) {
        ...
        m_treeControls->CallAfter(&gsgs::TreeCtrl::SetFocus); // Without this, focus will unexpectedly appear elsewhere,
...
{
    if(!searchFromItem.IsOk()) { searchFromItem = m_treeControls->GetRootItem(); }
...
void GUICraftMainPanel::OnMoveItemUI(wxUpdateUIEvent& e)
{
    ...
    if(e.GetId() == ID_MOVE_NODE_DOWN) {
        if(control->GetParent()) {
            ...
            if(item.IsOk()) { e.Enable(m_treeControls->GetNextSibling(item).IsOk()); }
        }
        ...
        if(control->GetParent()) {
            ...
            wxTreeItemId item;
            DoFindName(m_treeControls->GetRootItem(), control->GetName(), item);
            if(item.IsOk()) { e.Enable(m_treeControls->GetPrevSibling(item).IsOk()); }
        }
    } else if(e.GetId() == ID_MOVE_NODE_INTO_SIZER) {
        if(!control->IsSizerItem()) { return; }
...
{
    if(item.IsOk() == false) { return wxTreeItemId(); }
...
bool GUICraftMainPanel::DoUpdateNotebookSelection(const wxTreeItemId& item)
{
    ...
    if(!page && !ribbonPage) return false;
...
void GUICraftMainPanel::OnCut(wxCommandEvent& e)
{
    ...
    if(m_treeControls->ItemHasChildren(item)) m_treeControls->DeleteChildren(item);
...
void GUICraftMainPanel::OnPaste(wxCommandEvent& e)
{
    ...
    if(destTLW) { destTLW->StoreNames(existingNames); }
...
void GUICraftMainPanel::OnEndDrag(wxTreeEvent& event)
{
    ...
    if(!itemDst.IsOk() || !m_draggedItem.IsOk()) { return; }
    ...
    if(target->IsDirectOrIndirectChildOf(source)) return;

    // Can we paste the item to the new location?
    if(!Allocator::Instance()->CanPaste(source, target)) { return; }
    ...
    if(Pasting) {
        ...
        if(!source->IsTopWindow() && differentTLW) {
            ...
            if(source->GetName() != clone->GetName()) { source->SetName(clone->GetName()); }
                                     ...
                                     wxcWidget* sourceItemData)
{
    ...
    if(guiTargetItem && guiTargetItem->m_wxcWidget) { target = guiTargetItem->m_wxcWidget; }
    ...
    if(sourceItem.IsOk()) {
        ...
        if(m_treeControls->ItemHasChildren(sourceItem)) m_treeControls->DeleteChildren(sourceItem);
                                       ...
                                       wxcWidget* sourceItemData, bool insertBefore)
{
    ...
    if(sourceItem.IsOk()) {
        ...
        if(!DoCheckInsert(source, target)) return;
...
{
    wxCommandEvent closePreviewEvt(wxEVT_CLOSE_PREVIEW);
    gsgs_Event().ProcessEvent(closePreviewEvt);
}
...
wxcWidget* GUICraftMainPanel::GetActiveWizardPage() const
{
    ...
    if(topLevel.IsOk() == false) return NULL;

    wxTreeItemId sel = m_treeControls->GetSelection();
    if(sel.IsOk() == false) return NULL;
    ...
    if(topLevelItemData->m_wxcWidget->GetType() != ID_WXWIZARD) return NULL;
...
void GUICraftMainPanel::OnCloseProject(wxCommandEvent& e)
{
    ...
    gsgs_Event().AddPendingEvent(refreshView);
}
...
void GUICraftMainPanel::OnRedo(wxCommandEvent& e)
{
    if(!m_plugin->IsTabMode() && !(m_plugin->GetMainFrame() && m_plugin->GetMainFrame()->IsShown())) {
        e.Skip();
        return; // Otherwise, in non-tabbed mode, there'll be contamination between us and gsgsFrame
    }
...
State::Ptr_t GUICraftMainPanel::CurrentState()
{
    ...
    root.getObject().append(metadata);
    root.getObject().append(ToJSON(wxTreeItemId()));

    State::Ptr_t state(new State);
    state->project_json = root.getObject().getString();
    ...
    if(item.IsOk()) {
        ...
        if(control && control->m_wxcWidget) { state->parentTLW = control->m_wxcWidget->GetTopLevel()->GetName(); }
    }
    return state;
}
...
{
    if(event.GetId() == XRCID("GenerateCPP")) { wxcProjectMetadata::Get().SetGenerateCPPCode(event.IsChecked()); }
    if(event.GetId() == XRCID("GenerateXRC")) { wxcProjectMetadata::Get().SetGenerateXRC(event.IsChecked()); }
}
...
wxArrayString GUICraftMainPanel::GetCustomControlsUsed() const
{
    ...
    while(child.IsOk()) {
        ...
        GUICraftItemData* itemData = dynamic_cast<GUICraftItemData*>(m_treeControls->GetItemData(child));
        if(itemData && itemData->m_wxcWidget) { itemData->m_wxcWidget->GetCustomControlsName(customControls); }
        child = m_treeControls->GetNextChild(rootItem, cookie);
    }
...
void GUICraftMainPanel::OnFindBar(gsgs::FindEvent& e)
{
    e.Skip();
    if(IsShown()) {
        int sel = m_mainBook->GetSelection();
...
void GUICraftMainPanel::DoDismissFindBar()
{
    // Notify the find-bar to clear any pointer referenced by it
    // that is belonged to this view
    gsgs::FindEvent evtFindBar(wxEVT_FINDBAR_RELEASE_EDITOR);
    evtFindBar.SetCtrl(m_textCtrlCppSource);
    gsgs_Event().ProcessEvent(evtFindBar);
...
{
    GUICraftItemData* itemData = dynamic_cast<GUICraftItemData*>(m_treeControls->GetItemData(item));
    if(itemData && itemData->m_wxcWidget == widget) { return item; }

    if(!m_treeControls->HasChildren(item)) return wxTreeItemId();
    ...
    while(child.IsOk()) {
        ...
        if(itemData && itemData->m_wxcWidget) {
            ...
            if(matchedItem.IsOk()) { return matchedItem; }
        }
        child = m_treeControls->GetNextChild(item, cookie);
    }
    return wxTreeItemId();
...
void GUICraftMainPanel::AddCustomControl(int controlId)
{
    ...
    if(templateInfo.IsValid() == false) { return; }
...
void GUICraftMainPanel::DoChangeOrInsertIntoSizer(int id)
{
    ...
    if(widgetType == wxNOT_FOUND) return;
...
void GUICraftMainPanel::DoGenerateCode(bool silent)
{
    ...
    if(!silent) { wxcSettings::Get().ShowNagDialogIfNeeded(); }
    ...
    if(!dirs.IsEmpty()) {
        if(dirs.size() > 2) { blockGuard << dirs.Item(dirs.size() - 2) << "_"; }
    ...
    if(wxcProjectMetadata::Get().GetGenerateCPPCode() && !additionalFiles.empty()) {
        gsgsStringMap::const_iterator itr = additionalFiles.begin();
    ...
    if(wxcProjectMetadata::Get().GetGenerateXRC()) {
        ...
        if(!xrcFilePath.empty()) {
            ...
            if(!XrcOutput.empty()) {
                ...
                if(!doc.Save(out)) { wxMessageBox(XrcOutput); }
...
void GUICraftMainPanel::BatchGenerate(const wxArrayString& files)
{
...

    {
        ...
        // Lock the UI
        wxWindowUpdateLocker locker(gsgs_Event().TopFrame());

        for(size_t i = 0; i < wxcpFiles.size(); ++i) {
            wxString fileContent;
            if(FileUtil::ReadFileContent(wxcpFiles.Item(i), fileContent)) {
