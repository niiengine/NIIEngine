...
protected:
    ...
    gsgsStringMap m_additionalFiles;
...
public:
    ...
    void SetAdditionalFiles(const gsgsStringMap& additionalFiles) { this->m_additionalFiles = additionalFiles; }
    const gsgsStringMap& GetAdditionalFiles() const { return m_additionalFiles; }
