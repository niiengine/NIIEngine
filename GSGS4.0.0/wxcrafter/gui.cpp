    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_mainToolbar = new gsgs::ToolBar(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTB_FLAT);
    ...
    this->Connect(m_menuItemBackToCodelite->GetId(), wxEVT_UPDATE_UI,
                  wxUpdateUIEventHandler(MainFrameBase::OnSwitchToGSGSUI), NULL, this);
