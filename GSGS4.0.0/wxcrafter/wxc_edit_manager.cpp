...
wxcEditManager::wxcEditManager() : 
    m_isModified(false)
{
    gsgs_Event().Connect(wxEVT_WXGUI_PROJECT_SAVED, wxCommandEventHandler(wxcEditManager::OnProjectSaved), NULL, this);
    gsgs_Event().Connect(wxEVT_WXC_PROJECT_LOADED, wxCommandEventHandler(wxcEditManager::OnProjectLoaded), NULL, this);
    gsgs_Event().Connect(wxEVT_WXGUI_PROJECT_CLOSED, wxCommandEventHandler(wxcEditManager::OnProjectClosed), NULL, this);
    gsgs_Event().Connect(wxEVT_PROJECT_METADATA_MODIFIED, wxCommandEventHandler(wxcEditManager::OnProjectMetadataChanged), NULL, this);
    gsgs_Event().Connect(wxEVT_PROPERTIES_MODIFIED, wxCommandEventHandler(wxcEditManager::OnPropertyChanged), NULL, this);
}
