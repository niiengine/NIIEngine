...
protected:
    ...
    /**
     * @brief covnert LSP::SignatureHelp class to TagEntryPtrList
     */
    void LSPSignatureHelpToTagEntries(TagEntryPtrList& tags, const LSP::SignatureHelp& sighelp);
...
protected:
    ...
    void OnCompileCommandsGenerated(gsgs::Event& event);
