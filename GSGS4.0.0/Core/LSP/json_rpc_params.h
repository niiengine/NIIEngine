...
// Params
//===----------------------------------------------------------------------------------
class _gsgsAPI Params : public Serializable
{
public:
...
//===----------------------------------------------------------------------------------
class _gsgsAPI TextDocumentPositionParams : public Params
{
...
// CompletionParams
//===----------------------------------------------------------------------------------
class _gsgsAPI CompletionParams : public TextDocumentPositionParams
{
public:
    CompletionParams();
...
//===----------------------------------------------------------------------------------
class _gsgsAPI DidOpenTextDocumentParams : public Params
{
...
//===----------------------------------------------------------------------------------
class _gsgsAPI DidCloseTextDocumentParams : public Params
{
    TextDocumentIdentifier m_textDocument;
...
//===----------------------------------------------------------------------------------
class _gsgsAPI DidChangeTextDocumentParams : public Params
{
...
//===----------------------------------------------------------------------------------
class _gsgsAPI DidSaveTextDocumentParams : public Params
{
    TextDocumentIdentifier m_textDocument;
    wxString m_text;
