...
class _gsgsAPI LSPEvent : public gsgs::Event
{
...
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_DEFINITION, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_INITIALIZED, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_COMPLETION_READY, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_RESTART_NEEDED, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_REPARSE_NEEDED, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_METHOD_NOT_FOUND, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_SIGNATURE_HELP, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_SET_DIAGNOSTICS, LSPEvent);
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_LSP_CLEAR_DIAGNOSTICS, LSPEvent);
