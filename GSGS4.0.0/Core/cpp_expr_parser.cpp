...
static gsgs::ExpressionResult result;
...
gsgs::ExpressionResult &parse_expression(const std::string &in)
{
	result.Reset();
...
case 5:
{
								...
								yyerrok;
								/*fprintf(stderr, "gsgs: syntax error, unexpected token '%s' found at line %d \n", cl_expr_text, cl_expr_lineno);*/
								/*fflush(stderr);*/
								expr_syncParser();
						}
break;
