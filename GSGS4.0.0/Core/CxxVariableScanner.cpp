...
namespace gsgs
{
    ...
    CxxVariableScanner::CxxVariableScanner(const wxString& buffer, eCxxStandard standard, const gsgsStringMap& macros,
    ...
    void CxxVariableScanner::OptimizeBuffer(const wxString& buffer, wxString& stripped_buffer)
    {
        ...
        if(!sc) {
            gsgsWARNING() << "CxxVariableScanner::OptimizeBuffer(): failed to create Scanner_t" << clEndl;
