...
namespace gsgs
{
    ...
    bool ReplacePattern(const wxString& in, const wxString& pattern, const wxString& replaceWith, wxString& outStr)
    {
    ...
    void Replacement::construct(const std::string& pattern, const std::string& replacement)
    {
        is_ok = true;
