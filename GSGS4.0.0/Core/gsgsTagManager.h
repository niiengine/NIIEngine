...
#ifndef gsgs_CTAGS_MANAGER_H
#define gsgs_CTAGS_MANAGER_H
...
namespace gsgs
{
    ...
    wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TAGS_DB_UPGRADE, wxCommandEvent);
    wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TAGS_DB_UPGRADE_INTER, wxCommandEvent);
     ...
     *
     */
    class _gsgsAPI TagsManager : public wxEvtHandler
    {
    ...
    public:
         ...
         */
        inline CxxFileCacheSymbols::Ptr_t GetFileCache() { return m_symbolsCache; }

        inline void SetEvtHandler(wxEvtHandler* handler) { m_evtHandler = handler; }
         ...
         */
        inline const std::vector<TagEntryPtr>& GetCachedFileTags() const { return m_cachedFileFunctionsTags; }

        /**
         * Return the CtagsOptions used by the tags manager
         * @return
         */
        inline const TagsOptionsData& GetCtagsOptions() const { return m_tagsOptions; }
         ...
         * @param path ctags
         */
        void SetIndexerPath(const wxString& path);
         ...
         */
        TagEntryPtrList ParseBuffer(const wxString& content, const wxString& filename = "");
         ...
         * @return tag tree
         */
        TagTreePtr Load(const wxFileName& fileName, TagEntryPtrList* tags = NULL);
         ...
         */
        inline const wxArrayString& GetProjectPaths() const { return m_projectPaths; }
         ...
         */
        gsgsTipInfoPtr GetFunctionTip(const wxFileName& fileName, int lineno, const wxString& expression,
         ...
         *        string will be parsed by gsgs to determine the current scope
         ...
         * @param word the token under the cursor
         * @param text scope where token was found
         * @param gotoImpl set to true, if you wish that gsgs will find the implementation, false to declaration
        ...
        /**
         * @brief get the scope name. gsgs assumes that the caret is placed at the end of the 'scope'
         ...
         * @return true on success, false otherwise
         */
        bool GetFunctionDetails(const wxFileName& fileName, int lineno, TagEntryPtr& tag, Function& func);
         ...
         */
        bool AreTheSame(const TagEntryPtrList& v1, const TagEntryPtrList& v2) const;
         ...
         */
        static void GetCXXKeywords(gsgsStringSet& words);
    ...
    protected:
         ...
         */
        void OnIndexerTerminated(gsgs::ProcessEvent& event);
    ...
    protected:
        ...
        void DoSortByVisibility(TagEntryPtrList& tags);
        void GetScopesByScopeName(const wxString& scopeName, wxArrayString& scopes);
    private:
        wxFileName m_IndexerPath;
        IProcess* m_IndexerProcess;
        wxString m_ctagsCmd;
        wxStopWatch m_watch;
        ...
        gsgsStringSet m_CppIgnoreKeyWords;
    ...
    #endif
        CxxFileCacheSymbols::Ptr_t m_symbolsCache;
    };

    /// create the singleton typedef
    class _gsgsAPI TagsManagerST
    {
    public:
