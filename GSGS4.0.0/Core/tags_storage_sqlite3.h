...
------------------------------------------------------------------------------
*/
#ifndef gsgs_TAGS_DATABASE_H
#define gsgs_TAGS_DATABASE_H
 ...
 * this class is responsible for creating the schema for the gsgs library.
 *
...
class gsgsSqliteDB : public wxSQLite3Database
{
...
class _gsgsAPI TagsStorageSQLite : public gsgs::ITagsStorage
{
public:
    /**
     ...
     */
    virtual void Rollback() { return m_db->Rollback(); }
     ...
     */
    inline wxSQLite3Statement PrepareStatement(const wxString& sql) { return m_db->PrepareStatement(sql); }
