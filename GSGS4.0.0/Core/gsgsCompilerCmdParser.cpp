...
namespace gsgs
{
    ...
    CompilerCmdParser::CompilerCmdParser(const wxString& cmdline, const wxString& workingDirectory)
    {
        m_argc = 0;
        m_argv = NULL;
    ...
    CompilerCmdParser::~CompilerCmdParser()
    {
        freeargv(m_argv);
        m_argv = NULL;
        m_argc = 0;
    ...
    wxString CompilerCmdParser::GetCompileLine() const
    {
        wxString s;
    ...
    wxString CompilerCmdParser::GetStandardWithPrefix() const
    {
    ...
    void CompilerCmdParser::MakeAbsolute(const wxString& path)
    {
        wxArrayString incls;
    ...
    void CompilerCmdParser::AddIncludesFromFile(const wxFileName& includeFile)
    {
        ...
        if(fp.IsOpened()) {
            ...
            fp.ReadAll(&content);
            content.Replace("\n", " ");
            CompilerCmdParser cclp(content);
