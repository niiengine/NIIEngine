...
------------------------------------------------------------------------------
*/
#ifndef gsgs_MULTIBOOK_H
#define gsgs_MULTIBOOK_H
...
namespace gsgs
{
    class _gsgsAPI MultiBook : public wxPanel
    {
    public:
        MultiBook(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition,
        ...
        TabHistoryPtr_t GetHistory() { return m_history; }
         ...
         * @param tabs [output]
         */
        size_t GetAllTabs(TabInfoVec_t& tabs);
