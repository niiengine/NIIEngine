...
extern _gsgsAPI void              get_variables(const std::string &in, gsgs::VariableList &li, const std::map<std::string, std::string> &ignoreMap, bool isUsedWithinFunc);
extern _gsgsAPI bool              is_primitive_type(const std::string &in);
extern _gsgsAPI void              get_functions(const std::string &in, gsgs::FunctionList &li, const std::map<std::string, std::string> &ignoreTokens);
extern _gsgsAPI void              get_typedefs(const std::string &in, gsgs::TypedefList &li);
extern _gsgsAPI gsgs::ExpressionResult &parse_expression(const std::string &in);
