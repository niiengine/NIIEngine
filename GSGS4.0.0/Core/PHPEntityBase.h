...
class _gsgsAPI PHPEntityBase
{
public:
    typedef gsgs::SharedPtr<PHPEntityBase> Ptr_t;
...
protected:
    JSONObject BaseToJSON(const wxString& entityType) const;
    void BaseFromJSON(const JSONObject& json);
