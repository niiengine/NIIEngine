...
namespace gsgs
{
    ...
    wxString CxxVariable::GetTypeAsString(const gsgsStringMap& table) const
    {
        return PackType(m_type, m_standard, false, table);
    }
    wxString CxxVariable::GetTypeAsCxxString(const gsgsStringMap& table) const
    {
        return PackType(m_type, m_standard, true, table);
    }

    wxString CxxVariable::ToString(size_t flags, const gsgsStringMap& table) const
    {
        wxString str;
