...
/////////////////////////////////////////////////////////////////////////////
// Name:        gsgsTreeListCtrl.h (originally treelistctrl.h)
// Purpose:     TreeListCtrl class (was wxTreeListCtrl pre-nameclash)
...
namespace gsgs
{
    ...
    class _gsgsAPI TreeListColumnInfo: public wxObject {

    public:
        TreeListColumnInfo (const wxString &text = wxEmptyString,
        ...
        TreeListColumnInfo (const TreeListColumnInfo& other) {
            m_text = other.m_text;
        ...
        TreeListColumnInfo& SetText (const wxString& text) { m_text = text; return *this; }

        int GetWidth() const { return m_width; }
        TreeListColumnInfo& SetWidth (int width) { m_width = width; return *this; }

        int GetAlignment() const { return m_flag; }
        TreeListColumnInfo& SetAlignment (int flag) { m_flag = flag; return *this; }

        int GetImage() const { return m_image; }
        TreeListColumnInfo& SetImage (int image) { m_image = image; return *this; }

        int GetSelectedImage() const { return m_selected_image; }
        TreeListColumnInfo& SetSelectedImage (int image) { m_selected_image = image; return *this; }

        bool IsEditable() const { return m_edit; }
        TreeListColumnInfo& SetEditable (bool edit)
            { m_edit = edit; return *this; }

        bool IsShown() const { return m_shown; }
        TreeListColumnInfo& SetShown(bool shown) { m_shown = shown; return *this; }
    ...
    extern _gsgsAPI const wxChar* clTreeListCtrlNameStr;

    class _gsgsAPI TreeListCtrl : public wxControl
    {
        friend class TreeListHeaderWindow;
        friend class TreeListMainWindow;
    ...
    public:
        ...
        TreeListCtrl(wxWindow *parent, wxWindowID id = -1,
        ...
        void AddColumn (const wxString& text,
                        ...
                        bool shown = true,
                        bool edit = false) {
            AddColumn (TreeListColumnInfo (text, width, flag, image, shown, edit));
        }
        ...
        void InsertColumn (int before,
                           ...
                           bool edit = false) {
            InsertColumn (before,
                          TreeListColumnInfo (text, width, flag, image, shown, edit));
        }
        ...
        void SetColumn (int column, const TreeListColumnInfo& colInfo);
    ...
    protected:
        ...
        TreeListHeaderWindow* GetHeaderWindow() const
            { return m_header_win; }
        TreeListHeaderWindow* m_header_win;  // future cleanup: make private or remove GetHeaderWindow()

        // main window, the "true" tree ctrl
        TreeListMainWindow* GetMainWindow() const
            { return m_main_win; }
        TreeListMainWindow* m_main_win;  // future cleanup: make private or remove GetMainWindow()
