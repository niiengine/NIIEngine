...
namespace gsgs
{
    ...
    public:
        ...
        inline void SetFile(const wxString& file)           { this->m_file = file; }
        inline void SetLastRetaggedTimestamp(const int& lastRetaggedTimestamp) {
            this->m_lastRetaggedTimestamp = lastRetaggedTimestamp;
        }
        inline const wxString& GetFile() const              { return m_file; }
        inline const int& GetLastRetaggedTimestamp() const  { return m_lastRetaggedTimestamp; }
        inline void SetId(const long& id)                   { this->m_id = id; }
    ...
    typedef SharedPtr<FileEntry> FileEntryPtr;
    ...
    public:
         ...
         */
        inline const wxFileName & GetDatabaseFileName() const{ return m_fileName; }
        ...
        inline int GetSingleSearchLimit() const             { return m_singleSearchLimit; }

        inline void SetMaxWorkspaceTagToColour(int maxWorkspaceTagToColour)
        {
    ...
    typedef SharedPtr<ITagsStorage> ITagsStoragePtr;
}
#endif
