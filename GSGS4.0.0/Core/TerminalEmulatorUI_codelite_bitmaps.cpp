...
void wxCB1DAInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/TerminalEmulatorUI_codelite_bitmaps.cpp$F__tool_codelite13.0.2_CodeLite_TerminalEmulatorUI_codelite_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/TerminalEmulatorUI_codelite_bitmaps.cpp$F__tool_codelite13.0.2_CodeLite_TerminalEmulatorUI_codelite_bitmaps.xrc"));
}
