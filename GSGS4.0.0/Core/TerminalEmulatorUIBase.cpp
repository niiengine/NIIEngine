    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_textCtrl = gsgs_Style().createTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxTE_PROCESS_ENTER);
...
gsgsProgressDlgBase::gsgsProgressDlgBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style)
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticLabel = gsgs_Style().createStaticText(this, wxID_ANY, _("MyLabel"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    mainSizer->Add(m_staticLabel, 0, wxALL|wxEXPAND, WXC_FROM_DIP(5));
    
    m_gauge = new wxGauge(this, wxID_ANY, 100, wxDefaultPosition, wxDLG_UNIT(this, wxSize(400,-1)), wxGA_HORIZONTAL);
    m_gauge->SetValue(10);
    
    mainSizer->Add(m_gauge, 0, wxALL|wxEXPAND, WXC_FROM_DIP(5));
    
    SetName(wxT("gsgsProgressDlgBase"));
...
gsgsProgressDlgBase::~gsgsProgressDlgBase()
{
}
