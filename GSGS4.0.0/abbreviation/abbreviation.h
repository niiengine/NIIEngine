...
protected:
    void OnWordComplete(CodeCompleteEvent& event);
...
protected:
    ...
    void AddAbbreviations(CodeCompleteEvent& e);
    void OnAbbrevSelected(CodeCompleteEvent& e);
    void InitDefaults();
    bool InsertExpansion(const wxString& abbreviation);
    void OnCompletionBoxShowing(CodeCompleteEvent& event);
