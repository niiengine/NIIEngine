...
namespace gsgs
{
    ...
    // Breakpoint types. If you add more, Editor::FillBPtoMarkerArray will also need altering
    enum BreakpointType {
    ...
    class BreakpointInfo : public ObjectData
    {
    public:
     ...
     * @brief
     */
    class BreakpointInfoArray : public ObjectData
    {
    ...
    public:
        virtual void DeSerialize(Serializer& arch)
        {
            ...
            for (size_t i = 0; i < bt_count; i++) {
                ...
                BreakpointInfo bkpt;
                arch.Read(name, (ObjectData*)&bkpt);
        ...
        virtual void Serialize(Serializer& arch)
        {
            ...
            for (size_t i = 0; i < m_breakpoints.size(); i++) {
                wxString name = wxString::Format(wxT("Breakpoint%u"), (unsigned int)i);
                arch.Write(name, (ObjectData*)&m_breakpoints.at(i));
            }
        }
    };

    class DebuggerInformation : public ObjectData
    {
    public:
        enum eGdbFlags {
            kPrintObjectOff = (1 << 0),
        ...
        bool whenBreakpointHitRaiseGSGS;
    public:
        DebuggerInformation()
            : name(wxEmptyString)
            , path(wxEmptyString)
            ...
            , whenBreakpointHitRaiseGSGS(true)
            , charArrAsPtr(false)
        ...
        void Serialize(Serializer& arch)
        {
            ...
            arch.Write(wxT("whenBreakpointHitRaiseGSGS"), whenBreakpointHitRaiseGSGS);
        ...
        void DeSerialize(Serializer& arch)
        {
            ...
            wxFileName gsgsInstallDir = wxFileName(gsgs_Path().GetUserDataDir(), "gdb_printers");
            startupCommands.Replace("$GSGSGdbPrinters", gsgsInstallDir.GetFullPath());
            ...
            arch.Read(wxT("whenBreakpointHitRaiseGSGS"), whenBreakpointHitRaiseGSGS);
    ...
    public:
        ...
        void SetEnvironment(EditorConfig* env) { m_env = env; }
