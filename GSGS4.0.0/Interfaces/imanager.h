...
namespace gsgs
{
    ...
    class _gsgsAPI IManager
    {
    public:
        IManager() {}
        virtual ~IManager() {}

        const wxArrayString& GetOutputTabs() const { return mOPNameList; }
        const wxArrayString& GetWorkspaceTabs() const { return mWSNameList; }
        const wxArrayString& GetPerspectiveTabs() const { return mPTNameList; }

        void AddWorkspaceTab(const wxString& tabLabel);

        void AddOutputTab(const wxString& tabLabel);

        void AddPerspectiveTab(const wxString& tabLabel);

        virtual ToolBar * GetToolBar() = 0;
         ...
         * @return pointer to the current editor, or NULL incase the active editor is not of type Editor or no active
         * editor open
         */
         ...
         * @return
         */
        virtual EditorBar* GetNavigationBar() = 0;
        /**
         ...
         */
        virtual IEditor * OpenFile(const wxString& fileName, const wxBitmap& bmp, const wxString& tooltip = wxEmptyString) = 0;
         ...
         * @sa ConfigTool
         */
        virtual ConfigTool* GetConfigTool() = 0;
         ...
         * @sa TreeType
         */
        virtual TreeCtrl* GetFileExplorerTree() = 0;
        virtual TreeCtrl* GetWorkspaceTree() = 0;
        ...
        /**
         * @brief return the startup directory of gsgs which is also the base directory for searching installation files
        ...
        /**
         * @brief return an instance to the tags manager - which allows access to gsgs CodeCompletion API
         ...
         */
        virtual CxxWS* GetWorkspace() = 0;

        /**
         * @brief return the workspace view tab
         * @return
         */
        virtual WorkspaceView* GetWorkspaceView() = 0;
        ...
        /**
         * @brief return the size of the icons used by gsgs
         * @return 16 or 24
         */
         ...
         * gsgs. On Mac, only single toolbar is allowed in the application (otherwise, the application
         ...
         */
        virtual Plugin* GetPlugin(const wxString& pluginName) = 0;
         ...
         */
        virtual OptionsConfig * GetEditorSettings() = 0;
        ...
        virtual wxStyledTextCtrl * CreateEditor(wxWindow* parent) = 0;

        /**
         * @brief return the default icons loader class
         */
        virtual ImageManager* GetStdIcons() = 0;
         ...
         */
        virtual size_t GetAllTabs(TabVec_t & tabs) = 0;
    ...
    private:
        wxArrayString mWSNameList;
        wxArrayString mOPNameList;
        wxArrayString mPTNameList;
    };
}
#endif // IMANAGER_H
