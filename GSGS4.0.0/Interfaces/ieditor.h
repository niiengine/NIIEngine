...
namespace gsgs
{
    ...
    public:
         ...
         */
        virtual void ShowCalltip(gsgsTipInfoPtr tip) = 0;
         ...
         */
        virtual gsgs::OptionsConfig * GetOptions() = 0;
         ...
         */
        inline void SetFindBookmarksActive(bool findBookmarksActive) { m_findBookmarksActive = findBookmarksActive; }
        /**
         * Returns true if the currently-active bookmark level is 'Find'
         */
        inline bool IsFindBookmarksActive() const { return m_findBookmarksActive; }
    protected:
