...
SpellCheckerOptions::SpellCheckerOptions()
{
    ...
    defaultDicsDir << PathManager::Get().GetDataDir() << wxFILE_SEP_PATH << "dics";
...
// ------------------------------------------------------------
void SpellCheckerOptions::DeSerialize( Serializer& arch )
{
...
// ------------------------------------------------------------
void SpellCheckerOptions::Serialize( Serializer& arch )
{
