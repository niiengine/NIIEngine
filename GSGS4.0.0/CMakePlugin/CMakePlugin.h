 ...
 */
class CMakePlugin : public Plugin
{
...
public:
     ...
     */
    void CreateToolBar(gsgs::ToolBar* toolbar);
...
public:
     ...
     */
    void OnWorkspaceContextMenu(ContextMenuEvent& event);
    ...
    void OnToggleHelpTab(gsgs::Event& event);
    /**
     ...
     */
    void OnCMakeOutput(gsgs::ProcessEvent& event);
    /**
     * @brief cmake process terminated
     */
    void OnCMakeTerminated(gsgs::ProcessEvent& event);

    /**
     * @brief a file has been removed from the project, re-generate CMakeLists.txt
     */
    void OnFileRemoved(gsgs::Event& event);
    /**
