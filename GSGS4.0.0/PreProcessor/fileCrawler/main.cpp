...
void searchAndReplaceW() {
#ifdef __WXMSW__
	wxFFile input(wxT("C:\\Users\\eran\\src\\Development\\C++\\gsgs\\CL_trunk\\gsgs\\tags_options_data.cpp"), wxT("r"));
#else
	wxFFile input(wxT("/home/eran/devl/gsgs/gsgs/tags_options_data.cpp"), wxT("r"));
#endif
