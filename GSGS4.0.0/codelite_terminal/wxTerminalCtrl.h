...
// Use event.GetString()
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TERMINAL_CTRL_READY, gsgs::Event);
// Fired when stdout output is ready
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TERMINAL_CTRL_OUTPUT, gsgs::Event);
// Fired when stderr output is ready
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TERMINAL_CTRL_STDERR, gsgs::Event);
// The terminal has exited
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TERMINAL_CTRL_DONE, gsgs::Event);
// Set the terminal title
wxDECLARE_EXPORTED_EVENT(_gsgsAPI, wxEVT_TERMINAL_CTRL_SET_TITLE, gsgs::Event);
