    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText5 = new wxStaticText(this, wxID_ANY, _("gsgs will place the below text after the auto generated section (so you may override the generated variables)"), wxDefaultPosition, wxSize(-1, -1), 0);
