...
void CodeDesignerItemDlg::OnOk(wxCommandEvent& event)
{
	...
	{
		wxMessageBox( _("Diagram name cannot be empty"), _("光栅故事"), wxICON_WARNING | wxOK );
	...
	{
		wxMessageBox( _("Package name cannot be empty"), _("光栅故事"), wxICON_WARNING | wxOK );
	...
	{
		wxMessageBox( _("Folder name cannot be empty"), _("光栅故事"), wxICON_WARNING | wxOK );
