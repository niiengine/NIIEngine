...
{
    m_config = new gsgs::Config("zoom-navigator.conf");
    ...
    gsgs_Event().Connect(wxEVT_INIT_DONE, wxCommandEventHandler(ZoomNavigator::OnInitDone), NULL, this);
    gsgs_Event().Connect(wxEVT_FILE_SAVED, gsgsEventHandler(ZoomNavigator::OnFileSaved), NULL, this);
    gsgs_Event().Connect(wxEVT_ZN_SETTINGS_UPDATED, wxCommandEventHandler(ZoomNavigator::OnSettingsChanged),
                                  NULL, this);
    ...
    gsgs_Event().Bind(wxEVT_SHOW_WORKSPACE_TAB, &ZoomNavigator::OnToggleTab, this);
    DoInitialize();
}
...
{
    gsgs_Event().Disconnect(wxEVT_INIT_DONE, wxCommandEventHandler(ZoomNavigator::OnInitDone), NULL, this);
    gsgs_Event().Disconnect(wxEVT_ZN_SETTINGS_UPDATED, wxCommandEventHandler(ZoomNavigator::OnSettingsChanged),
                                     NULL, this);
    gsgs_Event().Disconnect(wxEVT_FILE_SAVED, gsgsEventHandler(ZoomNavigator::OnFileSaved), NULL, this);
    ...
    m_topWindow->Disconnect(XRCID("zn_settings"), wxEVT_COMMAND_MENU_SELECTED,
                            wxCommandEventHandler(ZoomNavigator::OnSettings), NULL, this);
    gsgs_Event().Unbind(wxEVT_SHOW_WORKSPACE_TAB, &ZoomNavigator::OnToggleTab, this);
...
void ZoomNavigator::CreateToolBar(gsgs::ToolBar* toolbar) { wxUnusedVar(toolbar); }
...
void ZoomNavigator::OnFileSaved(gsgs::Event& e)
{
    e.Skip();
...
void ZoomNavigator::OnToggleTab(gsgs::Event& event)
{
