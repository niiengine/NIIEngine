    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_table = new gsgs::TableWithPagination(m_panel14, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel14, wxSize(-1, -1)),
                                        wxTAB_TRAVERSAL);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_treeDatabases =
        new gsgs::DefaultTreeCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTR_HIDE_ROOT);
