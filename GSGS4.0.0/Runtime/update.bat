...
xcopy gsgsbm.zip "%TARGET_DIR%\CodeLite\" /H /Y /EXCLUDE:excludes
xcopy gsgs.zip "%TARGET_DIR%\CodeLite\" /H /Y /EXCLUDE:excludes
xcopy gsgs-dark.zip "%TARGET_DIR%\CodeLite\" /H /Y /EXCLUDE:excludes
xcopy gsgs-fresh-farm.zip "%TARGET_DIR%\CodeLite\" /H /Y /EXCLUDE:excludes
