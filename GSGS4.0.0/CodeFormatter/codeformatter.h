...
class CodeFormatter : public Plugin
{
...
private:
    ...
    void OnPhpSettingsChanged(gsgs::Event& event);
...
public:
    ...
    void OnFormatString(gsgs::SourceFormatEvent& e);
    void OnFormatFile(gsgs::SourceFormatEvent& e);
    void OnFormatFiles(wxCommandEvent& e);
    void OnFormatProject(wxCommandEvent& e);
    void OnBeforeFileSave(gsgs::Event& e);
};
