...
void SvnConsole::OnReadProcessOutput(gsgs::ProcessEvent& event)
{
...
void SvnConsole::OnProcessEnd(gsgs::ProcessEvent& event)
{
    wxDELETE(m_process);
...
void SvnConsole::DoProcessNextCommand()
{
    ...
    gsgsDEBUG() << "Running svn command:" << cmdShell << clEndl;
