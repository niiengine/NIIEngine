...
#include "gsgsSerializer.h" // Base class
...
class SvnSettingsData : public ObjectData
{
    ...
    int m_svnTabIndex;
    gsgsStringMap m_workspaceRepoPath;
...
public:
    ...
    void SetWorkspaceRepoPath(const gsgsStringMap& workspaceRepoPath) { this->m_workspaceRepoPath = workspaceRepoPath; }
    gsgsStringMap& GetWorkspaceRepoPath() { return m_workspaceRepoPath; }
};
