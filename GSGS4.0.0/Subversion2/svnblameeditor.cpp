...
void SvnBlameEditor::Initialize()
{
    ...
    SetTabWidth(4);
    wxColour temp;
    gsgs_Style().LightColour(wxT("GREEN"), temp, 7.0);
    // Define some colors to use
    StyleSetBackground(MARGIN_STYLE_START + 1, temp);
    gsgs_Style().LightColour(wxT("BLUE"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 2,  temp);
    gsgs_Style().LightColour(wxT("ORANGE"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 3,  temp);
    gsgs_Style().LightColour(wxT("YELLOW"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 4,  temp);
    gsgs_Style().LightColour(wxT("PURPLE"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 5,  temp);
    gsgs_Style().LightColour(wxT("RED"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 6,  temp);
    gsgs_Style().LightColour(wxT("BROWN"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 7,  temp);
    gsgs_Style().LightColour(wxT("LIGHT GREY"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 8,  temp);
    gsgs_Style().LightColour(wxT("SIENNA"), temp, 7.0);
    StyleSetBackground(MARGIN_STYLE_START + 9,  temp);
