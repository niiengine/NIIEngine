...
class Subversion2 : public Plugin
{
private:
...
protected:
    ...
    // IDE events
    ///////////////////////////////////////////////////////////
    void OnGetCompileLine(gsgs::BuildEvent& event);
    void OnWorkspaceConfigChanged(wxCommandEvent& event);
    void OnProjectFileRemoved(gsgs::Event& event);
    void OnFileDeleted(gsgs::FileEvent& event);
    void OnFolderDeleted(gsgs::FileEvent& event);
    void OnFolderContextMenu(ContextMenuEvent& event);
    void OnFileContextMenu(ContextMenuEvent& event);
    void OnGotoAnythingShowing(gsgs::GotoEvent& e);
