...
class SvnCommitDialog : public SvnCommitDialogBaseClass
{
    ...
    IProcess* m_process;
    wxString m_output;
    gsgsStringMap m_cache;
    wxString m_currentFile;
    gsgs::EditEventsHandler::Ptr_t m_stcMessageHelper;
    gsgs::EditEventsHandler::Ptr_t m_stcDiffHelper;
...
protected:
    ...
    void OnProcessOutput(gsgs::ProcessEvent& e);
    void OnProcessTerminatd(gsgs::ProcessEvent& e);
};
