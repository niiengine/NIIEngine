...
void wxC52E5InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/unittestreport_unittestcpp_bitmaps.cpp$C__src_codelite_UnitTestCPP_unittestreport_unittestcpp_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/unittestreport_unittestcpp_bitmaps.cpp$C__src_codelite_UnitTestCPP_unittestreport_unittestcpp_bitmaps.xrc"));
}
