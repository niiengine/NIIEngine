...
{
protected:
    gsgs::ProgressCtrl* m_progressPassed;
    gsgs::ProgressCtrl* m_progressFailed;
...
public:
    gsgs::ProgressCtrl* GetProgressPassed() { return m_progressPassed; }
    gsgs::ProgressCtrl* GetProgressFailed() { return m_progressFailed; }
