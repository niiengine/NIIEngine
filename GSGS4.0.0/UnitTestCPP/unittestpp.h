...
class UnitTestPP : public Plugin
{
...
protected:
    ...
    void OnRunProject(gsgs::ExecuteEvent& e);
    void OnMarkProjectAsUT(wxCommandEvent& e);
    void OnRunUnitTestsUI(wxUpdateUIEvent& e);
    void OnProcessTerminated(gsgs::ProcessEvent& e);
    void OnProcessRead(gsgs::ProcessEvent& e);
    void OnEditorContextMenu(ContextMenuEvent& e);
